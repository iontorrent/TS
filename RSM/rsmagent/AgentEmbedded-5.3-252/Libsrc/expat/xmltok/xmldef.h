...
/* #include <stdlib.h> */
#include "AeOSLocal.h"
#define malloc(x) AeAlloc((x))
#define free(x) AeFree((x))
#define realloc(x, y) AeRealloc(x, y)
#define calloc(x, y)  AeCalloc((x),(y))
...
/* Avoid conflict with Microsoft Windows SDK */
#ifdef _MSC_VER
#define ELEMENT_TYPE __ELEMENT_TYPE
#endif
