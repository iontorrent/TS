...
char H5libhdf5_settings[]=
	...
	"-------------------\n"
	"		   HDF5 Version: 1.8.7\n"
	"		  Configured on: Fri Jan 13 07:45:40 PST 2012\n"
	"		  Configured by: nhomer@rnd2\n"
	"		 Configure mode: production\n"
	"		    Host system: x86_64-unknown-linux-gnu\n"
	"	      Uname information: Linux rnd2 2.6.32-24-server #43-Ubuntu SMP Thu Sep 16 16:05:42 UTC 2010 x86_64 GNU/Linux\n"
	"		       Byte sex: little-endian\n"
	"		      Libraries: \n"
	"	     Installation point: /home/nhomer/svn/TS/Release_2.0/external/hdf5-1.8.7/hdf5\n"
	"\n"
	"Compiling Options:\n"
	"------------------\n"
