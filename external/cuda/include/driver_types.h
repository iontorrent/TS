...
#define cudaPeerDevicePointerDefault   0x00  /**< Default peer device pointer query flag */

#define cudaPeerRegisterDefault        0x00  /**< Default peer memory registration flag */
#define cudaPeerRegisterMapped         0x02  /**< Map registered memory into device space */
...
enum cudaError
{
  ...
  /**
   * This error indicates that a call to ::cudaPeerRegister is trying to
   * register memory from a context which has not had peer addressing 
   * enabled yet via ::cudaDeviceEnablePeerAccess(), or that 
   * ::cudaDeviceDisablePeerAccess() is trying to disable peer addressing
  ...
  /**
   * This error indicates that a call to ::cudaPeerUnregister is trying to
