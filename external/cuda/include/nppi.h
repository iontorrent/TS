 ...
 */
NppStatus 
nppiReductionGetBufferHostSize_8u_C1R(const NppiSize & oSizeROI, int * hpBufferSize /* host pointer */);
 ...
 */
NppStatus 
nppiReductionGetBufferHostSize_8u_C4R(const NppiSize & oSizeROI, int * hpBufferSize /* host pointer */);
 ...
 */
NppStatus
nppiMinMaxGetBufferSize_8u_C1R(const NppiSize & oSizeROI, int * hpBufferSize /* host pointer */);
 ...
 */
NppStatus
nppiMinMaxGetBufferSize_8u_C4R(const NppiSize & oSizeROI, int * hpBufferSize /* host pointer */);
