        ...
        if read[i] == "-":
            ...
            if prev_del == 1:
                ...
                while (
                    ...
                    and read[start_ins] != "-"
                    and ref[start_ins] != "-"
                    and read[start_ins] == read[end_ins]
                ):
                    c = ref[end_ins]
...
if __name__ == "__main__":
    ...
    parser.add_option(
        "--print-read-name",
        help="print the read name",
        dest="print_read_name",
        default=False,
        action="store_true",
    )
    parser.add_option(
    ...
    parser.add_option(
        "--forward-genome",
        help="print alignments relative to the forward genomic strand",
        dest="forward_genome",
        default=False,
        action="store_true",
    )
