...
void tmap_map_locopt_init (tmap_map_locopt_t* locopt)
{
    ...
    locopt->repair.over = 0;
    locopt->repair_he.over = 0;
    locopt->repair_le.over = 0;
    locopt->repair_min_adapter.over = 0;
    locopt->repair_min_adapter_he.over = 0;
    locopt->repair_min_adapter_le.over = 0;
    locopt->repair_max_overhang.over = 0;
    locopt->repair_max_overhang_he.over = 0;
    locopt->repair_max_overhang_le.over = 0;
    locopt->repair_identity_drop_limit.over = 0;
    locopt->repair_identity_drop_limit_he.over = 0;
    locopt->repair_identity_drop_limit_le.over = 0;
    locopt->repair_max_primer_zone_dist.over = 0;
    locopt->repair_max_primer_zone_dist_he.over = 0;
    locopt->repair_max_primer_zone_dist_le.over = 0;
    locopt->repair_clip_ext.over = 0;
    locopt->repair_clip_ext_he.over = 0;
    locopt->repair_clip_ext_le.over = 0;
