...
void CrossTalkSpecification::SetStandardGrid()
{
   ...
   int ndx=0;
   cx[ndx] = -1; cy[ndx] = 0; delay[ndx] = 3.0; mix[ndx] = 1.0; ndx++;
   cx[ndx] = 1, cy[ndx] = 1; delay[ndx] = 3.0; mix[ndx] = 1.0; ndx++;
   cx[ndx] = 0; cy[ndx] = -1; delay[ndx] = 3.0; mix[ndx] = 1.0;ndx++;
   cx[ndx] = 0; cy[ndx] = 1; delay[ndx] = 3.0; mix[ndx] = 0.7;ndx++;
   cx[ndx] = 1; cy[ndx] = 1; delay[ndx] = 6.0; mix[ndx] = 0.8;ndx++;
   tau_bulk = 14.0;
   cbulk = 45;
   nscale = 4.0;
}
...
void CrossTalkSpecification::SetNewQuadGrid()
{
  ...
  // left/right
  int ndx = 0;
   cx[ndx] = -1; cy[ndx] = 0;  tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.02; ndx++;// reduced because downstream
   cx[ndx] = 1,  cy[ndx] = 0;   tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.03; ndx++;
   // phase of hex grid shifts these two entities
   // up
   //cx[ndx] = -1; cy[ndx] = 1;  tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.00; ndx++;
   cx[ndx] = 0;  cy[ndx] = 1;  tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.03; ndx++;
   cx[ndx] = 1;  cy[ndx] = 1;  tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.02; ndx++; // upstream towards inlet neighbor, reduced because diagonal
   // down
   //cx[ndx] = -1; cy[ndx] = -1;  tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.00; ndx++;
   cx[ndx] = 0; cy[ndx] = -1;  tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.02; ndx++; // reduced because downstream
   //cx[ndx] = 1; cy[ndx] = -1; tau_top[ndx] = 3; tau_fluid[ndx] = 7; multiplier[ndx] = 0.00; ndx++;
...
void CrossTalkSpecification::SetHexGrid()
{
  ...
  cx[ndx] = -1; cy[ndx] = 0; delay[ndx] = 3.0; mix[ndx] = 1.0;ndx++;
   ...
   cx[ndx] = 0; cy[ndx] = -1; delay[ndx] = 3.0; mix[ndx] = 1.0;ndx++;
   cx[ndx] = 0; cy[ndx] = 1; delay[ndx] = 3.0; mix[ndx] = 0.7;ndx++;
   cx[ndx] = -1; cy[ndx] = 1; delay[ndx] = 6.0; mix[ndx] = 0.6;ndx++;
   cx[ndx] = -1; cy[ndx] = -1; delay[ndx] = 6.0; mix[ndx]= 0.6; ndx++;
   tau_bulk = 14.0;
   cbulk = 35;
   nscale = 4.0;
...
void CrossTalkSpecification::SetNewHexGrid()
{
  ...
  int ndx = 0;
  // left/right
   cx[ndx] = -1; cy[ndx] = 0;  tau_top[ndx] = 5; tau_fluid[ndx] = 15; multiplier[ndx] = 0.01;ndx++;
   cx[ndx] = 1, cy[ndx] = 0;   tau_top[ndx] = 5; tau_fluid[ndx] = 12; multiplier[ndx] = 0.01;ndx++;
   // phase of hex grid shifts these two entities
   // up
   cx[ndx] = 0; cy[ndx] = 1;  tau_top[ndx] = 5; tau_fluid[ndx] = 12; multiplier[ndx] = 0.01;ndx++;
   cx[ndx] = 1; cy[ndx] = 1;   tau_top[ndx] = 5; tau_fluid[ndx] = 12; multiplier[ndx] = 0.01;ndx++;
   // down
   cx[ndx] = 0; cy[ndx] = -1;  tau_top[ndx] = 5; tau_fluid[ndx] = 12; multiplier[ndx] = 0.01;ndx++;
   cx[ndx] = 1; cy[ndx] = -1; tau_top[ndx] = 5; tau_fluid[ndx] = 11; multiplier[ndx] = 0.01;ndx++;
}
...
void CrossTalkSpecification::BootUpXtalkSpec(bool can_do_xtalk_correction, char *chipType, char *xtalk_name)
{
    ...
    if (can_do_xtalk_correction)
    {
        ...
        // local flag, hex_packed gets set in cross-talk when created

        bool hexchip = false; // detect 318 here and switch properly between specifications
        if (strcmp (chipType, "318") == 0)
            hexchip=true; // find out who we really are!
        ...
        if (strlen(xtalk_name)>0)
        {
            ...
            if (!hexchip)
                SetNewQuadGrid(); // or whatever for hex grid
            else
                SetNewHexGrid();  // hex grid, maybe
        }
    }
}
