...
class DecisionTreeData {
  public:
    ...
    DecisionTreeData() {
      ...
      tune_xbias = 0.005f; // tune calculation of chi-square bias
    };
    ...
    void SpecializedFilterFromBiasVariables(vcf::Variant *current_variant, float bias_threshold, int _allele);
