...
//////////////////////////////////////////////////////////////////////////////
// code derived from: http://www.ginac.de/~kreckel/fileno/
// By Richard B. Kreckel, 2005. This is code is in public domain.
//////////////////////////////////////////////////////////////////////////////

#ifndef __fileno_hpp__
#define __fileno_hpp__
...
template <typename charT, typename traits>
inline int fileno(const std::basic_ios<charT, traits>& stream);
