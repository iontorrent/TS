...
def merge_bam_files(bamfilelist, composite_bam_filepath, composite_bai_filepath):
    ...
    try:
        ...
        cmd = (
            "java -Xmx8g -jar /opt/picard/picard-tools-current/picard.jar MergeSamFiles"
        )
...
def Usage():
    ...
    print(
        "-t x\t\tfilter type set to x (1=filter on aligned qscore, 2=filter on predicted qscore)"
    )
