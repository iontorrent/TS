...
\section*{Analysis Details}
    ...
    {% if not report.isThumbnail %}
        ...
        \bf Analysis Args & \detokenize{% verbatim %}{ {% endverbatim %}{{ report.eas.analysisargs }}{% verbatim %}}{% endverbatim %} \\
    ...
    {% else %}
        ...
        \bf Analysis Args & \detokenize{% verbatim %}{ {% endverbatim %}{{ report.eas.thumbnailanalysisargs }}{% verbatim %}}{% endverbatim %}| \\
...
%%%%%%%%%%second row starts%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        {% else %}
            ...
            \fcolorbox{gray}{white}{\parbox[t][20mm]{160mm}{\setlength{\parindent}{0mm}\small\centering%%
            \begin{tabular}{lrrrr}
