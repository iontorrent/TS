...
%%%%%%%%%%first column of top row starts%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 ...
 \\[1.5mm]
 \includegraphics[width=44mm]{sigproc_results/Bead_density_contour.png} 		%UL %insert your figure-filename here{}
 }}
 \end{minipage}
...
%%%%%%%%%%third column of top row starts%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
 ...
 \begin{tabular}{P{40mm}}
 %column1
 \bfseries {{quality|bracket:"Mean Read Length at Q0"|float2int}} bp \\
 \footnotesize Mean Read Length
 \end{tabular} 
 \rule{40mm}{0.5pt}\\
 \bfseries\small
 Read Length
...
{% if datasets.barcode_config %}
 \begin{longtable}{E{28mm}E{47mm}E{13mm}E{13mm}E{13mm}E{30mm}}
...
{{barcode.barcode_name|default:"No barcode"|latexsafe}} & {{barcode.sample|latexsafe}} & {{barcode.total_bases|intcomma}} & {{barcode.Q20_bases|intcomma}} & {{barcode.read_count|intcomma}} & {{barcode.mean_read_length}} \\[2.5mm]
 ...
 \end{longtable}
{% elif CA_barcodes %}
 \begin{longtable}{E{28mm}E{13mm}E{13mm}E{13mm}}
