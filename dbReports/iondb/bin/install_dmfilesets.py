...
DM_FILE_SETS = [
    {
        ...
        "exclude": [".[^/]*?onboard_results.*?", ".*?expMeta\.dat", ".*?histo\.dat"],
        "keepwith": {dmactions_types.BASE: [".[^/]*?xplog\.txt", ".[^/]*?xplog\.json"]},
    ...
    },
    {
        ...
        "keepwith": {
            ...
            dmactions_types.SIG: [".[^/]*?xplog\.txt", ".[^/]*?xplog\.json"],
        },
        "version": settings.RELVERSION,
        "auto_trigger_age": "60",
        "auto_trigger_usage": "90",
    ...
    },
    {
        ...
        "exclude": [],
        "keepwith": {
            dmactions_types.OUT: ["analysis\.bfmask\.stats", "Bead_density_.*?\.png"]
        },
        "version": "2.2",
        "auto_trigger_age": "60",
        "auto_trigger_usage": "90",
    ...
    },
    {
        ...
        "keepwith": {
            dmactions_types.BASE: ["analysis.bfmask.stats", "Bead_density_.*?\.png"]
        },
        "version": "2.2",
        "auto_trigger_age": "180",
        "auto_trigger_usage": "90",
            ...
            if created:
                ...
                try:
                    ...
                    olddm = models.DMFileSet.objects.filter(
                        type=dmfileset["type"]
                    ).exclude(version=dmfileset["version"])
                    olddm = olddm[0]
