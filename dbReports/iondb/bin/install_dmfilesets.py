...
DM_FILE_SETS = [
    ...
    },
    {
        ...
        'include': [
            ...
            'onboard_results/sigproc_results/1\.wells',
            'onboard_results/sigproc_results/.[^/]*?\.bin',
            'onboard_results/sigproc_results/bfmask\.stats',
            ...
            'onboard_results/sigproc_results/sigproc\.log',
            'onboard_results/sigproc_results/processParameters\.txt',
            '.[^/]*?xplog\.txt',
            ],
        'exclude':[
            ],
