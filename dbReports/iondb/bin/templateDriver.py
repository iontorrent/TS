...
if __name__ == "__main__":
    ...
    parser.add_option("-h", dest="plugin_report_html", help="specify template html file rendering the results.json ")
    ...
    """
    settings.TEMPLATE_DIRS += (os.path.join(pluginparams['runinfo']['plugin_dir'], opt.template_dir),)
    data=[]
