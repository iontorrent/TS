...
class LegacyMigration(SchemaMigration):
    def forwards(self, orm):
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "storage_options",
                        models.fields.CharField(default="A", max_length=200),
                    ),
                    ("user_ack", models.fields.CharField(default="U", max_length=24)),
                    (
                        "project",
                        models.fields.CharField(max_length=64, null=True, blank=True),
                    ),
                    (
                        "sample",
                        models.fields.CharField(max_length=64, null=True, blank=True),
                    ...
                    (
                        "notes",
                        models.fields.CharField(max_length=128, null=True, blank=True),
                    ),
                    ("chipBarcode", models.fields.CharField(max_length=64, blank=True)),
                    (
                        "seqKitBarcode",
                        models.fields.CharField(max_length=64, blank=True),
                    ),
                    (
                        "reagentBarcode",
                        models.fields.CharField(max_length=64, blank=True),
                    ...
                    (
                        "sequencekitname",
                        models.fields.CharField(max_length=512, null=True, blank=True),
                    ),
                    (
                        "sequencekitbarcode",
                        models.fields.CharField(max_length=512, null=True, blank=True),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "report",
                        models.fields.related.ForeignKey(to=orm["rundb.Results"]),
                    ),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "location",
                        models.fields.related.ForeignKey(to=orm["rundb.Location"]),
                    ),
                    ("comments", models.fields.TextField(blank=True)),
                    (
                        "ftpserver",
                        models.fields.CharField(
                            default="192.168.201.1", max_length=128
                        ),
                    ),
                    (
                        "ftpusername",
                        models.fields.CharField(default="ionguest", max_length=64),
                    ),
                    (
                        "ftppassword",
                        models.fields.CharField(default="ionguest", max_length=64),
                    ...
                    (
                        "ftprootdir",
                        models.fields.CharField(default="results", max_length=64),
                    ),
                    (
                        "updatehome",
                        models.fields.CharField(
                            default="192.168.201.1", max_length=256
                        ),
                    ),
                    ("updateflag", models.fields.BooleanField(default=False)),
                    (
                        "serial",
                        models.fields.CharField(max_length=24, null=True, blank=True),
                    ),
                    ...
                    (
                        "last_init_date",
                        models.fields.CharField(max_length=512, blank=True),
                    ),
                    (
                        "last_clean_date",
                        models.fields.CharField(max_length=512, blank=True),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "experiment",
                        models.fields.related.ForeignKey(to=orm["rundb.Experiment"]),
                    ),
                    (
                        "backupName",
                        models.fields.CharField(unique=True, max_length=256),
                    ),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "reference_path",
                        models.fields.CharField(max_length=1000, blank=True),
                    ),
                    (
                        "records_to_display",
                        models.fields.IntegerField(default=20, blank=True),
                    ),
                    (
                        "default_test_fragment_key",
                        models.fields.CharField(max_length=50, blank=True),
                    ),
                    (
                        "default_library_key",
                        models.fields.CharField(max_length=50, blank=True),
                    ...
                    (
                        "default_flow_order",
                        models.fields.CharField(max_length=100, blank=True),
                    ),
                    (
                        "plugin_output_folder",
                        models.fields.CharField(max_length=500, blank=True),
                    ),
                    (
                    ...
                    (
                        ...
                        models.fields.CharField(
                            default="D", max_length=500, blank=True
                        ),
                    ),
                    ...
                    (
                        "ts_update_status",
                        models.fields.CharField(max_length=256, blank=True),
                    ),
                ),
            )
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "meta",
                        models.fields.TextField(default="", null=True, blank=True),
                    ),
                ),
            )
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "project",
                        models.fields.CharField(default="", max_length=512, blank=True),
                    ),
                    (
                        "sample",
                        models.fields.CharField(default="", max_length=512, blank=True),
                    ...
                    (
                        "url",
                        models.fields.URLField(default="", max_length=256, blank=True),
                    ),
                ),
            )
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "plugin",
                        models.fields.related.ForeignKey(to=orm["rundb.Plugin"]),
                    ),
                    (
                        "result",
                        models.fields.related.ForeignKey(to=orm["rundb.Results"]),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "floworder",
                        models.fields.CharField(default="", max_length=128, blank=True),
                    ),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "reference_path",
                        models.fields.CharField(max_length=1024, blank=True),
                    ),
                    ("date", models.fields.DateTimeField()),
                    ...
                    (
                        "verbose_error",
                        models.fields.CharField(max_length=3000, blank=True),
                    ),
                ),
            )
        ...
        try:
            ...
            db.create_table(
                "rundb_threeprimeadapter",
                (
                    ("id", models.fields.AutoField(primary_key=True)),
                    (
                        "direction",
                        models.fields.CharField(default="Forward", max_length=20),
                    ),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "planShortID",
                        models.fields.CharField(max_length=5, null=True, blank=True),
                    ),
                    ...
                    (
                        "planExecutedDate",
                        models.fields.DateTimeField(null=True, blank=True),
                    ),
                    ("metaData", models.fields.TextField(default="{}", blank=True)),
                    (
                        "chipType",
                        models.fields.CharField(max_length=32, null=True, blank=True),
                    ),
                    (
                        "chipBarcode",
                        models.fields.CharField(max_length=64, null=True, blank=True),
                    ...
                    (
                        "barcodeId",
                        models.fields.CharField(max_length=256, null=True, blank=True),
                    ),
                    (
                        "adapter",
                        models.fields.CharField(max_length=256, null=True, blank=True),
                    ...
                    (
                        "project",
                        models.fields.CharField(max_length=127, null=True, blank=True),
                    ),
                    (
                        "runname",
                        models.fields.CharField(max_length=255, null=True, blank=True),
                    ),
                    (
                        "sample",
                        models.fields.CharField(max_length=127, null=True, blank=True),
                ...
                (
                    ...
                    (
                        ...
                        models.fields.related.ForeignKey(
                            to=orm["rundb.Publisher"], null=True
                        ),
                    ),
                ),
            )
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "phone_number",
                        models.fields.CharField(default="", max_length=256, blank=True),
                    ),
        ...
        try:
            ...
            db.create_table(
                ...
                (
                    ...
                    (
                        "description",
                        models.fields.CharField(max_length=3024, blank=True),
                    ),
    ...
    models = {
        ...
        "rundb.dnabarcode": {
            ...
            "adapter": (
                "django.db.models.fields.CharField",
                [],
                {"default": "''", "max_length": "128", "blank": "True"},
            ),
            "annotation": (
                "django.db.models.fields.CharField",
                [],
        ...
        "rundb.experiment": {
            ...
            "storage_options": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'A'", "max_length": "200"},
            ),
            "unique": (
                "django.db.models.fields.CharField",
                [],
                {"unique": "True", "max_length": "512"},
            ),
            "usePreBeadfind": (
                "django.db.models.fields.BooleanField",
                [],
        ...
        "rundb.rig": {
            ...
            "ftppassword": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'ionguest'", "max_length": "64"},
            ),
            "ftprootdir": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'results'", "max_length": "64"},
            ),
            "ftpserver": (
                "django.db.models.fields.CharField",
                [],
