...
class StartupHousekeepingWithFixturesTest(TestCase):
    fixtures = ['iondb/rundb/tests/models/fixtures/groups.json', 
...
SINGLE = {
('Result', 'save'): ['http://localhost/rundb/demo_consumer/result_save',],
}
...
class StartupHousekeepingTest(TestCase):
    ...
    def test_init(self):
        ...
        self.assertRaisesMessage(MiddlewareNotUsed, 'End of startup.', callable_obj = StartupHousekeeping)
