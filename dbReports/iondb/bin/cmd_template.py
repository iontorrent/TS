...
if __name__=="__main__":
    ...
    parser.add_option("-o","--output", dest="outputFile", help="output file to direct the json generated from stripping div tag")
    parser.add_option("--json", dest="jsonFile", help="If you have more than one divs, enter the json filename")
