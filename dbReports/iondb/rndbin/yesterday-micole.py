...
def data_find(big_list):
    ...
    """
    results = []
    csv = open("daily-" + str(datetime.date.today())+ ".csv",'w')
...
if __name__ == '__main__':
    ...
    html = open("daily-" + str(datetime.date.today())+ ".html",'w')
    ...
    html.write('</br> <a href="daily-' + str(datetime.date.today()) + '.csv">csv file</a>'  )
