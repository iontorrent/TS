...
jQuery.fn.uniform = function (extended_settings) {
    ...
    this.validators = {
        ...
        /**
         * Valid non-FTP URL (http://,https://)
         *
         * @param jQuery field
         * @param string caption
         */
        validateHTTPUrl : function (field, caption) {
            if (field.val().match(/^(http|https):\/\/(([A-Z0-9][A-Z0-9_\-]*)(\.[A-Z0-9][A-Z0-9_\-]*)+)(:(\d+))?\/?/i)) {
                return true;
            }
            return i18n('url_http', caption);
        },
        /**
         * Valid Filename Rule 
         *
         ...
         * @param string caption
         */
        validateFilenameRegex : function (field, caption) {
            ...
            return i18n('filenameregex', caption);
        }
...
jQuery.fn.uniform.isValid = function(form, settings) {
    ...
    return 0 === form.find('.' + settings.invalid_class).add('.' + settings.error_class).length 
};
/**
...
/*    required      : '%s is required',*/
    ...
    filenameregex : '%s is not a valid pattern.  Allowable characters include (comma-separated): A-Z,a-z,0-9,_,-,/,?.,!,*,.'
};
