...
function onDataBinding(arg) {
	console.log("at planned_by_template.html.js onDataBinding...");
...
function onDataBound(arg) {
	console.log("at planned_by_template.html.js onDataBound...");
...
$(document).ready(function() {
    ...
    var grid = $("#grid").kendoGrid({
        dataSource : {
            ...
            transport : {
                read : {
                    url : "/rundb/api/v1/plannedexperiment/?isReusable=False&planExecuted=False&isSystem=False&sampleSet__isnull=True",                	
