...
!function ($) {
  ...
  * ============================== */
  ...
  $.fn.collapse = function (option, parent) {
    return this.each(function () {
      var $this = $(this)
        , data = $this.data('collapse')
        , options = typeof option == 'object' && option
      if (parent) options = $.extend({}, options, {parent:parent})
...
!function ($) {
  ...
  * =============================== */
  ...
  , setContent: function () {
      ...
      $tip.find('.popover-footer > *')[this.isHTML(footer) ? 'html' : 'text'](footer)
