...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DMFileStat.preserve_data'
        db.add_column('rundb_dmfilestat', 'preserve_data',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DMFileStat.preserve_data'
        db.delete_column('rundb_dmfilestat', 'preserve_data')
