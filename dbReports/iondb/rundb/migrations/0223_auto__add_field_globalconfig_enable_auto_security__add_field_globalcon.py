...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.enable_auto_security'
        db.add_column(u'rundb_globalconfig', 'enable_auto_security',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'GlobalConfig.sec_update_status'
        db.add_column(u'rundb_globalconfig', 'sec_update_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.enable_auto_security'
        db.delete_column(u'rundb_globalconfig', 'enable_auto_security')

        # Deleting field 'GlobalConfig.sec_update_status'
        db.delete_column(u'rundb_globalconfig', 'sec_update_status')
    ...
    models = {
        ...
        u'rundb.globalconfig': {
            ...
            'enable_auto_security': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
