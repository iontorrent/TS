...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.chefScriptVersion'
        db.add_column(u'rundb_experiment', 'chefScriptVersion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.chefScriptVersion'
        db.delete_column(u'rundb_experiment', 'chefScriptVersion')
