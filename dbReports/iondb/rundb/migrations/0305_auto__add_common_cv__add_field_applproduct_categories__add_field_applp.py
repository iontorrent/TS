...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'common_CV'
        db.create_table(u'rundb_common_cv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cv_type', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=127)),
            ('displayedValue', self.gf('django.db.models.fields.CharField')(unique=True, max_length=127)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('isDefault', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('isActive', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('categories', self.gf('django.db.models.fields.CharField')(default='', max_length=256, null=True, blank=True)),
            ('samplePrep_instrumentType', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('sequencing_instrumentType', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
        ))
        db.send_create_signal(u'rundb', ['common_CV'])

        # Adding unique constraint on 'common_CV', fields ['cv_type', 'value']
        db.create_unique(u'rundb_common_cv', ['cv_type', 'value'])

        # Adding field 'ApplProduct.categories'
        db.add_column(u'rundb_applproduct', 'categories',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ApplProduct.defaultSamplePrepProtocol'
        db.add_column(u'rundb_applproduct', 'defaultSamplePrepProtocol',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='common_CV_applProduct_set', null=True, to=orm['rundb.common_CV']),
                      keep_default=False)

        # Adding field 'PlannedExperiment.samplePrepProtocol'
        db.add_column(u'rundb_plannedexperiment', 'samplePrepProtocol',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'common_CV', fields ['cv_type', 'value']
        db.delete_unique(u'rundb_common_cv', ['cv_type', 'value'])

        # Deleting model 'common_CV'
        db.delete_table(u'rundb_common_cv')

        # Deleting field 'ApplProduct.categories'
        db.delete_column(u'rundb_applproduct', 'categories')

        # Deleting field 'ApplProduct.defaultSamplePrepProtocol'
        db.delete_column(u'rundb_applproduct', 'defaultSamplePrepProtocol_id')

        # Deleting field 'PlannedExperiment.samplePrepProtocol'
        db.delete_column(u'rundb_plannedexperiment', 'samplePrepProtocol')
    ...
    models = {
        ...
        u'rundb.plannedexperiment': {
            ...
            'samplePrepProtocol': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64'}),
