...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        def humanVersion(version):
            try:
                human = version[-2] + "." + version[-1]
                return human
            except:
                return version
                ...
                if 'userInput' in iru:
                    if 'accountId' in iru['userInput']:
                        try:
                            ...
                            print "\tBefore " + iru['userInput']['accountName']

                            #now build the new string
                            accountName = flat[id]["name"] + " (Version: " + humanVersion(flat[id]["version"]) + " | User: " + flat[id]["details"]["firstname"] + " " + flat[id]["details"]["lastname"] + " | Org: " + flat[id]["details"]["orgname"] + ")"

                            print "\tAfter" + accountName

                            #set the new string
                            selected_plugins["IonReporterUploader"]["userInput"]["accountName"] = accountName
    ...
    def backwards(self, orm):
        print "Not reverting the old IRU plan cached names"
