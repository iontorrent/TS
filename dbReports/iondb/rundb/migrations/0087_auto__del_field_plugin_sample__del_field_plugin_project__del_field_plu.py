...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Plugin.sample'
        db.delete_column('rundb_plugin', 'sample')

        # Deleting field 'Plugin.chipType'
        db.delete_column('rundb_plugin', 'chipType')

        # Deleting field 'Plugin.libraryName'
        db.delete_column('rundb_plugin', 'libraryName')

        # Deleting field 'Plugin.project'
        db.delete_column('rundb_plugin', 'project')


    def backwards(self, orm):
        
        # Adding field 'Plugin.sample'
        db.add_column('rundb_plugin', 'sample', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'Plugin.chipType'
        db.add_column('rundb_plugin', 'chipType', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'Plugin.libraryName'
        db.add_column('rundb_plugin', 'libraryName', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'Plugin.project'
        db.add_column('rundb_plugin', 'project', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 13, 18, 15, 568223)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 13, 18, 15, 568111)'}),
