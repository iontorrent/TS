...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KitInfo.defaultFlowOrder'
        db.add_column(u'rundb_kitinfo', 'defaultFlowOrder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['rundb.FlowOrder'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KitInfo.defaultFlowOrder'
        db.delete_column(u'rundb_kitinfo', 'defaultFlowOrder_id')
