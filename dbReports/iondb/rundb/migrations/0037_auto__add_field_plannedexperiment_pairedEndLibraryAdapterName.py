...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlannedExperiment.pairedEndLibraryAdapterName'
        db.add_column('rundb_plannedexperiment', 'pairedEndLibraryAdapterName', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlannedExperiment.pairedEndLibraryAdapterName'
        db.delete_column('rundb_plannedexperiment', 'pairedEndLibraryAdapterName')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 21, 8, 19, 613019)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 21, 8, 19, 612918)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 21, 8, 19, 180527)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
