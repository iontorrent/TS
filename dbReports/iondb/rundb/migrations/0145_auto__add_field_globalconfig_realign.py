...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.realign'
        db.add_column('rundb_globalconfig', 'realign',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.realign'
        db.delete_column('rundb_globalconfig', 'realign')
