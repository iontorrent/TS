...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rundb_globalconfig', (
            ...
            ('default_command_line', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True, null=True)),
            ('basecallerargs', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True, null=True)),
