...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.chefInstrumentName'
        db.add_column(u'rundb_experiment', 'chefInstrumentName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefKitType'
        db.add_column(u'rundb_experiment', 'chefKitType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefChipType1'
        db.add_column(u'rundb_experiment', 'chefChipType1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefChipType2'
        db.add_column(u'rundb_experiment', 'chefChipType2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefChipExpiration1'
        db.add_column(u'rundb_experiment', 'chefChipExpiration1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefChipExpiration2'
        db.add_column(u'rundb_experiment', 'chefChipExpiration2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefReagentsPart'
        db.add_column(u'rundb_experiment', 'chefReagentsPart',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefReagentsLot'
        db.add_column(u'rundb_experiment', 'chefReagentsLot',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefReagentsExpiration'
        db.add_column(u'rundb_experiment', 'chefReagentsExpiration',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefSolutionsPart'
        db.add_column(u'rundb_experiment', 'chefSolutionsPart',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefSolutionsLot'
        db.add_column(u'rundb_experiment', 'chefSolutionsLot',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefSolutionsExpiration'
        db.add_column(u'rundb_experiment', 'chefSolutionsExpiration',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefSamplePos'
        db.add_column(u'rundb_experiment', 'chefSamplePos',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefPackageVer'
        db.add_column(u'rundb_experiment', 'chefPackageVer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefExtraInfo_1'
        db.add_column(u'rundb_experiment', 'chefExtraInfo_1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefExtraInfo_2'
        db.add_column(u'rundb_experiment', 'chefExtraInfo_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.chefInstrumentName'
        db.delete_column(u'rundb_experiment', 'chefInstrumentName')

        # Deleting field 'Experiment.chefKitType'
        db.delete_column(u'rundb_experiment', 'chefKitType')

        # Deleting field 'Experiment.chefChipType1'
        db.delete_column(u'rundb_experiment', 'chefChipType1')

        # Deleting field 'Experiment.chefChipType2'
        db.delete_column(u'rundb_experiment', 'chefChipType2')

        # Deleting field 'Experiment.chefChipExpiration1'
        db.delete_column(u'rundb_experiment', 'chefChipExpiration1')

        # Deleting field 'Experiment.chefChipExpiration2'
        db.delete_column(u'rundb_experiment', 'chefChipExpiration2')

        # Deleting field 'Experiment.chefReagentsPart'
        db.delete_column(u'rundb_experiment', 'chefReagentsPart')

        # Deleting field 'Experiment.chefReagentsLot'
        db.delete_column(u'rundb_experiment', 'chefReagentsLot')

        # Deleting field 'Experiment.chefReagentsExpiration'
        db.delete_column(u'rundb_experiment', 'chefReagentsExpiration')

        # Deleting field 'Experiment.chefSolutionsPart'
        db.delete_column(u'rundb_experiment', 'chefSolutionsPart')

        # Deleting field 'Experiment.chefSolutionsLot'
        db.delete_column(u'rundb_experiment', 'chefSolutionsLot')

        # Deleting field 'Experiment.chefSolutionsExpiration'
        db.delete_column(u'rundb_experiment', 'chefSolutionsExpiration')

        # Deleting field 'Experiment.chefSamplePos'
        db.delete_column(u'rundb_experiment', 'chefSamplePos')

        # Deleting field 'Experiment.chefPackageVer'
        db.delete_column(u'rundb_experiment', 'chefPackageVer')

        # Deleting field 'Experiment.chefExtraInfo_1'
        db.delete_column(u'rundb_experiment', 'chefExtraInfo_1')

        # Deleting field 'Experiment.chefExtraInfo_2'
        db.delete_column(u'rundb_experiment', 'chefExtraInfo_2')
    ...
    models = {
        ...
        u'rundb.applproduct': {
            ...
            'defaultAvalancheSequencingKit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'avalancheSeqKit_applProduct_set'", 'null': 'True', 'to': u"orm['rundb.KitInfo']"}),
            'defaultAvalancheTemplateKit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'avalancheTemplateKit_applProduct_set'", 'null': 'True', 'to': u"orm['rundb.KitInfo']"}),
            ...
            'defaultPairedEndAdapterKit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'peAdapterKit_applProduct_set'", 'null': 'True', 'to': u"orm['rundb.KitInfo']"}),
            'defaultPairedEndLibraryKit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'peLibKit_applProduct_set'", 'null': 'True', 'to': u"orm['rundb.KitInfo']"}),
            'defaultPairedEndSequencingKit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'peSeqKit_applProduct_set'", 'null': 'True', 'to': u"orm['rundb.KitInfo']"}),
