...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.enable_compendia_OCP'
        db.add_column(u'rundb_globalconfig', 'enable_compendia_OCP',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.enable_compendia_OCP'
        db.delete_column(u'rundb_globalconfig', 'enable_compendia_OCP')
