...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KitInfo.defaultThreePrimeAdapter'
        db.add_column(u'rundb_kitinfo', 'defaultThreePrimeAdapter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['rundb.ThreePrimeadapter'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KitInfo.defaultThreePrimeAdapter'
        db.delete_column(u'rundb_kitinfo', 'defaultThreePrimeAdapter_id')
