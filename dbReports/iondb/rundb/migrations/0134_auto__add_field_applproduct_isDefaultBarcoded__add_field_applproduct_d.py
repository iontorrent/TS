...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.isDefaultBarcoded'
        db.add_column('rundb_applproduct', 'isDefaultBarcoded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApplProduct.defaultBarcodeKitName'
        db.add_column('rundb_applproduct', 'defaultBarcodeKitName',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.isDefaultBarcoded'
        db.delete_column('rundb_applproduct', 'isDefaultBarcoded')

        # Deleting field 'ApplProduct.defaultBarcodeKitName'
        db.delete_column('rundb_applproduct', 'defaultBarcodeKitName')
