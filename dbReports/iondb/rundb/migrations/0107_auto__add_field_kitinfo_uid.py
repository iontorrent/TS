...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KitInfo.uid'
        db.add_column('rundb_kitinfo', 'uid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KitInfo.uid'
        db.delete_column('rundb_kitinfo', 'uid')
    ...
    models = {
        ...
        'rundb.kitinfo': {
            ...
            'runMode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'})
        },
        'rundb.kitpart': {
