...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Results.parentResult'
        db.add_column(u'rundb_results', 'parentResult',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='childResults_set', null=True, on_delete=models.SET_NULL, to=orm['rundb.Results']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Results.parentResult'
        db.delete_column(u'rundb_results', 'parentResult_id')
