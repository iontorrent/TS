...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Copy the 15bp field's value to the 150bp field."
        QualityMetrics = orm['rundb.QualityMetrics']
        QualityMetrics.objects.all().update(q0_150bp_reads=F('q0_15bp_reads'))

    def backwards(self, orm):
        "Assign the 150bp value to the 15bp field."
        QualityMetrics = orm['rundb.QualityMetrics']
        QualityMetrics.objects.all().update(q0_15bp_reads=F('q0_150bp_reads'))
