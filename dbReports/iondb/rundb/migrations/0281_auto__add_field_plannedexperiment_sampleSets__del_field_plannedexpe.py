...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field sampleSets on 'PlannedExperiment'
        m2m_table_name = db.shorten_name(u'rundb_plannedexperiment_sampleSets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plannedexperiment', models.ForeignKey(orm[u'rundb.plannedexperiment'], null=False)),
            ('sampleset', models.ForeignKey(orm[u'rundb.sampleset'], null=False))
        ))
        db.create_unique(m2m_table_name, ['plannedexperiment_id', 'sampleset_id'])

        # Deleting field 'PlannedExperiment.sampleSet_uid'
        db.delete_column(u'rundb_plannedexperiment', 'sampleSet_uid')

        # Deleting field 'PlannedExperiment.sampleSet_planIndex'
        db.delete_column(u'rundb_plannedexperiment', 'sampleSet_planIndex')

        # Deleting field 'PlannedExperiment.sampleSet_planTotal'
        db.delete_column(u'rundb_plannedexperiment', 'sampleSet_planTotal')


    def backwards(self, orm):
        # Adding field 'PlannedExperiment.sampleSet_uid'
        db.add_column(u'rundb_plannedexperiment', 'sampleSet_uid',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.sampleSet_planIndex'
        db.add_column(u'rundb_plannedexperiment', 'sampleSet_planIndex',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlannedExperiment.sampleSet_planTotal'
        db.add_column(u'rundb_plannedexperiment', 'sampleSet_planTotal',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Removing M2M table for field sampleSets on 'PlannedExperiment'
        db.delete_table(db.shorten_name(u'rundb_plannedexperiment_sampleSets'))
    ...
    models = {
        ...
        u'rundb.plannedexperiment': {
            ...
            'sampleSets': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'plans_set'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['rundb.SampleSet']"}),
