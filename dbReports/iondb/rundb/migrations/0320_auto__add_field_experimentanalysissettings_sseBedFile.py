...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.sseBedFile'
        db.add_column(u'rundb_experimentanalysissettings', 'sseBedFile',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.sseBedFile'
        db.delete_column(u'rundb_experimentanalysissettings', 'sseBedFile')
