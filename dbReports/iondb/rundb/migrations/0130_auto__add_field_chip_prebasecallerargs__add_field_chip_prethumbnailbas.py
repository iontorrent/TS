...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rundb_chip', 'prebasecallerargs')

        # Deleting field 'Chip.prethumbnailbasecallerargs'
        db.delete_column('rundb_chip', 'prethumbnailbasecallerargs')
