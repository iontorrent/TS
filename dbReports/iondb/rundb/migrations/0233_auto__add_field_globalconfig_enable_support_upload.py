...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.enable_support_upload'
        db.add_column(u'rundb_globalconfig', 'enable_support_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.enable_support_upload'
        db.delete_column(u'rundb_globalconfig', 'enable_support_upload')
