...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for dnaBarcode in orm.dnaBarcode.objects.filter(name='IonSet1'):
            dnaBarcode.active = False
            print "*** 0352 > Deactivating pk=%d; barcodeId=%s" % (dnaBarcode.id, dnaBarcode.id_str)
            dnaBarcode.save()
