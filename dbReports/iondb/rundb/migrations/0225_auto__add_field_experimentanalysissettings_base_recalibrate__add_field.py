...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # get default values from GlobalConfig
        gc = orm.globalconfig.objects.all()
        default_base_recalibrate = gc[0].base_recalibrate if gc else True
        default_realign = gc[0].realign if gc else False
        ...
        db.add_column(u'rundb_experimentanalysissettings', 'base_recalibrate',
                      self.gf('django.db.models.fields.BooleanField')(default=default_base_recalibrate),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.realign'
        db.add_column(u'rundb_experimentanalysissettings', 'realign',
                      self.gf('django.db.models.fields.BooleanField')(default=default_realign),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ExperimentAnalysisSettings.realign'
        db.delete_column(u'rundb_experimentanalysissettings', 'realign')
