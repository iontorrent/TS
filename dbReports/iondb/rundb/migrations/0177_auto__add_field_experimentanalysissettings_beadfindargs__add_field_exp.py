...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.beadfindargs'
        db.add_column(u'rundb_experimentanalysissettings', 'beadfindargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.thumbnailbeadfindargs'
        db.add_column(u'rundb_experimentanalysissettings', 'thumbnailbeadfindargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.analysisargs'
        db.add_column(u'rundb_experimentanalysissettings', 'analysisargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.thumbnailanalysisargs'
        db.add_column(u'rundb_experimentanalysissettings', 'thumbnailanalysisargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.prebasecallerargs'
        db.add_column(u'rundb_experimentanalysissettings', 'prebasecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.prethumbnailbasecallerargs'
        db.add_column(u'rundb_experimentanalysissettings', 'prethumbnailbasecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.basecallerargs'
        db.add_column(u'rundb_experimentanalysissettings', 'basecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.thumbnailbasecallerargs'
        db.add_column(u'rundb_experimentanalysissettings', 'thumbnailbasecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.alignmentargs'
        db.add_column(u'rundb_experimentanalysissettings', 'alignmentargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.thumbnailalignmentargs'
        db.add_column(u'rundb_experimentanalysissettings', 'thumbnailalignmentargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.beadfindargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'beadfindargs')

        # Deleting field 'ExperimentAnalysisSettings.thumbnailbeadfindargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'thumbnailbeadfindargs')

        # Deleting field 'ExperimentAnalysisSettings.analysisargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'analysisargs')

        # Deleting field 'ExperimentAnalysisSettings.thumbnailanalysisargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'thumbnailanalysisargs')

        # Deleting field 'ExperimentAnalysisSettings.prebasecallerargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'prebasecallerargs')

        # Deleting field 'ExperimentAnalysisSettings.prethumbnailbasecallerargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'prethumbnailbasecallerargs')

        # Deleting field 'ExperimentAnalysisSettings.basecallerargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'basecallerargs')

        # Deleting field 'ExperimentAnalysisSettings.thumbnailbasecallerargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'thumbnailbasecallerargs')

        # Deleting field 'ExperimentAnalysisSettings.alignmentargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'alignmentargs')

        # Deleting field 'ExperimentAnalysisSettings.thumbnailalignmentargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'thumbnailalignmentargs')
    ...
    models = {
        ...
        u'rundb.filemonitor': {
            ...
            'celery_task_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '60'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rundb.referencegenome': {
            ...
            'file_monitor': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['rundb.FileMonitor']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
