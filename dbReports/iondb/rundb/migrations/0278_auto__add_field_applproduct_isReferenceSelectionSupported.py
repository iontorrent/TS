...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.isReferenceSelectionSupported'
        db.add_column(u'rundb_applproduct', 'isReferenceSelectionSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.isReferenceSelectionSupported'
        db.delete_column(u'rundb_applproduct', 'isReferenceSelectionSupported')
