...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlannedExperiment.templatingKitName'
        db.add_column('rundb_plannedexperiment', 'templatingKitName', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)

        # Adding field 'PlannedExperiment.controlSequencekitname'
        db.add_column('rundb_plannedexperiment', 'controlSequencekitname', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlannedExperiment.templatingKitName'
        db.delete_column('rundb_plannedexperiment', 'templatingKitName')

        # Deleting field 'PlannedExperiment.controlSequencekitname'
        db.delete_column('rundb_plannedexperiment', 'controlSequencekitname')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 20, 15, 10, 916236)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 20, 15, 10, 916087)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 20, 15, 10, 488723)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
