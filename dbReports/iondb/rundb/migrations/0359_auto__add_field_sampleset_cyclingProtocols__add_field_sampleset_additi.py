...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSet.cyclingProtocols'
        db.add_column(u'rundb_sampleset', 'cyclingProtocols',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSet.additionalCycles'
        db.add_column(u'rundb_sampleset', 'additionalCycles',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSet.cyclingProtocols'
        db.delete_column(u'rundb_sampleset', 'cyclingProtocols')

        # Deleting field 'SampleSet.additionalCycles'
        db.delete_column(u'rundb_sampleset', 'additionalCycles')
    ...
    models = {
        ...
        u'rundb.sampleset': {
            ...
            'cyclingProtocols': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'displayedName': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '127'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastModifiedDate': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
