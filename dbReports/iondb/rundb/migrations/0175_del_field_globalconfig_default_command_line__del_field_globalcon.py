...
class Migration(SchemaMigration):
    ...
    # Soft migration to remove obsolete GC fields from database (already removed on internal servers)

    def forwards(self, orm):
        delete_fields = ['default_command_line', 'analysisthumbnailargs', 'basecallerthumbnailargs', 'basecallerargs']
        
        sql = "SELECT column_name FROM information_schema.columns " + \
              "WHERE table_name = 'rundb_globalconfig'"
        gc_names = db.execute(sql)
                
        for field in delete_fields:
            if field in sum(gc_names, ()):
                db.delete_column('rundb_globalconfig', field)

    def backwards(self, orm):
        
        # Adding field 'GlobalConfig.default_command_line'
        db.add_column('rundb_globalconfig', 'default_command_line', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)
        ...
        # Adding field 'GlobalConfig.basecallerargs'
        db.add_column('rundb_globalconfig', 'basecallerargs', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)
