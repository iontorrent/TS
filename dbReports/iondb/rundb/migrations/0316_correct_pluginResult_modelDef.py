...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # no-op - just to correct rundb_pluginresult model def below
        print "0316- NO-OP forwards - rundb_pluginresult model definition correction only"

    def backwards(self, orm):
        # no-op to correct model def
        print "0316- NO-OP backwards - rundb_pluginresult model definition correction only"
