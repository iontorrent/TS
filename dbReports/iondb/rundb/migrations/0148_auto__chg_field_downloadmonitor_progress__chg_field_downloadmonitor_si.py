...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DownloadMonitor.progress'
        db.alter_column('rundb_downloadmonitor', 'progress', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'DownloadMonitor.size'
        db.alter_column('rundb_downloadmonitor', 'size', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'DownloadMonitor.progress'
        db.alter_column('rundb_downloadmonitor', 'progress', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'DownloadMonitor.size'
        db.alter_column('rundb_downloadmonitor', 'size', self.gf('django.db.models.fields.IntegerField')(null=True))
