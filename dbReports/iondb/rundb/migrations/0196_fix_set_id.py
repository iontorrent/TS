...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for pe in planned_experiments:
            #print ">>0196 LOOP... going to process plan.id=%d; name=%s" %(pe.id, pe.planDisplayedName)
                        ...
                        if type(uii) == types.DictType:
                            ...
                            for ui in uii:
                                if ui:
                                    ...
                                    print ">>0196 userInputInfo list has no element to process. SKIPPED plan.id=%d; eas.id=%d" %(pe.id, eas.id)
            else:                
                print ">>0196 NO selectedPlugins for plan.id=%d; eas.id=%d" %(pe.id, eas.id)
    ...
    models = {
        ...
        u'rundb.plannedexperiment': {
            ...
            'sampleGrouping': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
