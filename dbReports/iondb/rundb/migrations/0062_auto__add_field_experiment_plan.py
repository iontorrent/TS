...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.plan'
        db.add_column('rundb_experiment', 'plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.PlannedExperiment'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.plan'
        db.delete_column('rundb_experiment', 'plan_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 6, 20, 48, 42, 582052)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 6, 20, 48, 42, 581948)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 6, 20, 48, 42, 208253)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
