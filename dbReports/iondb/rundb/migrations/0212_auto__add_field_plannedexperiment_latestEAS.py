...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlannedExperiment.latestEAS'
        db.add_column(u'rundb_plannedexperiment', 'latestEAS',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='+', null=True, on_delete=models.SET_NULL, to=orm['rundb.ExperimentAnalysisSettings'], blank=True, unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlannedExperiment.latestEAS'
        db.delete_column(u'rundb_plannedexperiment', 'latestEAS_id')
