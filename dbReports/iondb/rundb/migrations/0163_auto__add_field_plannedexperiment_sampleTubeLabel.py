...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlannedExperiment.sampleTubeLabel'
        db.add_column('rundb_plannedexperiment', 'sampleTubeLabel',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlannedExperiment.sampleTubeLabel'
        db.delete_column('rundb_plannedexperiment', 'sampleTubeLabel')
