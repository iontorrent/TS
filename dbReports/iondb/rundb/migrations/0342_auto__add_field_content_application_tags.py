...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.application_tags'
        db.add_column(u'rundb_content', 'application_tags',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.application_tags'
        db.delete_column(u'rundb_content', 'application_tags')
