...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Fills in command line args for existing unused Plans"
        for plan in orm.plannedexperiment.objects.filter(planExecuted=False, isReusable=False):
            try:
                #print 'Updating cmd line args for %s' % plan.planName
                exp = plan.experiment
                eas = exp.eas_set.all()[0]
                chipType = exp.chipType
                sequencekitname = exp.sequencekitname
                
                if chipType in ['314','316','318','314v2','316v2','318v2']:
                    args_dict = {
                ...
                print 'Unable to update cmd line args for %s' % plan.planName
