...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rundb_globalconfig', 'base_recalibrate', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GlobalConfig.base_recalibrate'
        db.delete_column('rundb_globalconfig', 'base_recalibrate')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 2, 11, 48, 4, 489478)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 2, 11, 48, 4, 489361)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 2, 11, 48, 4, 94405)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
