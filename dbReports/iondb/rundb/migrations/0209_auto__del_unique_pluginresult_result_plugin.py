...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'rundb_pluginresult', ['result_id', 'plugin_id'])


    def backwards(self, orm):

        # FIXME - needs code to remove non-unique records (keeping most recent?)

        # Adding unique constraint on 'PluginResult', fields ['result', 'plugin']
        db.create_unique(u'rundb_pluginresult', ['result_id', 'plugin_id'])
