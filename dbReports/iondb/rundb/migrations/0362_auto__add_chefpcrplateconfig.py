...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChefPcrPlateconfig'
        db.create_table(u'rundb_chefpcrplateconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.KitInfo'], null=True, blank=True)),
            ('confg', self.gf('django.db.models.fields.TextField')(default='{}', blank=True)),
        ))
        db.send_create_signal(u'rundb', ['ChefPcrPlateconfig'])


    def backwards(self, orm):
        # Deleting model 'ChefPcrPlateconfig'
        db.delete_table(u'rundb_chefpcrplateconfig')
