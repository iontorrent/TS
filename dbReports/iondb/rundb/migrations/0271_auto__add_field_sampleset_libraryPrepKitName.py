...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSet.libraryPrepKitName'
        db.add_column(u'rundb_sampleset', 'libraryPrepKitName',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSet.libraryPrepKitName'
        db.delete_column(u'rundb_sampleset', 'libraryPrepKitName')
