...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceGenome.file_monitor'
        db.add_column(u'rundb_referencegenome', 'file_monitor',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rundb.FileMonitor'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceGenome.file_monitor'
        db.delete_column(u'rundb_referencegenome', 'file_monitor_id')
