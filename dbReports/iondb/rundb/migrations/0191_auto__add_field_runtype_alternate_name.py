...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RunType.alternate_name'
        db.add_column(u'rundb_runtype', 'alternate_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RunType.alternate_name'
        db.delete_column(u'rundb_runtype', 'alternate_name')
