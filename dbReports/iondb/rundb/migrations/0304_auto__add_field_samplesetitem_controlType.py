...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.controlType'
        db.add_column(u'rundb_samplesetitem', 'controlType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.controlType'
        db.delete_column(u'rundb_samplesetitem', 'controlType')
