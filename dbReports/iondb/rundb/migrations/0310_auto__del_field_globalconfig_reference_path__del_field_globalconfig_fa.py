...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GlobalConfig.reference_path'
        db.delete_column(u'rundb_globalconfig', 'reference_path')

        # Deleting field 'GlobalConfig.fasta_path'
        db.delete_column(u'rundb_globalconfig', 'fasta_path')

        # Deleting field 'GlobalConfig.default_plugin_script'
        db.delete_column(u'rundb_globalconfig', 'default_plugin_script')

        # Deleting field 'GlobalConfig.barcode_args'
        db.delete_column(u'rundb_globalconfig', 'barcode_args')

        # Deleting field 'GlobalConfig.plugin_folder'
        db.delete_column(u'rundb_globalconfig', 'plugin_folder')


    def backwards(self, orm):
        # Adding field 'GlobalConfig.reference_path'
        db.add_column(u'rundb_globalconfig', 'reference_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'GlobalConfig.fasta_path'
        db.add_column(u'rundb_globalconfig', 'fasta_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'GlobalConfig.default_plugin_script'
        db.add_column(u'rundb_globalconfig', 'default_plugin_script',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'GlobalConfig.barcode_args'
        db.add_column(u'rundb_globalconfig', 'barcode_args',
                      self.gf('django.db.models.fields.TextField')(default='{}', blank=True),
                      keep_default=False)

        # Adding field 'GlobalConfig.plugin_folder'
        db.add_column(u'rundb_globalconfig', 'plugin_folder',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)
