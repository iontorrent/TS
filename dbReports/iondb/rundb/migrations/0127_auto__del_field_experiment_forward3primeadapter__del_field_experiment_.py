...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Experiment.forward3primeadapter'
        db.delete_column('rundb_experiment', 'forward3primeadapter')

        # Deleting field 'Experiment.librarykitbarcode'
        db.delete_column('rundb_experiment', 'librarykitbarcode')

        # Deleting field 'Experiment.library'
        db.delete_column('rundb_experiment', 'library')

        # Deleting field 'Experiment.reverselibrarykey'
        db.delete_column('rundb_experiment', 'reverselibrarykey')

        # Deleting field 'Experiment.barcodeId'
        db.delete_column('rundb_experiment', 'barcodeId')

        # Deleting field 'Experiment.libraryKey'
        db.delete_column('rundb_experiment', 'libraryKey')

        # Deleting field 'Experiment.librarykitname'
        db.delete_column('rundb_experiment', 'librarykitname')

        # Deleting field 'Experiment.reverse3primeadapter'
        db.delete_column('rundb_experiment', 'reverse3primeadapter')


    def backwards(self, orm):
        # Adding field 'Experiment.forward3primeadapter'
        db.add_column('rundb_experiment', 'forward3primeadapter',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.librarykitbarcode'
        db.add_column('rundb_experiment', 'librarykitbarcode',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.library'
        db.add_column('rundb_experiment', 'library',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.reverselibrarykey'
        db.add_column('rundb_experiment', 'reverselibrarykey',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.barcodeId'
        db.add_column('rundb_experiment', 'barcodeId',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.libraryKey'
        db.add_column('rundb_experiment', 'libraryKey',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.librarykitname'
        db.add_column('rundb_experiment', 'librarykitname',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.reverse3primeadapter'
        db.add_column('rundb_experiment', 'reverse3primeadapter',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


        #restore data for the resurrected fields
        exps = orm.experiment.objects.all()
        for exp in exps:
            ...
            if exp.eas_set:
                ...
                ##print "*** going to restore eas info for exp.id=%s; name=%s" %(str(exp.pk), exp.expName)   
                                    
                exp.forward3primeadapter = str(eas.get("threePrimeAdapter", ""))
                exp.librarykitbarcode = str(eas.get("libraryKitBarcode", ""))
                exp.library = str(eas.get("reference", ""))
                exp.barcodeId = str(eas.get("barcodeKitName", ""))
                exp.libraryKey = str(eas.get("libraryKey", ""))
                exp.librarykitname = str(eas.get("libraryKitName", ""))
                
                exp.save()                
            else:
                print "!!! Warning: NO EAS found to restore data for the resurrected fields for exp.id=%s; name=%s " %(str(exp.pk), exp.expName) 
