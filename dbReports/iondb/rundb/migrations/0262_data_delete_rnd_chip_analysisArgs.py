...
class Migration(DataMigration):
    def forwards(self, orm):
        """
        delete R&D chips and analysis arguments 
        """
        
        for chip in orm.chip.objects.filter(name__in = ["P1.1.17TARS", "P1.1.17AMPS_EXOME", "900TARS", "900AMPS_EXOME", "900v2"]):
            print ">>0262 going to delete chip.pk=%d; name=%s" %(chip.id, chip.name)
            chip.delete()
            
        for analysisArgs in orm.analysisargs.objects.filter(chipType = "900v2"):
            print ">>0262 going to delete analysisArgs.pk=%d; name=%s" %(analysisArgs.id, analysisArgs.name)
            analysisArgs.delete()
