...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.telemetry_enabled'
        db.add_column(u'rundb_globalconfig', 'telemetry_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.telemetry_enabled'
        db.delete_column(u'rundb_globalconfig', 'telemetry_enabled')
