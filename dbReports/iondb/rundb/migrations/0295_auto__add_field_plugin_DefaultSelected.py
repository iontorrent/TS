...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin.defaultSelected'
        db.add_column(u'rundb_plugin', 'defaultSelected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin.defaultSelected'
        db.delete_column(u'rundb_plugin', 'defaultSelected')
