...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        for appl in orm.runtype.objects.all():
            if appl.runType == 'AMPS':
                ...
                seqKitName = 'IonPGM200Kit-v2'
                try:
                    seqKit = orm.kitinfo.objects.get(kitType='SequencingKit', name=seqKitName)
                    
                    applProduct.defaultSequencingKit = seqKit
                    applProduct.defaultPairedEndSequencingKit = seqKit
                except:
                    print "sequencing kit %s not found " % seqKitName
                    
                libKitName = 'Ion AmpliSeq 2.0 Library Kit'
                try:
                    libKit = orm.kitinfo.objects.get(kitType='LibraryKit', name=libKitName)
                    
                    applProduct.defaultLibraryKit = libKit
                except:
                    print "library kit %s not found " % libKitName
                    
                peLibKitName = 'Ion Plus Paired-End Library Kit'
                try:
                    libKit = orm.kitinfo.objects.get(kitType='LibraryKit', name=peLibKitName)
                    
                    applProduct.defaultPairedEndLibraryKit = libKit
                except:
                    print "library kit %s not found " % peLibKitName
                 
                 
                applProduct.defaultChipType = '318' 
 
                ##applProduct.defaultGenomeRefName = 'hg19'
                ##applProduct.defaultTargetRegionBedFileName = 'Regions_1.0_Ion_AmpliSeq_Cancer.bed'
                ##applProduct.defaultHotSpotRegionBedFileName = 'HotSpots_1.0_Ion_AmpliSeq_Cancer.bed'
                
                applProduct.defaultGenomeRefName = ''
                applProduct.defaultTargetRegionBedFileName = ''
                applProduct.defaultHotSpotRegionBedFileName = ''
                                       
                ##print "*** GOING TO SAVE applProduct for %s " % appl.runType                 
                applProduct.save()
            
            else:
                if appl.genetics == 'dna':
                    code = '%s_%s' % (appl.runType, '0')                    
                    name = '%s_%s' % (appl.runType, 'default')
                    ...
                    libKitName = 'IonPlusFragmentLibKit'
                    try:
                        libKit = orm.kitinfo.objects.get(kitType='LibraryKit', name=libKitName)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 19, 11, 18, 675283)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 19, 11, 18, 675188)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 19, 11, 18, 318861)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rundb.runtype': {
            ...
            'genetics': ('django.db.models.fields.CharField', [], {'default': "'dna'", 'max_length': '64', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
