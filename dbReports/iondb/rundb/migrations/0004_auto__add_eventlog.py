...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rundb_eventlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='content_type_set_for_eventlog', to=orm['contenttypes.ContentType'])),
        ...
        db.send_create_signal('rundb', ['EventLog'])


    def backwards(self, orm):
        
        # Deleting model 'EventLog'
        db.delete_table('rundb_eventlog')
    ...
    models = {
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 24, 17, 41, 25, 214046)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
