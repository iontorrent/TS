...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'dnaBarcode.end_sequence'
        db.add_column(u'rundb_dnabarcode', 'end_sequence',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'dnaBarcode.end_adapter'
        db.add_column(u'rundb_dnabarcode', 'end_adapter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'dnaBarcode.is_end_barcode'
        db.add_column(u'rundb_dnabarcode', 'is_end_barcode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'dnaBarcode.end_sequence'
        db.delete_column(u'rundb_dnabarcode', 'end_sequence')

        # Deleting field 'dnaBarcode.end_adapter'
        db.delete_column(u'rundb_dnabarcode', 'end_adapter')

        # Deleting field 'dnaBarcode.is_end_barcode'
        db.delete_column(u'rundb_dnabarcode', 'is_end_barcode')
