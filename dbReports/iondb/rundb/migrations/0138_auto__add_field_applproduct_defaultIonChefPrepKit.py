...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.defaultIonChefPrepKit'
        db.add_column('rundb_applproduct', 'defaultIonChefPrepKit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ionChefPrepKit_applProduct_set', null=True, to=orm['rundb.KitInfo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.defaultIonChefPrepKit'
        db.delete_column('rundb_applproduct', 'defaultIonChefPrepKit_id')
