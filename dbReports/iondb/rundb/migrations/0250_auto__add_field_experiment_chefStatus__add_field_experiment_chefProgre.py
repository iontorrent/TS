...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.chefStatus'
        db.add_column(u'rundb_experiment', 'chefStatus',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefProgress'
        db.add_column(u'rundb_experiment', 'chefProgress',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefMessage'
        db.add_column(u'rundb_experiment', 'chefMessage',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefLastUpdate'
        db.add_column(u'rundb_experiment', 'chefLastUpdate',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefLogPath'
        db.add_column(u'rundb_experiment', 'chefLogPath',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefReagentID'
        db.add_column(u'rundb_experiment', 'chefReagentID',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefLotNumber'
        db.add_column(u'rundb_experiment', 'chefLotNumber',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefManufactureDate'
        db.add_column(u'rundb_experiment', 'chefManufactureDate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chefTipRackBarcode'
        db.add_column(u'rundb_experiment', 'chefTipRackBarcode',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'PlannedExperiment.chefLogPath'
        db.delete_column(u'rundb_plannedexperiment', 'chefLogPath')
    ...
    def backwards(self, orm):
        # Deleting field 'Experiment.chefStatus'
        db.delete_column(u'rundb_experiment', 'chefStatus')

        # Deleting field 'Experiment.chefProgress'
        db.delete_column(u'rundb_experiment', 'chefProgress')

        # Deleting field 'Experiment.chefMessage'
        db.delete_column(u'rundb_experiment', 'chefMessage')

        # Deleting field 'Experiment.chefLastUpdate'
        db.delete_column(u'rundb_experiment', 'chefLastUpdate')

        # Deleting field 'Experiment.chefLogPath'
        db.delete_column(u'rundb_experiment', 'chefLogPath')

        # Deleting field 'Experiment.chefReagentID'
        db.delete_column(u'rundb_experiment', 'chefReagentID')

        # Deleting field 'Experiment.chefLotNumber'
        db.delete_column(u'rundb_experiment', 'chefLotNumber')

        # Deleting field 'Experiment.chefManufactureDate'
        db.delete_column(u'rundb_experiment', 'chefManufactureDate')

        # Deleting field 'Experiment.chefTipRackBarcode'
        db.delete_column(u'rundb_experiment', 'chefTipRackBarcode')
        ...
        # Adding field 'PlannedExperiment.chefLogPath'
        db.add_column(u'rundb_plannedexperiment', 'chefLogPath',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)
