...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlannedExperiment.sampleGrouping'
        db.add_column(u'rundb_plannedexperiment', 'sampleGrouping',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.applicationGroup'
        db.add_column(u'rundb_plannedexperiment', 'applicationGroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.ApplicationGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlannedExperiment.sampleGrouping'
        db.delete_column(u'rundb_plannedexperiment', 'sampleGrouping')

        # Deleting field 'PlannedExperiment.applicationGroup'
        db.delete_column(u'rundb_plannedexperiment', 'applicationGroup_id')
