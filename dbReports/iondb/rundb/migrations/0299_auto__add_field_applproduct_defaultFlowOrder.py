...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.defaultFlowOrder'
        db.add_column(u'rundb_applproduct', 'defaultFlowOrder',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='flowOrder_applProduct_set', null=True, to=orm['rundb.FlowOrder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.defaultFlowOrder'
        db.delete_column(u'rundb_applproduct', 'defaultFlowOrder_id')
