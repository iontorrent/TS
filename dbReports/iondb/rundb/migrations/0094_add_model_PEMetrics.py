...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            ...
            # Adding model 'PEMetrics'
            db.create_table('rundb_pemetrics', (
                ('id', self.gf('django.db.models.fields.AutoField')(primary_key = True)),
                ('pereport', self.gf('django.db.models.fields.related.ForeignKey')(related_name = 'pemetrics_set', to = orm['rundb.Results'])),
                ('pefwdreport', self.gf('django.db.models.fields.related.ForeignKey')(related_name = 'pefwdreport_set', to = orm['rundb.Results'])),
                ('perevreport', self.gf('django.db.models.fields.related.ForeignKey')(related_name = 'perevreport_set', to = orm['rundb.Results'])),
                ('pairingrate', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('fwdandrevcorrected', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('fwdandrevuncorrected', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('fwdnotrev', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalbasesunion', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalbasescorrected', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalbasesunpairedfwd', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalbasesunpairedrev', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq17basesunpairedrev', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq17basesunpairedfwd', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq17basescorrected', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq17basesunion', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq20basesunion', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq20basescorrected', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq20basesunpairedfwd', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalq20basesunpairedrev', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalreadsbasesunpairedrev', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalreadsbasesunpairedfwd', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalreadsbasescorrected', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('totalreadsbasesunion', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('meanlengthunion', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('meanlengthcorrected', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('meanlengthunpairedfwd', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
                ('meanlengthunpairedrev', self.gf('django.db.models.fields.FloatField')(null = True, blank = True)),
            ))
            db.send_create_signal('rundb', ['PEMetrics'])
            db.execute_deferred_sql()
            db.commit_transaction()
        except DatabaseError:
            db.rollback_transaction()
            get_logger().warn("PEMetrics table already exists")
            db.clear_deferred_sql()


    def backwards(self, orm):
        
        # Deleting model 'PEMetrics'
        db.delete_table('rundb_pemetrics')
