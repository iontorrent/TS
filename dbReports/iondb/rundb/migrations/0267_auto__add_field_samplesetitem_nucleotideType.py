...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.nucleotideType'
        db.add_column(u'rundb_samplesetitem', 'nucleotideType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.nucleotideType'
        db.delete_column(u'rundb_samplesetitem', 'nucleotideType')
