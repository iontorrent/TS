...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'rundb_applproduct', 'defaultAvalancheTemplateKit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='avalancheTemplateKit_applProduct_set', null=True, to=orm['rundb.KitInfo']),
                      keep_default=False)

        # Adding field 'ApplProduct.defaultAvalancheSequencingKit'
        db.add_column(u'rundb_applproduct', 'defaultAvalancheSequencingKit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='avalancheSeqKit_applProduct_set', null=True, to=orm['rundb.KitInfo']),
                      keep_default=False)

        # Adding field 'ThreePrimeadapter.chemistryType'
        db.add_column(u'rundb_threeprimeadapter', 'chemistryType',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ThreePrimeadapter.chemistryType'
        db.delete_column(u'rundb_threeprimeadapter', 'chemistryType')
