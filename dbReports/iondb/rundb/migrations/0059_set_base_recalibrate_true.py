...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # There is always only 1 record in the global config table.
        GlobalConfig = orm['rundb.GlobalConfig']
        try:
            gc = GlobalConfig.objects.all()[0]
            gc.base_recalibrate = True
            gc.save()
        except:
            print "No GC object"
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 4, 19, 2, 17, 2593)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 4, 19, 2, 17, 2483)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 4, 19, 2, 16, 505238)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
