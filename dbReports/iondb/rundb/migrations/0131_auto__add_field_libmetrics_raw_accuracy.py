...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LibMetrics.raw_accuracy'
        db.add_column('rundb_libmetrics', 'raw_accuracy',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LibMetrics.raw_accuracy'
        db.delete_column('rundb_libmetrics', 'raw_accuracy')
