...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rundb_plugin', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Plugin.userinputfields'
        db.add_column('rundb_plugin', 'userinputfields',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rundb_plugin', 'description')

        # Deleting field 'Plugin.userinputfields'
        db.delete_column('rundb_plugin', 'userinputfields')
