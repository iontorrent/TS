...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chip.isActive'
        db.add_column('rundb_chip', 'isActive',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Chip.instrumentType'
        db.add_column('rundb_chip', 'instrumentType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chip.isActive'
        db.delete_column('rundb_chip', 'isActive')

        # Deleting field 'Chip.instrumentType'
        db.delete_column('rundb_chip', 'instrumentType')
