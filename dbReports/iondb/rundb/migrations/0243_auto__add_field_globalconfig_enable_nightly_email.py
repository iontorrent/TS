...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.enable_nightly_email'
        db.add_column(u'rundb_globalconfig', 'enable_nightly_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'GlobalConfig.enable_nightly_email'
        db.delete_column(u'rundb_globalconfig', 'enable_nightly_email')
