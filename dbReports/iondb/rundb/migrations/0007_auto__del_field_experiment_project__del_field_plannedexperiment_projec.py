...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Experiment.project'
        db.delete_column('rundb_experiment', 'project')

        # Deleting field 'PlannedExperiment.project'
        db.delete_column('rundb_plannedexperiment', 'project')

        # Adding M2M table for field projects on 'PlannedExperiment'
        db.create_table('rundb_plannedexperiment_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plannedexperiment', models.ForeignKey(orm['rundb.plannedexperiment'], null=False)),
            ('project', models.ForeignKey(orm['rundb.project'], null=False))
        ))
        db.create_unique('rundb_plannedexperiment_projects', ['plannedexperiment_id', 'project_id'])


    def backwards(self, orm):
        
        # Adding field 'Experiment.project'
        db.add_column('rundb_experiment', 'project', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'PlannedExperiment.project'
        db.add_column('rundb_plannedexperiment', 'project', self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True), keep_default=False)

        # Removing M2M table for field projects on 'PlannedExperiment'
        db.delete_table('rundb_plannedexperiment_projects')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 11, 12, 30, 21, 618520)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 11, 12, 30, 21, 618374)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 11, 12, 30, 21, 250381)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
