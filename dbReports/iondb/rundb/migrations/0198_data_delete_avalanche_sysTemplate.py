...
#20130918 change log:
# removed avalance system template

class Migration(SchemaMigration):

    def forwards(self, orm):
        
        sysTemplates = orm.plannedexperiment.objects.filter(isSystemDefault = False, isSystem = True, isReusable = True, planName__icontains = "PGM_Avalanche_Template")
