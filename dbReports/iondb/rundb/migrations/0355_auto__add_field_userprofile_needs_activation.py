...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.needs_activation'
        db.add_column(u'rundb_userprofile', 'needs_activation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.needs_activation'
        db.delete_column(u'rundb_userprofile', 'needs_activation')
