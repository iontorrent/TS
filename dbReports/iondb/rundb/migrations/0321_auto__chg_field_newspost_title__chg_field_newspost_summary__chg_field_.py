...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'rundb_newspost', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'NewsPost.summary'
        db.alter_column(u'rundb_newspost', 'summary', self.gf('django.db.models.fields.TextField')())

        # Changing field 'NewsPost.link'
        db.alter_column(u'rundb_newspost', 'link', self.gf('django.db.models.fields.CharField')(max_length=2083))

        # Changing field 'NewsPost.guid'
        db.alter_column(u'rundb_newspost', 'guid', self.gf('django.db.models.fields.CharField')(max_length=2083, null=True))

    def backwards(self, orm):

        # Changing field 'NewsPost.title'
        db.alter_column(u'rundb_newspost', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'NewsPost.summary'
        db.alter_column(u'rundb_newspost', 'summary', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'NewsPost.link'
        db.alter_column(u'rundb_newspost', 'link', self.gf('django.db.models.fields.CharField')(max_length=2000))

        # Changing field 'NewsPost.guid'
        db.alter_column(u'rundb_newspost', 'guid', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
