...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.sampleSource'
        db.add_column(u'rundb_samplesetitem', 'sampleSource',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.panelPoolType'
        db.add_column(u'rundb_samplesetitem', 'panelPoolType',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.assayGroup'
        db.add_column(u'rundb_samplesetitem', 'assayGroup',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.tubePosition'
        db.add_column(u'rundb_samplesetitem', 'tubePosition',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.sampleSource'
        db.delete_column(u'rundb_samplesetitem', 'sampleSource')

        # Deleting field 'SampleSetItem.panelPoolType'
        db.delete_column(u'rundb_samplesetitem', 'panelPoolType')

        # Deleting field 'SampleSetItem.assayGroup'
        db.delete_column(u'rundb_samplesetitem', 'assayGroup')

        # Deleting field 'SampleSetItem.tubePosition'
        db.delete_column(u'rundb_samplesetitem', 'tubePosition')
