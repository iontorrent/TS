...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FlowOrder'
        db.create_table(u'rundb_floworder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True)),
            ('flowOrder', self.gf('django.db.models.fields.TextField')()),
            ('isActive', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('isSystem', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('isDefault', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'rundb', ['FlowOrder'])


    def backwards(self, orm):
        # Deleting model 'FlowOrder'
        db.delete_table(u'rundb_floworder')
