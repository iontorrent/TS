...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.diskusage'
        db.add_column('rundb_experiment', 'diskusage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Results.diskusage'
        db.add_column('rundb_results', 'diskusage',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.diskusage'
        db.delete_column('rundb_experiment', 'diskusage')

        # Deleting field 'Results.diskusage'
        db.delete_column('rundb_results', 'diskusage')
