...
#20130103 change log:
# removed all system templates of AmpliSeq RNA

class Migration(SchemaMigration):

    def forwards(self, orm):
        
        sysTemplates = orm.plannedexperiment.objects.filter(isSystemDefault = False, isSystem = True, isReusable = True, runType = "AMPS_RNA")
