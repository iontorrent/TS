...
#20120627 change log:
# 1) added genetics info to RunType
# 2) added run mode to LibraryKey
# 3) added run mode to ThreePrimeAdapter

class Migration(SchemaMigration):

    def forwards(self, orm):
               
        #add attributes to LibraryKey, RunType and 3' adapter
        db.add_column('rundb_librarykey', 'runMode', self.gf('django.db.models.fields.CharField') (max_length=64, default='single', blank=True))
        db.add_column('rundb_runtype', 'genetics', self.gf('django.db.models.fields.CharField') (max_length=64, default='dna', blank=True))
        db.add_column('rundb_threeprimeadapter', 'runMode', self.gf('django.db.models.fields.CharField') (max_length=64, default='single', blank=True))


    def backwards(self, orm):
         
        #delete attributes from LibraryKey, RunType and 3' adapter
        db.delete_column('rundb_librarykey', 'runMode')
        db.delete_column('rundb_runtype', 'genetics')
        db.delete_column('rundb_threeprimeadapter', 'runMode')
