...
#20120731 change log:
# 1) changed templating kit name per product management
# 2) changed plannedExperiment's references to templatingKitName
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        templateKit.name = "Ion OneTouch 200 Template Kit v2 DL"
        templateKit.description = "Ion OneTouch 200 Template Kit v2 DL"
        templateKit.save()
        ...
        for plannedExp in orm.plannedexperiment.objects.filter(templatingKitName = "One Touch 200 Template kit v2 DL"):
            #print "*** going to change templatingKitName in plannedExperiment=%s " % (plannedExp.planName) 
            
            plannedExp.templatingKitName = "Ion OneTouch 200 Template Kit v2 DL";
            plannedExp.save()
    ...
    def backwards(self, orm):      
        ...
        templateKit, isCreated = orm.kitinfo.objects.get_or_create(kitType = "TemplatingKit", name = "Ion OneTouch 200 Template Kit v2 DL", 
            description = "Ion OneTouch 200 Template Kit v2 DL", flowCount = 0)

        print "*** REVERT: AFTER get_or_create Ion OneTouch 200 Template Kit v2 DL isCreated=%s " % (str(isCreated)) 

        templateKit.name = "One Touch 200 Template kit v2 DL"
        templateKit.description = "One Touch 200 Template kit v2 DL"
        templateKit.save()

        for plannedExp in orm.plannedexperiment.objects.filter(templatingKitName = "Ion OneTouch 200 Template Kit v2 DL"):
            #print "*** going to REVERT templatingKitName in plannedExperiment=%s " % (plannedExp.planName) 
            
            plannedExp.templatingKitName = "One Touch 200 Template kit v2 DL";
            plannedExp.save()
