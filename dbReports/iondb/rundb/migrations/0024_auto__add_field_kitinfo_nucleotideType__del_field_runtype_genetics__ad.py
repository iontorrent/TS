...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KitInfo.nucleotideType'
        db.add_column('rundb_kitinfo', 'nucleotideType', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Deleting field 'RunType.genetics'
        db.delete_column('rundb_runtype', 'genetics')

        # Adding field 'RunType.nucleotideType'
        db.add_column('rundb_runtype', 'nucleotideType', self.gf('django.db.models.fields.CharField')(default='dna', max_length=64, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'KitInfo.nucleotideType'
        db.delete_column('rundb_kitinfo', 'nucleotideType')

        # Adding field 'RunType.genetics'
        db.add_column('rundb_runtype', 'genetics', self.gf('django.db.models.fields.CharField')(default='dna', max_length=64, blank=True), keep_default=False)

        # Deleting field 'RunType.nucleotideType'
        db.delete_column('rundb_runtype', 'nucleotideType')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 14, 33, 31, 293899)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 14, 33, 31, 293796)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 14, 33, 30, 502575)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
