            ...
            if 'IonReporterUploader' in selected_plugins:
                ...
                if 'userInput' in iru:
                    ...
                    if 'userInputInfo' in iru['userInput']:
                        ...
                        if type(uii) == types.ListType:
                            for ui1 in uii:
                                if type(ui1) == types.DictType:
                                    ui1['ApplicationType'] = ""
                        elif type(uii) == types.DictType:
                            iru['userInput']['userInputInfo'] = [uii]
                            for ui1 in uii:
                                if type(ui1) == types.DictType:
                                    ui1['ApplicationType'] = ""
                    else:
                        ...
                        for uii in iru['userInput']['userInputInfo']:
                            if type(uii) == types.DictType:
                                uii['ApplicationType'] = ""
                                uii['sampleDescription'] = ""
                                uii['sampleExternalId'] = ""
                else:
                    iru['userInput'] = dict(
                        accountName = "",
                        accountId = "",
