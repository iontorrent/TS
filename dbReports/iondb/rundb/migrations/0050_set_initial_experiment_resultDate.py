...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        experiments = Experiment.objects.prefetch_related('results_set').annotate(repdate=Max('results__timeStamp'))
        for experiment in experiments:
            experiment.resultDate = experiment.repdate or experiment.date
            experiment.save()


    def backwards(self, orm):
        "Since we're not storing the old value, nothing to do here."
        pass
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 17, 36, 42, 127664)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 17, 36, 42, 127538)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 17, 36, 42, 63124)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
