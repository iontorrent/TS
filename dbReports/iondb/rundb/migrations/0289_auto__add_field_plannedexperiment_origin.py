...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlannedExperiment.origin'
        db.add_column(u'rundb_plannedexperiment', 'origin',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlannedExperiment.origin'
        db.delete_column(u'rundb_plannedexperiment', 'origin')
