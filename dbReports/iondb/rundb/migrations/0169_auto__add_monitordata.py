...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonitorData'
        db.create_table(u'rundb_monitordata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('treeDat', self.gf('django.db.models.fields.TextField')(default='{}', blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
        ))
        db.send_create_signal(u'rundb', ['MonitorData'])


    def backwards(self, orm):
        # Deleting model 'MonitorData'
        db.delete_table(u'rundb_monitordata')
