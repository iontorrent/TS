...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LibMetrics.total_mapped_reads'
        db.add_column('rundb_libmetrics', 'total_mapped_reads',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LibMetrics.total_mapped_target_bases'
        db.add_column('rundb_libmetrics', 'total_mapped_target_bases',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LibMetrics.total_mapped_reads'
        db.delete_column('rundb_libmetrics', 'total_mapped_reads')

        # Deleting field 'LibMetrics.total_mapped_target_bases'
        db.delete_column('rundb_libmetrics', 'total_mapped_target_bases')
