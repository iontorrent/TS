...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PlannedExperiment.flowsInOrder'
        db.delete_column(u'rundb_plannedexperiment', 'flowsInOrder')


    def backwards(self, orm):

        # Changing field 'Experiment.flowsInOrder'
        db.alter_column(u'rundb_experiment', 'flowsInOrder', self.gf('django.db.models.fields.CharField')(max_length=512))
        # Adding field 'PlannedExperiment.flowsInOrder'
        db.add_column(u'rundb_plannedexperiment', 'flowsInOrder',
