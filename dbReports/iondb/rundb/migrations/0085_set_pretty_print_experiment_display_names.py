...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        "There is no meaningful backwards migration."
        pass
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 0, 16, 1, 742172)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 18, 0, 16, 1, 742065)'}),
