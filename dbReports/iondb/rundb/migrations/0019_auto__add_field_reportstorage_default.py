...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportStorage.default'
        db.add_column('rundb_reportstorage', 'default', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReportStorage.default'
        db.delete_column('rundb_reportstorage', 'default')
