...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.defaultIonChefSequencingKit'
        db.add_column(u'rundb_applproduct', 'defaultIonChefSequencingKit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ionChefSeqKit_applProduct_set', null=True, to=orm['rundb.KitInfo']),
                      keep_default=False)

        # Adding field 'ApplProduct.isTargetTechniqueSelectionSupported'
        db.add_column(u'rundb_applproduct', 'isTargetTechniqueSelectionSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ApplProduct.isTargetRegionBEDFileSupported'
        db.add_column(u'rundb_applproduct', 'isTargetRegionBEDFileSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ApplProduct.isControlSeqTypeBySampleSupported'
        db.add_column(u'rundb_applproduct', 'isControlSeqTypeBySampleSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApplProduct.isReferenceBySampleSupported'
        db.add_column(u'rundb_applproduct', 'isReferenceBySampleSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApplProduct.isDualNucelotideTypeBySampleSupported'
        db.add_column(u'rundb_applproduct', 'isDualNucelotideTypeBySampleSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.defaultIonChefSequencingKit'
        db.delete_column(u'rundb_applproduct', 'defaultIonChefSequencingKit_id')

        # Deleting field 'ApplProduct.isTargetTechniqueSelectionSupported'
        db.delete_column(u'rundb_applproduct', 'isTargetTechniqueSelectionSupported')

        # Deleting field 'ApplProduct.isTargetRegionBEDFileSupported'
        db.delete_column(u'rundb_applproduct', 'isTargetRegionBEDFileSupported')

        # Deleting field 'ApplProduct.isControlSeqTypeBySampleSupported'
        db.delete_column(u'rundb_applproduct', 'isControlSeqTypeBySampleSupported')

        # Deleting field 'ApplProduct.isReferenceBySampleSupported'
        db.delete_column(u'rundb_applproduct', 'isReferenceBySampleSupported')

        # Deleting field 'ApplProduct.isDualNucelotideTypeBySampleSupported'
        db.delete_column(u'rundb_applproduct', 'isDualNucelotideTypeBySampleSupported')
