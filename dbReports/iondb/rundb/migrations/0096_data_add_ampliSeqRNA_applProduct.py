...
#20121028 change log:
# 1) added applProduct for AmpliSeq RNA
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #TODO NOTES: library kit value is temporary - to be replaced with the final library kit
        defaultLibKit = orm.kitinfo.objects.get(kitType = "LibraryKit", name__exact = "Ion AmpliSeq 2.0 Library Kit")
        defaultTemplateKit = orm.kitinfo.objects.get(kitType = "TemplatingKit", name__iexact = "Ion OneTouch 200 Template Kit v2 DL")
        defaultSeqKit = orm.kitinfo.objects.get(kitType = "SequencingKit", name__iexact = "IonPGM200Kit")
                                
        # update applProduct data
        counter = 0
        for appl in orm.runtype.objects.filter(runType = "AMPS_RNA"):
            code = '%s_%s' % (appl.runType, str(counter))
            ...
            applProduct.defaultVariantFrequency =''
