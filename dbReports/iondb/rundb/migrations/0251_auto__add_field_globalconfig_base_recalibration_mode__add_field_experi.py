...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.base_recalibration_mode'
        db.add_column(u'rundb_globalconfig', 'base_recalibration_mode',
                      self.gf('django.db.models.fields.CharField')(default='standard_recal', max_length=64),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.base_recalibration_mode'
        db.add_column(u'rundb_experimentanalysissettings', 'base_recalibration_mode',
                      self.gf('django.db.models.fields.CharField')(default='standard_recal', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.base_recalibration_mode'
        db.delete_column(u'rundb_globalconfig', 'base_recalibration_mode')

        # Deleting field 'ExperimentAnalysisSettings.base_recalibration_mode'
        db.delete_column(u'rundb_experimentanalysissettings', 'base_recalibration_mode')
