...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventLog.username'
        db.add_column('rundb_eventlog', 'username', self.gf('django.db.models.fields.CharField')(default='ION', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventLog.username'
        db.delete_column('rundb_eventlog', 'username')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 6, 17, 3, 26, 25292)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 6, 17, 3, 26, 25167)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 6, 17, 3, 25, 659941)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
