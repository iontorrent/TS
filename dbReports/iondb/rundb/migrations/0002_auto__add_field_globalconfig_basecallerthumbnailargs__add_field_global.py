...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GlobalConfig.basecallerthumbnailargs'
        db.delete_column('rundb_globalconfig', 'basecallerthumbnailargs')

        # Deleting field 'GlobalConfig.analysisthumbnailargs'
        db.delete_column('rundb_globalconfig', 'analysisthumbnailargs')
    ...
    models = {
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 3, 15, 10, 45, 317798)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
