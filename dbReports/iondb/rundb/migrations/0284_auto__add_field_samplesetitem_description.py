...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.description'
        db.add_column(u'rundb_samplesetitem', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.description'
        db.delete_column(u'rundb_samplesetitem', 'description')
