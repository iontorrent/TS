...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        appl, isCreated =orm.runtype.objects.get_or_create(runType = "RNA",
            description = "RNA Sequencing",
            nucleotideType = "rna")
                    
        print "*** AFTER get_or_create runType for RNA isCreated=%s " % (str(isCreated)) 
    ...
    def backwards(self, orm):
        ...
        for appl in orm.runtype.objects.filter(runType = "RNA"):
            ...
            print "*** AFTER runType RNA is deleted "
