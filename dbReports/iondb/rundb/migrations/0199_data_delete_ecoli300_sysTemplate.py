...
#20130920 change log:
# removed dh10b 300 system template

class Migration(SchemaMigration):

    def forwards(self, orm):
        
        sysTemplates = orm.plannedexperiment.objects.filter(isSystemDefault = False, isSystem = True, isReusable = True, planDisplayedName__icontains = "Ion PGM E_coli DH10B Control 300")

        for sysTemplate in sysTemplates:
            print "*** Going to delete system template=%s " %(sysTemplate.planName)
            sysTemplate.delete()                
