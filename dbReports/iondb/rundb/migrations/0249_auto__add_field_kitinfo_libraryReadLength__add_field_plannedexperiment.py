...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KitInfo.libraryReadLength'
        db.add_column(u'rundb_kitinfo', 'libraryReadLength',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PlannedExperiment.libraryReadLength'
        db.add_column(u'rundb_plannedexperiment', 'libraryReadLength',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KitInfo.libraryReadLength'
        db.delete_column(u'rundb_kitinfo', 'libraryReadLength')

        # Deleting field 'PlannedExperiment.libraryReadLength'
        db.delete_column(u'rundb_plannedexperiment', 'libraryReadLength')
