...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlannedExperiment.samplePrepProtocol'
        db.alter_column(u'rundb_plannedexperiment', 'samplePrepProtocol', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True))
