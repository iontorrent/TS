...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # first we are going to have to remove the old IonCode barcodes
        for dnaBarcode in orm.dnaBarcode.objects.filter(name='IonCode'):
            dnaBarcode.delete()

        start = 'rundb/fixtures/barcodes/5.14/'
        # fixtures path is different for manual vs ion-dbreports install
        if not os.path.exists('rundb/fixtures'):
            start = 'iondb/rundb/fixtures/barcodes/5.14/'

        management.call_command('loaddata', start + 'IonCode_v4.json')
