...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KitInfo.applicationType'
        db.add_column(u'rundb_kitinfo', 'applicationType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, null=True, blank=True),
                      keep_default=False)


        # Changing field 'KitInfo.kitType'
        db.alter_column(u'rundb_kitinfo', 'kitType', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):
        # Deleting field 'KitInfo.applicationType'
        db.delete_column(u'rundb_kitinfo', 'applicationType')


        # Changing field 'KitInfo.kitType'
        db.alter_column(u'rundb_kitinfo', 'kitType', self.gf('django.db.models.fields.CharField')(max_length=20))
