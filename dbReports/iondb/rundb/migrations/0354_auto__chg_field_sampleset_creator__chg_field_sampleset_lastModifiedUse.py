...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SampleSet.creator'
        db.alter_column(u'rundb_sampleset', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'SampleSet.lastModifiedUser'
        db.alter_column(u'rundb_sampleset', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'Project.creator'
        db.alter_column(u'rundb_project', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.SET_DEFAULT))

        # Changing field 'SampleAttribute.creator'
        db.alter_column(u'rundb_sampleattribute', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'SampleAttribute.lastModifiedUser'
        db.alter_column(u'rundb_sampleattribute', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'SampleAttributeValue.creator'
        db.alter_column(u'rundb_sampleattributevalue', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'SampleAttributeValue.lastModifiedUser'
        db.alter_column(u'rundb_sampleattributevalue', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'SampleSetItem.creator'
        db.alter_column(u'rundb_samplesetitem', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'SampleSetItem.lastModifiedUser'
        db.alter_column(u'rundb_samplesetitem', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_DEFAULT, to=orm['auth.User']))

        # Changing field 'AnalysisArgs.creator'
        db.alter_column(u'rundb_analysisargs', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'AnalysisArgs.lastModifiedUser'
        db.alter_column(u'rundb_analysisargs', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'PluginResult.owner'
        db.alter_column(u'rundb_pluginresult', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.SET_DEFAULT))

        # Changing field 'SupportUpload.user'
        db.alter_column(u'rundb_supportupload', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.SET_DEFAULT))

    def backwards(self, orm):

        # Changing field 'SampleSet.creator'
        db.alter_column(u'rundb_sampleset', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SampleSet.lastModifiedUser'
        db.alter_column(u'rundb_sampleset', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Project.creator'
        db.alter_column(u'rundb_project', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SampleAttribute.creator'
        db.alter_column(u'rundb_sampleattribute', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SampleAttribute.lastModifiedUser'
        db.alter_column(u'rundb_sampleattribute', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SampleAttributeValue.creator'
        db.alter_column(u'rundb_sampleattributevalue', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SampleAttributeValue.lastModifiedUser'
        db.alter_column(u'rundb_sampleattributevalue', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SampleSetItem.creator'
        db.alter_column(u'rundb_samplesetitem', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SampleSetItem.lastModifiedUser'
        db.alter_column(u'rundb_samplesetitem', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'AnalysisArgs.creator'
        db.alter_column(u'rundb_analysisargs', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AnalysisArgs.lastModifiedUser'
        db.alter_column(u'rundb_analysisargs', 'lastModifiedUser_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'PluginResult.owner'
        db.alter_column(u'rundb_pluginresult', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'SupportUpload.user'
        db.alter_column(u'rundb_supportupload', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'rundb.analysisargs': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_analysisArgs'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'lastModifiedUser': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'lastModified_analysisArgs'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'rundb.applproduct': {
            ...
            'dualBarcodingRule': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'isDualBarcodingBySampleSupported': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'rundb.content': {
            ...
            'application_tags': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            ...
            'extra': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
        ...
        u'rundb.contentupload': {
            ...
            'upload_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'upload_type': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
        ...
        u'rundb.dnabarcode': {
            ...
            'end_adapter': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'end_sequence': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_str': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'index': ('django.db.models.fields.IntegerField', [], {}),
            'is_end_barcode': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'rundb.experiment': {
            ...
            'chefEndTime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'chefFlexibleWorkflow': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            ...
            'chefOperationMode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            ...
            'chefProtocolDeviationName': ('django.db.models.fields.CharField', [], {'max_length': '127', 'null': 'True', 'blank': 'True'}),
            ...
            'chefReagentsSerialNum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'blank': 'True'}),
            'chefRemainingSeconds': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'chefSolutionsSerialNum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'blank': 'True'}),
            'chefStartTime': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'flowsInOrder': ('django.db.models.fields.CharField', [], {'max_length': '1200', 'blank': 'True'}),
        ...
        u'rundb.experimentanalysissettings': {
            ...
            'endBarcodeKitName': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'sseBedFile': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512', 'blank': 'True'}),
        ...
        u'rundb.floworder': {
            ...
            'flowOrder': ('django.db.models.fields.CharField', [], {'max_length': '1200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isActive': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'isDefault': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isSystem': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'rundb.globalconfig': {
            ...
            'telemetry_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'rundb.kitinfo': {
            ...
            'cartridgeBetweenUsageAbsoluteMaxDayLimit': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cartridgeExpirationDayLimit': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'categories': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'chipTypes': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '127', 'blank': 'True'}),
            'defaultCartridgeUsageCount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'rundb.newspost': {
            ...
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '2083', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2083', 'blank': 'True'}),
        ...
        u'rundb.plannedexperiment': {
            ...
            'categories': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            ...
            'isCustom_kitSettings': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isFavorite': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'isPlanGroup': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isReusable': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'isReverseRun': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isSystem': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'planStatus': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512', 'db_index': 'True', 'blank': 'True'}),
            ...
            'reverse_primer': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'runMode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            'runType': ('django.db.models.fields.CharField', [], {'default': "'GENS'", 'max_length': '512', 'db_index': 'True'}),
        ...
        u'rundb.plansession': {
            ...
            '_session_data': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan_key': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
        ...
        u'rundb.plugin': {
            ...
            'requires_configuration': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'rundb.pluginresult': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.SET_DEFAULT'}),
            ...
            'validation_errors': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'blank': 'True'})
        },
        ...
        u'rundb.project': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.SET_DEFAULT'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'rundb.rig': {
            ...
            'comments': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'display_state': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
        ...
        u'rundb.sampleattribute': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_sampleAttribute'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"}),
            ...
            'lastModifiedUser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lastModified_sampleAttribute'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"})
        },
        ...
        u'rundb.sampleattributevalue': {
            ...
            'creationDate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_sampleAttributeValue'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastModifiedDate': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'lastModifiedUser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lastModified_sampleAttributeValue'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"}),
        ...
        u'rundb.sampleprepdata': {
            ...
            'operationMode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            ...
            'remainingSeconds': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'rundb.sampleset': {
            ...
            'creationDate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_sampleSet'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'displayedName': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '127'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastModifiedDate': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'lastModifiedUser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lastModified_sampleSet'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"}),
        ...
        u'rundb.samplesetitem': {
            ...
            'cellNum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '127', 'null': 'True', 'blank': 'True'}),
            ...
            'creationDate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_sampleSetItem'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'dnabarcode': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'startBarcode'", 'null': 'True', 'to': u"orm['rundb.dnaBarcode']"}),
            'embryoId': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '127', 'null': 'True', 'blank': 'True'}),
            'endDnabarcode': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'endBarcode'", 'null': 'True', 'to': u"orm['rundb.dnaBarcode']"}),
            'gender': ('django.db.models.fields.CharField', [], {'max_length': '127', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastModifiedDate': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'lastModifiedUser': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lastModified_sampleSetItem'", 'on_delete': 'models.SET_DEFAULT', 'to': u"orm['auth.User']"}),
            'nucleotideType': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
        ...
        u'rundb.supportupload': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.SET_DEFAULT'})
        },
        u'rundb.template': {
