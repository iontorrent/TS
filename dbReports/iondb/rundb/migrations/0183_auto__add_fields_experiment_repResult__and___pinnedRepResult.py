...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.repResult'
        db.add_column(u'rundb_experiment', 'repResult',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='+', unique=True, null=True, to=orm['rundb.Results']),
                      keep_default=False)

        # Adding field 'Experiment.pinnedRepResult'
        db.add_column(u'rundb_experiment', 'pinnedRepResult',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.repResult'
        db.delete_column(u'rundb_experiment', 'repResult_id')

        # Deleting field 'Experiment.pinnedRepResult'
        db.delete_column(u'rundb_experiment', 'pinnedRepResult')
