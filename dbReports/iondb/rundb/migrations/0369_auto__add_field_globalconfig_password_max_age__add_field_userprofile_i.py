...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.password_max_age'
        db.add_column(u'rundb_globalconfig', 'password_max_age',
                      self.gf('django.db.models.fields.IntegerField')(default=90, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.is_password_valid'
        db.add_column(u'rundb_userprofile', 'is_password_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.last_password_changed_on'
        db.add_column(u'rundb_userprofile', 'last_password_changed_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1984, 11, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.password_max_age'
        db.delete_column(u'rundb_globalconfig', 'password_max_age')

        # Deleting field 'UserProfile.is_password_valid'
        db.delete_column(u'rundb_userprofile', 'is_password_valid')

        # Deleting field 'UserProfile.last_password_changed_on'
        db.delete_column(u'rundb_userprofile', 'last_password_changed_on')
    ...
    models = {
        ...
        u'rundb.globalconfig': {
            ...
            'password_max_age': ('django.db.models.fields.IntegerField', [], {'default': '90', 'blank': 'True'}),
        ...
        u'rundb.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_password_valid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_password_changed_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1984, 11, 5, 0, 0)'}),
