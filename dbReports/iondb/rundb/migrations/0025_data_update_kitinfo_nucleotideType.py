...
#20120705 change log:
# initialize nucleotideType value in kitInfo
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # update nucleotideType in kitInfo
        kitInfos = orm.kitinfo.objects.filter(kitType = 'LibraryKit')
        for kitInfo in kitInfos:
            if 'rna' in kitInfo.name.lower():
                kitInfo.nucleotideType = 'rna'
            else:
                kitInfo.nucleotideType = 'dna'
    ...
    def backwards(self, orm):
        ...
        # revert nucleotideType in kitInfo
        kitInfos = orm.kitinfo.objects.filter(kitType = 'LibraryKit')
        for kitInfo in kitInfos:
            kitInfo.nucleotideType = ''                
            kitInfo.save()
