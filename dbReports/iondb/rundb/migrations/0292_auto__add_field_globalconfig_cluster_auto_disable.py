...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.cluster_auto_disable'
        db.add_column(u'rundb_globalconfig', 'cluster_auto_disable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.cluster_auto_disable'
        db.delete_column(u'rundb_globalconfig', 'cluster_auto_disable')
