...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.enabled'
        db.add_column(u'rundb_content', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Content.type'
        db.add_column(u'rundb_content', 'type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'Content.description'
        db.add_column(u'rundb_content', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Content.notes'
        db.add_column(u'rundb_content', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Content.extra'
        db.add_column(u'rundb_content', 'extra',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'ContentUpload.upload_date'
        db.add_column(u'rundb_contentupload', 'upload_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContentUpload.upload_type'
        db.add_column(u'rundb_contentupload', 'upload_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'ContentUpload.username'
        db.add_column(u'rundb_contentupload', 'username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'ContentUpload.source'
        db.add_column(u'rundb_contentupload', 'source',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.enabled'
        db.delete_column(u'rundb_content', 'enabled')

        # Deleting field 'Content.type'
        db.delete_column(u'rundb_content', 'type')

        # Deleting field 'Content.description'
        db.delete_column(u'rundb_content', 'description')

        # Deleting field 'Content.notes'
        db.delete_column(u'rundb_content', 'notes')

        # Deleting field 'Content.extra'
        db.delete_column(u'rundb_content', 'extra')

        # Deleting field 'ContentUpload.upload_date'
        db.delete_column(u'rundb_contentupload', 'upload_date')

        # Deleting field 'ContentUpload.upload_type'
        db.delete_column(u'rundb_contentupload', 'upload_type')

        # Deleting field 'ContentUpload.username'
        db.delete_column(u'rundb_contentupload', 'username')

        # Deleting field 'ContentUpload.source'
        db.delete_column(u'rundb_contentupload', 'source')
