...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ThreePrimeadapter.adapter_cutoff'
        db.delete_column('rundb_threeprimeadapter', 'adapter_cutoff')

        # Deleting field 'ThreePrimeadapter.qual_window'
        db.delete_column('rundb_threeprimeadapter', 'qual_window')

        # Deleting field 'ThreePrimeadapter.qual_cutoff'
        db.delete_column('rundb_threeprimeadapter', 'qual_cutoff')


    def backwards(self, orm):
        # Adding field 'ThreePrimeadapter.adapter_cutoff'
        db.add_column('rundb_threeprimeadapter', 'adapter_cutoff',
                      self.gf('django.db.models.fields.IntegerField')(default=16),
                      keep_default=False)

        # Adding field 'ThreePrimeadapter.qual_window'
        db.add_column('rundb_threeprimeadapter', 'qual_window',
                      self.gf('django.db.models.fields.IntegerField')(default=30),
                      keep_default=False)

        # Adding field 'ThreePrimeadapter.qual_cutoff'
        db.add_column('rundb_threeprimeadapter', 'qual_cutoff',
