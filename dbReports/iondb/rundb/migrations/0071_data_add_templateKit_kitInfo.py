...
#20120824 change log:
# 1) added PGM One Touch 300 templating kit
...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):       
        # revert addition of templating kit
        try:
            templateKit = orm.kitinfo.objects.get(kitType = "TemplatingKit", name = "Ion PGM Template OT 300 Kit") 
            templateKit.delete()
        except:            
            print "*** Cannot delete templating kit Ion PGM Template OT 300 Kit " 
