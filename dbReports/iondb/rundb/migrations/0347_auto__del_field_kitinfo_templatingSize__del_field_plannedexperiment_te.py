...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'KitInfo.templatingSize'
        db.delete_column(u'rundb_kitinfo', 'templatingSize')

        # Deleting field 'PlannedExperiment.templatingSize'
        db.delete_column(u'rundb_plannedexperiment', 'templatingSize')


    def backwards(self, orm):
        # Adding field 'KitInfo.templatingSize'
        db.add_column(u'rundb_kitinfo', 'templatingSize',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.templatingSize'
        db.add_column(u'rundb_plannedexperiment', 'templatingSize',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, null=True, blank=True),
                      keep_default=False)
