...
#20120627 change log:
# 1) increased notes attribute length in PlannedExperiment 
# 2) increased notes attribute length in Experiment
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rundb_plannedexperiment', 'notes',  self.gf('django.db.models.fields.CharField')(max_length=1024,null=True, blank=True))
        db.alter_column('rundb_experiment', 'notes',  self.gf('django.db.models.fields.CharField')(max_length=1024,null=True, blank=True))
        

    def backwards(self, orm):
         
        # revert attribute length increase
        db.alter_column('rundb_plannedexperiment', 'notes',  self.gf('django.db.models.fields.CharField')(max_length=255,null=True, blank=True))
        db.alter_column('rundb_experiment', 'notes',  self.gf('django.db.models.fields.CharField')(max_length=128,null=True, blank=True))
