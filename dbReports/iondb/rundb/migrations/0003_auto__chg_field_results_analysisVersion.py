...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Results.analysisVersion'
        db.alter_column('rundb_results', 'analysisVersion', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'Results.analysisVersion'
        db.alter_column('rundb_results', 'analysisVersion', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 6, 8, 59, 36, 449630)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
