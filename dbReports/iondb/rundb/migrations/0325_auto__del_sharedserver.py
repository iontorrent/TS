...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SharedServer'
        db.delete_table(u'rundb_sharedserver')


    def backwards(self, orm):
        # Adding model 'SharedServer'
        db.create_table(u'rundb_sharedserver', (
        ...
        db.send_create_signal(u'rundb', ['SharedServer'])
