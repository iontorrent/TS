...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.mixedTypeRNA_reference'
        db.add_column(u'rundb_experimentanalysissettings', 'mixedTypeRNA_reference',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.mixedTypeRNA_targetRegionBedFile'
        db.add_column(u'rundb_experimentanalysissettings', 'mixedTypeRNA_targetRegionBedFile',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.mixedTypeRNA_hotSpotRegionBedFile'
        db.add_column(u'rundb_experimentanalysissettings', 'mixedTypeRNA_hotSpotRegionBedFile',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.mixedTypeRNA_reference'
        db.delete_column(u'rundb_experimentanalysissettings', 'mixedTypeRNA_reference')

        # Deleting field 'ExperimentAnalysisSettings.mixedTypeRNA_targetRegionBedFile'
        db.delete_column(u'rundb_experimentanalysissettings', 'mixedTypeRNA_targetRegionBedFile')

        # Deleting field 'ExperimentAnalysisSettings.mixedTypeRNA_hotSpotRegionBedFile'
        db.delete_column(u'rundb_experimentanalysissettings', 'mixedTypeRNA_hotSpotRegionBedFile')
