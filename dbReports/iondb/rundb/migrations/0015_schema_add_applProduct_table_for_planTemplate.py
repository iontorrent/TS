...
#20120627 change log:
# added application product table to define its characteristics and default properties
#
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #add table ApplProduct
        db.create_table('rundb_applproduct', (
            ('id', models.AutoField(primary_key=True)),
            ('productCode', models.CharField(max_length = 64, default='any', unique=True)),
            ('productName', models.CharField(max_length = 128)),
            ('description', models.CharField(max_length = 1024, blank=True)),
            ('applType', models.ForeignKey(orm['rundb.RunType'])),
            ...
            ('defaultSequencingKit', models.ForeignKey(orm['rundb.kitinfo'], related_name='seqKit_applProduct_set', null=True)),
            ('defaultLibraryKit', models.ForeignKey(orm['rundb.kitinfo'], related_name='libKit_applProduct_set', null=True)),
            ('defaultPairedEndSequencingKit', models.ForeignKey(orm['rundb.kitinfo'], related_name='peSeqKit_applProduct_set', null=True)),
            ('defaultPairedEndLibraryKit', models.ForeignKey(orm['rundb.kitinfo'], related_name='peLibKit_applProduct_set', null=True)),
            ('defaultGenomeRefName', models.CharField(max_length = 512, blank=True, null=True)),
        ...
        db.send_create_signal('rundb', ['applproduct'])

        # Adding unique constraint on 'ApplProduct', fields ['productCode']
        db.create_unique('rundb_applproduct', ['productCode'])


    def backwards(self, orm):

        # Removing unique constraint on 'ApplProduct', fields ['productCode']
        db.delete_unique('rundb_applproduct', ['productCode'])

        #delete table ApplProduct 
        db.delete_table('rundb_applproduct')
