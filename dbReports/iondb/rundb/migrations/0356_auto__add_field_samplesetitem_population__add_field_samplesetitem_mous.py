...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.population'
        db.add_column(u'rundb_samplesetitem', 'population',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.mouseStrains'
        db.add_column(u'rundb_samplesetitem', 'mouseStrains',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.population'
        db.delete_column(u'rundb_samplesetitem', 'population')

        # Deleting field 'SampleSetItem.mouseStrains'
        db.delete_column(u'rundb_samplesetitem', 'mouseStrains')
