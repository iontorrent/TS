...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.applicationGroup'
        db.add_column(u'rundb_applproduct', 'applicationGroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.ApplicationGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.applicationGroup'
        db.delete_column(u'rundb_applproduct', 'applicationGroup_id')
