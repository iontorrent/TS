...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rundb_plansession', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session_key', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('plan_key', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('expire_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('_session_data', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'rundb', ['PlanSession'])


    def backwards(self, orm):
        # Deleting model 'PlanSession'
        db.delete_table(u'rundb_plansession')
