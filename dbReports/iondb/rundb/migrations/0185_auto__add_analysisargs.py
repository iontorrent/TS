...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnalysisArgs'
        db.create_table(u'rundb_analysisargs', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
            ('sequenceKitName', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
            ('chipType', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('chip_default', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('libraryKitName', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
            ('templateKitName', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
            ('beadfindargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('thumbnailbeadfindargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('analysisargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('thumbnailanalysisargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('prebasecallerargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('prethumbnailbasecallerargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('basecallerargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('thumbnailbasecallerargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('alignmentargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
            ('thumbnailalignmentargs', self.gf('django.db.models.fields.CharField')(max_length=5000, blank=True)),
        ))
        db.send_create_signal(u'rundb', ['AnalysisArgs'])


    def backwards(self, orm):
        # Deleting model 'AnalysisArgs'
        db.delete_table(u'rundb_analysisargs')
    ...
    models = {
        ...
        u'rundb.analysisargs': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'libraryKitName': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512'}),
            ...
            'sequenceKitName': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512'}),
            'templateKitName': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '512'}),
