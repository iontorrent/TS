...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PluginResultJob'
        db.create_table(u'rundb_pluginresultjob', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('grid_engine_jobid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('run_level', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ...
            ('config', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('plugin_result', self.gf('django.db.models.fields.related.ForeignKey')(related_name='plugin_result_jobs', to=orm['rundb.PluginResult'])),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'rundb', ['PluginResultJob'])


    def backwards(self, orm):
        # Deleting model 'PluginResultJob'
        db.delete_table(u'rundb_pluginresultjob')
