...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplProduct.defaultFlowCount'
        db.add_column('rundb_applproduct', 'defaultFlowCount', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'ApplProduct.defaultPairedEndAdapterKit'
        db.add_column('rundb_applproduct', 'defaultPairedEndAdapterKit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='peAdapterKit_applProduct_set', null=True, to=orm['rundb.KitInfo']), keep_default=False)

        # Adding field 'ApplProduct.defaultTemplateKit'
        db.add_column('rundb_applproduct', 'defaultTemplateKit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='templateKit_applProduct_set', null=True, to=orm['rundb.KitInfo']), keep_default=False)

        # Adding field 'ApplProduct.defaultControlSeqKit'
        db.add_column('rundb_applproduct', 'defaultControlSeqKit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='controlSeqKit_applProduct_set', null=True, to=orm['rundb.KitInfo']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplProduct.defaultFlowCount'
        db.delete_column('rundb_applproduct', 'defaultFlowCount')

        # Deleting field 'ApplProduct.defaultPairedEndAdapterKit'
        db.delete_column('rundb_applproduct', 'defaultPairedEndAdapterKit_id')

        # Deleting field 'ApplProduct.defaultTemplateKit'
        db.delete_column('rundb_applproduct', 'defaultTemplateKit_id')

        # Deleting field 'ApplProduct.defaultControlSeqKit'
        db.delete_column('rundb_applproduct', 'defaultControlSeqKit_id')
