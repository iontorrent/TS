...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisArgs.samplePrepKitName'
        db.add_column(u'rundb_analysisargs', 'samplePrepKitName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalysisArgs.samplePrepKitName'
        db.delete_column(u'rundb_analysisargs', 'samplePrepKitName')
