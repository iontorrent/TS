...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.isHotspotRegionBEDFileSuppported'
        db.add_column('rundb_applproduct', 'isHotspotRegionBEDFileSuppported',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.isHotspotRegionBEDFileSuppported'
        db.delete_column('rundb_applproduct', 'isHotspotRegionBEDFileSuppported')
