...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SamplePrepData'
        db.create_table(u'rundb_sampleprepdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instrumentName', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('instrumentStatus', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('lastUpdate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('samplePrepDataType', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('progress', self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('logPath', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('tipRackBarcode', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('kitType', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('reagentsPart', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('reagentsLot', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('reagentsExpiration', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('solutionsPart', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('solutionsLot', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('solutionsExpiration', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('packageVer', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
            ('scriptVersion', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True)),
        ))
        db.send_create_signal(u'rundb', ['SamplePrepData'])

        # Adding field 'SampleSet.libraryPrepInstrument'
        db.add_column(u'rundb_sampleset', 'libraryPrepInstrument',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'SampleSet.libraryPrepType'
        db.add_column(u'rundb_sampleset', 'libraryPrepType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'SampleSet.libraryPrepPlateType'
        db.add_column(u'rundb_sampleset', 'libraryPrepPlateType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'SampleSet.combinedLibraryTubeLabel'
        db.add_column(u'rundb_sampleset', 'combinedLibraryTubeLabel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'SampleSet.libraryPrepInstrumentData'
        db.add_column(u'rundb_sampleset', 'libraryPrepInstrumentData',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='libraryPrepData_sampleSet', null=True, to=orm['rundb.SamplePrepData']),
                      keep_default=False)

        # Adding field 'SampleSetItem.pcrPlateSerialNum'
        db.add_column(u'rundb_samplesetitem', 'pcrPlateSerialNum',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.pcrPlateColumn'
        db.add_column(u'rundb_samplesetitem', 'pcrPlateColumn',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.pcrPlateRow'
        db.add_column(u'rundb_samplesetitem', 'pcrPlateRow',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SamplePrepData'
        db.delete_table(u'rundb_sampleprepdata')

        # Deleting field 'SampleSet.libraryPrepInstrument'
        db.delete_column(u'rundb_sampleset', 'libraryPrepInstrument')

        # Deleting field 'SampleSet.libraryPrepType'
        db.delete_column(u'rundb_sampleset', 'libraryPrepType')

        # Deleting field 'SampleSet.libraryPrepPlateType'
        db.delete_column(u'rundb_sampleset', 'libraryPrepPlateType')

        # Deleting field 'SampleSet.combinedLibraryTubeLabel'
        db.delete_column(u'rundb_sampleset', 'combinedLibraryTubeLabel')

        # Deleting field 'SampleSet.libraryPrepInstrumentData'
        db.delete_column(u'rundb_sampleset', 'libraryPrepInstrumentData_id')

        # Deleting field 'SampleSetItem.pcrPlateSerialNum'
        db.delete_column(u'rundb_samplesetitem', 'pcrPlateSerialNum')

        # Deleting field 'SampleSetItem.pcrPlateColumn'
        db.delete_column(u'rundb_samplesetitem', 'pcrPlateColumn')

        # Deleting field 'SampleSetItem.pcrPlateRow'
        db.delete_column(u'rundb_samplesetitem', 'pcrPlateRow')
