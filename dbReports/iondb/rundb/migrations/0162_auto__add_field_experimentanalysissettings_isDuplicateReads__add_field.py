...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.isDuplicateReads'
        db.add_column('rundb_experimentanalysissettings', 'isDuplicateReads',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PlannedExperiment.templatingKitBarcode'
        db.add_column('rundb_plannedexperiment', 'templatingKitBarcode',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.isDuplicateReads'
        db.delete_column('rundb_experimentanalysissettings', 'isDuplicateReads')

        # Deleting field 'PlannedExperiment.templatingKitBarcode'
        db.delete_column('rundb_plannedexperiment', 'templatingKitBarcode')
