...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rundb_libmetrics', 'total_mapped_target_bases', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'LibMetrics.total_mapped_reads'
        db.alter_column('rundb_libmetrics', 'total_mapped_reads', self.gf('django.db.models.fields.BigIntegerField')())
