...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceGenome.celery_task_id'
        db.add_column(u'rundb_referencegenome', 'celery_task_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceGenome.celery_task_id'
        db.delete_column(u'rundb_referencegenome', 'celery_task_id')
