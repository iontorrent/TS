...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IonMeshNode'
        db.create_table(u'rundb_ionmeshnode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hostname', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('system_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=37)),
            ('apikey_remote', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('apikey_local', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('share_plans', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('share_data', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('share_monitoring', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'rundb', ['IonMeshNode'])


    def backwards(self, orm):
        # Deleting model 'IonMeshNode'
        db.delete_table(u'rundb_ionmeshnode')
