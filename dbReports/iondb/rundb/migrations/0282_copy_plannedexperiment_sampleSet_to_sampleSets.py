...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Move all Plan-SampleSet relations to the new Many-to-Many PlannedExperiment.sampleSets field"
        for plan in orm.PlannedExperiment.objects.filter(sampleSet__isnull=False):
            plan.sampleSets.add( plan.sampleSet )


    def backwards(self, orm):
        for plan in orm.PlannedExperiment.objects.filter(sampleSets__isnull=False):
            plan.sampleSet = plan.sampleSets.all()[0]
            plan.save()
