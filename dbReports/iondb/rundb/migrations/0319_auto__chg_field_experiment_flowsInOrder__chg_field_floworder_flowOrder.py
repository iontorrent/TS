...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # limit flow order to 1200 chars max
        for obj in orm.Experiment.objects.extra(where=['CHAR_LENGTH("flowsInOrder") > 1200']):
            obj.flowsInOrder = obj.flowsInOrder[:1200]
            obj.save()
            print ">>> 0319 >>> Truncated run %s flow order to satisfy max characters limit" % obj.expName

        for obj in orm.flowOrder.objects.extra(where=['CHAR_LENGTH("flowOrder") > 1200']):
            obj.flowOrder = obj.flowOrder[:1200]
            obj.save()
            print ">>> 0319 >>> Truncated %s flow order to satisfy max characters limit" % obj.name

        # Changing field 'Experiment.flowsInOrder'
        db.alter_column(u'rundb_experiment', 'flowsInOrder', self.gf('django.db.models.fields.CharField')(max_length=1200))

        # Changing field 'FlowOrder.flowOrder'
        db.alter_column(u'rundb_floworder', 'flowOrder', self.gf('django.db.models.fields.CharField')(max_length=1200))

    def backwards(self, orm):

        # Changing field 'Experiment.flowsInOrder'
        db.alter_column(u'rundb_experiment', 'flowsInOrder', self.gf('django.db.models.fields.TextField')())

        # Changing field 'FlowOrder.flowOrder'
        db.alter_column(u'rundb_floworder', 'flowOrder', self.gf('django.db.models.fields.TextField')())
