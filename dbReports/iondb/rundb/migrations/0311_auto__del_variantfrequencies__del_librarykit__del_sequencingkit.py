...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'rundb_variantfrequencies')

        # Deleting model 'LibraryKit'
        db.delete_table(u'rundb_librarykit')

        # Deleting model 'SequencingKit'
        db.delete_table(u'rundb_sequencingkit')


    def backwards(self, orm):
        # Adding model 'VariantFrequencies'
        db.create_table(u'rundb_variantfrequencies', (
        ...
        db.send_create_signal(u'rundb', ['VariantFrequencies'])

        # Adding model 'LibraryKit'
        db.create_table(u'rundb_librarykit', (
            ('sap', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=3024, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'rundb', ['LibraryKit'])

        # Adding model 'SequencingKit'
        db.create_table(u'rundb_sequencingkit', (
            ('sap', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=3024, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'rundb', ['SequencingKit'])
