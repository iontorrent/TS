...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'dm_prune_field'
        db.delete_table(u'rundb_dm_prune_field')

        # Deleting model 'dm_reports'
        db.delete_table(u'rundb_dm_reports')

        # Deleting model 'BackupConfig'
        db.delete_table(u'rundb_backupconfig')

        # Deleting model 'dm_prune_group'
        db.delete_table(u'rundb_dm_prune_group')


    def backwards(self, orm):
        # Adding model 'dm_prune_field'
        db.create_table(u'rundb_dm_prune_field', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rule', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
        ))
        db.send_create_signal(u'rundb', ['dm_prune_field'])

        # Adding model 'dm_reports'
        db.create_table(u'rundb_dm_reports', (
            ('autoType', self.gf('django.db.models.fields.CharField')(default='P', max_length=32)),
            ('autoAge', self.gf('django.db.models.fields.IntegerField')(default=90)),
            ('pruneLevel', self.gf('django.db.models.fields.CharField')(default='No-op', max_length=128)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('autoPrune', self.gf('django.db.models.fields.BooleanField')(default=False)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'rundb', ['dm_reports'])

        # Adding model 'BackupConfig'
        db.create_table(u'rundb_backupconfig', (
            ('status', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('online', self.gf('django.db.models.fields.BooleanField')()),
            ...
            ('keepTN', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
        ))
        db.send_create_signal(u'rundb', ['BackupConfig'])

        # Adding model 'dm_prune_group'
        db.create_table(u'rundb_dm_prune_group', (
            ('ruleNums', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=128, blank=True)),
        ...
        db.send_create_signal(u'rundb', ['dm_prune_group'])
