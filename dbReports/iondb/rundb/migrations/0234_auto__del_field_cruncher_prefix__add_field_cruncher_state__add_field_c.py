...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cruncher.prefix'
        db.delete_column(u'rundb_cruncher', 'prefix')

        # Adding field 'Cruncher.state'
        db.add_column(u'rundb_cruncher', 'state',
                      self.gf('django.db.models.fields.CharField')(default='U', max_length=8),
                      keep_default=False)

        # Adding field 'Cruncher.date'
        db.add_column(u'rundb_cruncher', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cruncher.info'
        db.add_column(u'rundb_cruncher', 'info',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cruncher.prefix'
        db.add_column(u'rundb_cruncher', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Deleting field 'Cruncher.state'
        db.delete_column(u'rundb_cruncher', 'state')

        # Deleting field 'Cruncher.date'
        db.delete_column(u'rundb_cruncher', 'date')

        # Deleting field 'Cruncher.info'
        db.delete_column(u'rundb_cruncher', 'info')
