...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chip.earlyDatFileDeletion'
        db.add_column(u'rundb_chip', 'earlyDatFileDeletion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chip.earlyDatFileDeletion'
        db.delete_column(u'rundb_chip', 'earlyDatFileDeletion')
