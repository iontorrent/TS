...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisArgs.applCategory'
        db.add_column(u'rundb_analysisargs', 'applCategory',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalysisArgs.applCategory'
        db.delete_column(u'rundb_analysisargs', 'applCategory')
