...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'KitInfo.categories'
        db.alter_column(u'rundb_kitinfo', 'categories', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'KitInfo.categories'
        db.alter_column(u'rundb_kitinfo', 'categories', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
