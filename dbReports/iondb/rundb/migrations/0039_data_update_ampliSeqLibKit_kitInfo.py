...
#20120715 change log:
# 1) modified ampliSeq library kit name

class Migration(SchemaMigration):

    def forwards(self, orm):
            
        # modify ampliSeq library kit name & description
        try:
            libKit = orm.kitinfo.objects.filter(kitType = "LibraryKit", name = "Ion AmpliSeq Library Kit 1.0")[0]
            libKit.name = "Ion AmpliSeq Kit"
            libKit.description = "Ion AmpliSeq Kit" 
            libKit.save()
        except IndexError:
            print "*** Ion AmpliSeq Library Kit 1.0 is not found. Update skipped. "


    def backwards(self, orm):
            
        # revert the kit name back to original value         
        try:
            libKit = orm.kitinfo.objects.filter(kitType = "LibraryKit", name = "Ion AmpliSeq Kit")[0]
            libKit.name = "Ion AmpliSeq Library Kit 1.0"
            libKit.description = "Ion AmpliSeq Library Kit 1.0" 
            libKit.save()
        except IndexError:
            print "*** Ion AmpliSeq Kit is not found. Rollback skipped. "
