...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        barcode_set_names = [
            "Ion SingleSeq Barcode set 1-24",
            "Ion SingleSeq Barcode set 1-96",
            "TagSequencing",
            "Ion Select BC Set-1",
            "Ion SingleSeq Barcode set 1",
            "IonXpress",
            "Ion Xpress MuSeek Barcode set 1",
            "IonXpressRNA",
            "IonCode",
            "IonCode Barcodes 1-32",
            "IonCode - TagSequencing",
            "IonSet1",
            "RNA_Barcode_None",
            "TagSequencing",
            "IonCode-TagSequencing",
        ]
        for barcode_set_name in barcode_set_names:
            for dnaBarcode in orm.dnaBarcode.objects.filter(name=barcode_set_name):
                dnaBarcode.delete()

        start = 'rundb/fixtures/barcodes/5.10/'
        # fixtures path is different for manual vs ion-dbreports install
        if not os.path.exists('rundb/fixtures'):
            start = 'iondb/rundb/fixtures/barcodes/5.10/'

        # better late than never...
        management.call_command('loaddata', start + 'Ion_Select_BC_Set-1.json')
        management.call_command('loaddata', start + 'ion_single_seq_barcode_set_1-24.json')
        management.call_command('loaddata', start + 'ion_single_seq_barcode_set_1-96.json')
        management.call_command('loaddata', start + 'Ion_SingleSeq_Barcode_set_1.json')
        management.call_command('loaddata', start + 'ion_xpress.json')
        management.call_command('loaddata', start + 'Ion_Xpress_MuSeek_Barcode_set_1.json')
        management.call_command('loaddata', start + 'ion_xpress_rna.json')
        management.call_command('loaddata', start + 'IonCode.json')
        management.call_command('loaddata', start + 'IonCode_Barcodes_1-32.json')
        management.call_command('loaddata', start + 'IonCode_TagSequencing.json')
        management.call_command('loaddata', start + 'IonSet1.json')
        management.call_command('loaddata', start + 'rna_barcode_none.json')
        management.call_command('loaddata', start + 'tag_sequencing.json')
    ...
    models = {
        ...
        u'rundb.experiment': {
            ...
            'chefReagentsSerialNum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            ...
            'chefSolutionsSerialNum': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
        ...
        u'rundb.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_read_news_post': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1984, 11, 6, 0, 0)'}),
