...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Experiment.objects.filter(ftpStatus__in=to_complete).update(ftpStatus="Complete")

    def backwards(self, orm):
        """There's no easy way to reverse this migration, 
        but it is compatible with older versions of the TS.
        """
        pass
