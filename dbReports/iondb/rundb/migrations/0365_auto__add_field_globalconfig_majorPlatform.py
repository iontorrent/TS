...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.majorPlatform'
        db.add_column(u'rundb_globalconfig', 'majorPlatform',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=24, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GlobalConfig.majorPlatform'
        db.delete_column(u'rundb_globalconfig', 'majorPlatform')
