...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisArgs.description'
        db.add_column(u'rundb_analysisargs', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=256, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AnalysisArgs.applType'
        db.add_column(u'rundb_analysisargs', 'applType',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='applType_analysisArgs', null=True, to=orm['rundb.RunType']),
                      keep_default=False)

        # Adding field 'AnalysisArgs.applGroup'
        db.add_column(u'rundb_analysisargs', 'applGroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='applGroup_analysisArgs', null=True, to=orm['rundb.ApplicationGroup']),
                      keep_default=False)

        # Adding field 'AnalysisArgs.isSystem'
        db.add_column(u'rundb_analysisargs', 'isSystem',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AnalysisArgs.creator'
        db.add_column(u'rundb_analysisargs', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_analysisArgs', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AnalysisArgs.creationDate'
        db.add_column(u'rundb_analysisargs', 'creationDate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AnalysisArgs.lastModifiedUser'
        db.add_column(u'rundb_analysisargs', 'lastModifiedUser',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lastModified_analysisArgs', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'AnalysisArgs.lastModifiedDate'
        db.add_column(u'rundb_analysisargs', 'lastModifiedDate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalysisArgs.description'
        db.delete_column(u'rundb_analysisargs', 'description')

        # Deleting field 'AnalysisArgs.applType'
        db.delete_column(u'rundb_analysisargs', 'applType_id')

        # Deleting field 'AnalysisArgs.applGroup'
        db.delete_column(u'rundb_analysisargs', 'applGroup_id')

        # Deleting field 'AnalysisArgs.isSystem'
        db.delete_column(u'rundb_analysisargs', 'isSystem')

        # Deleting field 'AnalysisArgs.creator'
        db.delete_column(u'rundb_analysisargs', 'creator_id')

        # Deleting field 'AnalysisArgs.creationDate'
        db.delete_column(u'rundb_analysisargs', 'creationDate')

        # Deleting field 'AnalysisArgs.lastModifiedUser'
        db.delete_column(u'rundb_analysisargs', 'lastModifiedUser_id')

        # Deleting field 'AnalysisArgs.lastModifiedDate'
        db.delete_column(u'rundb_analysisargs', 'lastModifiedDate')
