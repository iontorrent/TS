...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DMFileStat.files_in_use'
        db.add_column('rundb_dmfilestat', 'files_in_use',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DMFileStat.files_in_use'
        db.delete_column('rundb_dmfilestat', 'files_in_use')
