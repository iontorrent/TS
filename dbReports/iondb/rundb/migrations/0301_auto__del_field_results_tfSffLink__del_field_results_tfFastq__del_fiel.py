...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Results.tfSffLink'
        db.delete_column(u'rundb_results', 'tfSffLink')

        # Deleting field 'Results.tfFastq'
        db.delete_column(u'rundb_results', 'tfFastq')

        # Deleting field 'Results.sffLink'
        db.delete_column(u'rundb_results', 'sffLink')

        # Deleting field 'Results.fastqLink'
        db.delete_column(u'rundb_results', 'fastqLink')


    def backwards(self, orm):
        # Adding field 'Results.tfSffLink'
        db.add_column(u'rundb_results', 'tfSffLink',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Results.tfFastq'
        db.add_column(u'rundb_results', 'tfFastq',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Results.sffLink'
        db.add_column(u'rundb_results', 'sffLink',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Results.fastqLink'
        db.add_column(u'rundb_results', 'fastqLink',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)
