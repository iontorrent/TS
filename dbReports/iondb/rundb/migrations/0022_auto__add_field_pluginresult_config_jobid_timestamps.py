...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rundb_pluginresult', 'config', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'PluginResult.jobid'
        db.add_column('rundb_pluginresult', 'jobid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'PluginResult.apikey'
        db.add_column('rundb_pluginresult', 'apikey', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True), keep_default=False)

        # Adding field 'PluginResult.starttime'
        db.add_column('rundb_pluginresult', 'starttime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PluginResult.endtime'
        db.add_column('rundb_pluginresult', 'endtime', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'PluginResult.size'
        db.add_column('rundb_pluginresult', 'size', self.gf('django.db.models.fields.BigIntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PluginResult.config'
        db.delete_column('rundb_pluginresult', 'config')

        # Deleting field 'PluginResult.jobid'
        db.delete_column('rundb_pluginresult', 'jobid')

        # Deleting field 'PluginResult.apikey'
        db.delete_column('rundb_pluginresult', 'apikey')

        # Deleting field 'PluginResult.starttime'
        db.delete_column('rundb_pluginresult', 'starttime')

        # Deleting field 'PluginResult.endtime'
        db.delete_column('rundb_pluginresult', 'endtime')

        # Deleting field 'PluginResult.size'
        db.delete_column('rundb_pluginresult', 'size')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 5, 13, 47, 21, 549402)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 5, 13, 47, 21, 549223)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 5, 13, 47, 20, 989115)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
