...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Plugin.majorBlock'
        db.add_column('rundb_plugin', 'majorBlock', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Plugin.majorBlock'
        db.delete_column('rundb_plugin', 'majorBlock')
