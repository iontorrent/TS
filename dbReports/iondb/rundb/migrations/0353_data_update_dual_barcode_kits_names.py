...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ''' Modify barcode kit names:
              1) "Ion AmpliSeq HD Dual-Barcodes 1-24 Kit" to "Ion AmpliSeq HD Dual Barcode Kit 1-24"
              2) "Ion Dual Barcodes" to "Ion Dual Barcode Kit 1-96"
        '''
        new_ampsHD_name = "Ion AmpliSeq HD Dual Barcode Kit 1-24"
        for dnaBarcode in orm.dnaBarcode.objects.filter(name="Ion AmpliSeq HD Dual-Barcodes 1-24 Kit"):
            dnaBarcode.name = new_ampsHD_name
            dnaBarcode.save()
            
        new_dual_name = "Ion Dual Barcode Kit 1-96"
        for dnaBarcode in orm.dnaBarcode.objects.filter(name="Ion Dual Barcodes"):
            dnaBarcode.name = new_dual_name
            dnaBarcode.save()
