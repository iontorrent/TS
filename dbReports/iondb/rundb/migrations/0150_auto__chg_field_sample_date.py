...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rundb_sample', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # Changing field 'Sample.date'
        db.alter_column('rundb_sample', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
