...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExperimentAnalysisSettings'
        db.create_table('rundb_experimentanalysissettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True)),
            ('barcodeKitName', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('threePrimeAdapter', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('targetRegionBedFile', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('hotSpotRegionBedFile', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('barcodedSamples', self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True)),
            ('selectedPlugins', self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('isEditable', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('isOneTimeOverride', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='eas_set', null=True, to=orm['rundb.Experiment'])),
        ))
        db.send_create_signal('rundb', ['ExperimentAnalysisSettings'])

        # Adding model 'Sample'
        db.create_table('rundb_sample', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True)),
            ('displayedName', self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True)),
            ('externalId', self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('rundb', ['Sample'])

        # Adding M2M table for field experiments on 'Sample'
        db.create_table('rundb_sample_experiments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sample', models.ForeignKey(orm['rundb.sample'], null=False)),
            ('experiment', models.ForeignKey(orm['rundb.experiment'], null=False))
        ))
        db.create_unique('rundb_sample_experiments', ['sample_id', 'experiment_id'])

        # Adding field 'Experiment.status'
        db.add_column('rundb_experiment', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Results.eas'
        db.add_column('rundb_results', 'eas',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='results_set', null=True, to=orm['rundb.ExperimentAnalysisSettings']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExperimentAnalysisSettings'
        db.delete_table('rundb_experimentanalysissettings')

        # Deleting model 'Sample'
        db.delete_table('rundb_sample')

        # Removing M2M table for field experiments on 'Sample'
        db.delete_table('rundb_sample_experiments')

        # Deleting field 'Experiment.status'
        db.delete_column('rundb_experiment', 'status')

        # Deleting field 'Results.eas'
        db.delete_column('rundb_results', 'eas_id')
