...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.endBarcodeKitName'
        db.add_column(u'rundb_experimentanalysissettings', 'endBarcodeKitName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ApplProduct.isDualBarcodingBySampleSupported'
        db.add_column(u'rundb_applproduct', 'isDualBarcodingBySampleSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApplProduct.dualBarcodingRule'
        db.add_column(u'rundb_applproduct', 'dualBarcodingRule',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.endDnabarcode'
        db.add_column(u'rundb_samplesetitem', 'endDnabarcode',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='endBarcode', null=True, to=orm['rundb.dnaBarcode']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.endBarcodeKitName'
        db.delete_column(u'rundb_experimentanalysissettings', 'endBarcodeKitName')

        # Deleting field 'ApplProduct.isDualBarcodingBySampleSupported'
        db.delete_column(u'rundb_applproduct', 'isDualBarcodingBySampleSupported')

        # Deleting field 'ApplProduct.dualBarcodingRule'
        db.delete_column(u'rundb_applproduct', 'dualBarcodingRule')

        # Deleting field 'SampleSetItem.endDnabarcode'
        db.delete_column(u'rundb_samplesetitem', 'endDnabarcode_id')
