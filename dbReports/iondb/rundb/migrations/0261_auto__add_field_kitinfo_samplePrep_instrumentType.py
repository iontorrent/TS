...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KitInfo.samplePrep_instrumentType'
        db.add_column(u'rundb_kitinfo', 'samplePrep_instrumentType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KitInfo.samplePrep_instrumentType'
        db.delete_column(u'rundb_kitinfo', 'samplePrep_instrumentType')
