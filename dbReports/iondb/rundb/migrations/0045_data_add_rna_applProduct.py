...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        defaultLibKit = orm.kitinfo.objects.get(kitType = "LibraryKit", name__iexact = "Ion Total RNA Seq Kit v2")
        ...
        for appl in orm.runtype.objects.filter(runType = 'RNA'):
    ...
    def backwards(self, orm):      
        ...
        for applProduct in orm.applproduct.objects.all():
            ...
            try:
                for appl in orm.runtype.objects.filter(runType__in=['RNA']):
