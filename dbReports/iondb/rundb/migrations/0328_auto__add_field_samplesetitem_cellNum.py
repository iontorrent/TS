...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.cellNum'
        db.add_column(u'rundb_samplesetitem', 'cellNum',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.cellNum'
        db.delete_column(u'rundb_samplesetitem', 'cellNum')
