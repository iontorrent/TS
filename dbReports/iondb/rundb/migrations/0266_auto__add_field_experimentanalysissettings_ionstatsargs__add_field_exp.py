...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.ionstatsargs'
        db.add_column(u'rundb_experimentanalysissettings', 'ionstatsargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.thumbnailionstatsargs'
        db.add_column(u'rundb_experimentanalysissettings', 'thumbnailionstatsargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'AnalysisArgs.ionstatsargs'
        db.add_column(u'rundb_analysisargs', 'ionstatsargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'AnalysisArgs.thumbnailionstatsargs'
        db.add_column(u'rundb_analysisargs', 'thumbnailionstatsargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.ionstatsargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'ionstatsargs')

        # Deleting field 'ExperimentAnalysisSettings.thumbnailionstatsargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'thumbnailionstatsargs')

        # Deleting field 'AnalysisArgs.ionstatsargs'
        db.delete_column(u'rundb_analysisargs', 'ionstatsargs')

        # Deleting field 'AnalysisArgs.thumbnailionstatsargs'
        db.delete_column(u'rundb_analysisargs', 'thumbnailionstatsargs')
