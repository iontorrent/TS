...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LibMetrics.duplicate_read_percentage'
        db.delete_column('rundb_libmetrics', 'duplicate_read_percentage')

        # Adding field 'LibMetrics.duplicate_reads'
        db.add_column('rundb_libmetrics', 'duplicate_reads',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LibMetrics.duplicate_read_percentage'
        db.add_column('rundb_libmetrics', 'duplicate_read_percentage',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'LibMetrics.duplicate_reads'
        db.delete_column('rundb_libmetrics', 'duplicate_reads')
