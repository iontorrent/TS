...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReferenceGenome.identity_hash'
        db.add_column('rundb_referencegenome', 'identity_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReferenceGenome.identity_hash'
        db.delete_column('rundb_referencegenome', 'identity_hash')
