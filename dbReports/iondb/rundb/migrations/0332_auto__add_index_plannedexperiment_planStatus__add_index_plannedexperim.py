...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlannedExperiment', fields ['planStatus']
        db.create_index(u'rundb_plannedexperiment', ['planStatus'])

        # Adding index on 'PlannedExperiment', fields ['isFavorite']
        db.create_index(u'rundb_plannedexperiment', ['isFavorite'])

        # Adding index on 'PlannedExperiment', fields ['runType']
        db.create_index(u'rundb_plannedexperiment', ['runType'])

        # Adding index on 'PlannedExperiment', fields ['isReusable']
        db.create_index(u'rundb_plannedexperiment', ['isReusable'])

        # Adding index on 'PlannedExperiment', fields ['categories']
        db.create_index(u'rundb_plannedexperiment', ['categories'])


    def backwards(self, orm):
        # Removing index on 'PlannedExperiment', fields ['categories']
        db.delete_index(u'rundb_plannedexperiment', ['categories'])

        # Removing index on 'PlannedExperiment', fields ['isReusable']
        db.delete_index(u'rundb_plannedexperiment', ['isReusable'])

        # Removing index on 'PlannedExperiment', fields ['runType']
        db.delete_index(u'rundb_plannedexperiment', ['runType'])

        # Removing index on 'PlannedExperiment', fields ['isFavorite']
        db.delete_index(u'rundb_plannedexperiment', ['isFavorite'])

        # Removing index on 'PlannedExperiment', fields ['planStatus']
        db.delete_index(u'rundb_plannedexperiment', ['planStatus'])
