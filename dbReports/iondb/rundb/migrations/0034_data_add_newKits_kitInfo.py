...
#20120715
#LibraryKit:             Ion AmpliSeq Library Kit 1.0   - 4471261    
#Paired-end adapter:     Paired-end library adapter kit - 4477111
#Sequencing Kit:         Ion PGM Sequencing 300 Kit     - 4480445
#Paired-end seq kit:     Ion PGM 2x200 paired end sequencing kit – no part number yet
#Control sequence:       Ion AmpliSeq Sample Id panel   - no part number yet
#TemplateKit:            One Touch 200 Template kit v2 DL - 4480285
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        #LibraryKit:             Ion AmpliSeq Library Kit 1.0   - 4471261  
        libKit, isCreated = orm.kitinfo.objects.get_or_create(kitType = "LibraryKit", name = "Ion AmpliSeq Library Kit 1.0", 
            description = "Ion AmpliSeq Library Kit 1.0", flowCount = 0, nucleotideType="dna")

        print "*** AFTER get_or_create Ion AmpliSeq Library Kit 1.0 isCreated=%s " % (str(isCreated)) 

        libKitPart, isCreated = orm.kitpart.objects.get_or_create(kit = libKit, barcode = "4471261")

        print "*** AFTER get_or_create LibKit Part isCreated=%s " % (str(isCreated)) 
        ...
        #Paired-end adapter:     Paired-end library adapter kit - 4477111
        adapterKit, isCreated = orm.kitinfo.objects.get_or_create(kitType = "AdapterKit", name = "Paired-end library adapter kit", 
            description = "Paired-end library adapter kit", flowCount = 0, nucleotideType="", runMode = "pe")

        print "*** AFTER get_or_create Paired-end library adapter kit isCreated=%s " % (str(isCreated)) 

        adapterKitPart, isCreated = orm.kitpart.objects.get_or_create(kit = adapterKit, barcode = "4477111")

        print "*** AFTER get_or_create adapterKit Part isCreated=%s " % (str(isCreated)) 

        adapterKit.kitpart_set.add(adapterKitPart);
        adapterKit.save()    


        #Sequencing Kit:         Ion PGM Sequencing 300 Kit     - 4480445
        seqKit, isCreated = orm.kitinfo.objects.get_or_create(kitType = "SequencingKit", name = "Ion PGM Sequencing 300 Kit", 
            description = "Ion PGM Sequencing 300 Kit", flowCount = 520, nucleotideType="")

        print "*** AFTER get_or_create Ion PGM Sequencing 300 Kit isCreated=%s " % (str(isCreated)) 

        seqKitPart, isCreated = orm.kitpart.objects.get_or_create(kit = seqKit, barcode = "4480445")

        print "*** AFTER get_or_create seqKit Part isCreated=%s " % (str(isCreated)) 
        ...
        #Paired-end seq kit:     Ion PGM 2x200 paired end sequencing kit – no part number yet
        peSeqKit, isCreated = orm.kitinfo.objects.get_or_create(kitType = "SequencingKit", name = "Ion PGM 2x200 paired end sequencing kit", 
            description = "Ion PGM 2x200 paired end sequencing kit", flowCount = 520, runMode="pe")

        print "*** AFTER get_or_create Ion PGM 2x200 paired end sequencing kit isCreated=%s " % (str(isCreated)) 
        ...
        #TemplateKit:            One Touch 200 Template kit v2 DL - 4480285
        templateKit, isCreated = orm.kitinfo.objects.get_or_create(kitType = "TemplatingKit", name = "One Touch 200 Template kit v2 DL", 
            description = "One Touch 200 Template kit v2 DL", flowCount = 0)

        print "*** AFTER get_or_create One Touch 200 Template kit v2 DL isCreated=%s " % (str(isCreated)) 

        templateKitPart, isCreated = orm.kitpart.objects.get_or_create(kit = templateKit, barcode = "4480285")

        print "*** AFTER get_or_create templateKit Part isCreated=%s " % (str(isCreated)) 
    ...
    def backwards(self, orm):      
        #LibraryKit:             Ion AmpliSeq Library Kit 1.0   - 4471261 
        try: 
            libKit = orm.kitinfo.objects.get(kitType = "LibraryKit", name = "Ion AmpliSeq Library Kit 1.0")
            libKitPart = orm.kitpart.objects.get(kit = libKit, barcode = "4471261")
            libKitPart.delete()
            ##libKit.kitpart_set.remove(libKitPart)
            libKit.delete()
            
            print "after removing Ion AmpliSeq Library Kit 1.0 "
        except:
            print "*** Error retrieving Ion AmpliSeq Library Kit 1.0. Rollback skipped. "


        #Paired-end adapter:     Paired-end library adapter kit - 4477111
        try:
            adapterKit = orm.kitinfo.objects.get(kitType = "AdapterKit", name = "Paired-end library adapter kit")
            adapterKitPart = orm.kitpart.objects.get(kit = adapterKit, barcode = "4477111")
            adapterKitPart.delete()
            adapterKit.delete()
            
            print "after removing Paired-end library adapter kit "            
        except:
            print "*** Error retrieving Paired-end library adapter kit. Rollback skipped. "
     

        #Sequencing Kit:         Ion PGM Sequencing 300 Kit     - 4480445
        try:
            seqKit = orm.kitinfo.objects.get(kitType = "SequencingKit", name = "Ion PGM Sequencing 300 Kit")
            seqKitPart = orm.kitpart.objects.get(kit = seqKit, barcode = "4480445")
            seqKitPart.delete()
            seqKit.delete()
            
            print "after removing Ion PGM Sequencing 300 Kit "                      
        except:
            print "*** Error retrieving Ion PGM Sequencing 300 Kit. Rollback skipped. "
      
        
        #Paired-end seq kit:     Ion PGM 2x200 paired end sequencing kit – no part number yet
        try:
            peSeqKit = orm.kitinfo.objects.get(kitType = "SequencingKit", name = "Ion PGM 2x200 paired end sequencing kit")
            peSeqKit.delete()

            print "after removing Ion PGM 2x200 paired end sequencing kit "   
        except:
            print "*** Error retrieving Ion PGM 2x200 paired end sequencing kit. Rollback skipped. "
        ...
        try:
            ...
            print "after removing Ion AmpliSeq Sample Id panel "        
        except:
            print "*** Error retrieving Ion AmpliSeq Sample Id panel. Rollback skipped. "

        #TemplateKit:            One Touch 200 Template kit v2 DL - 4480285
        try:
            templateKit = orm.kitinfo.objects.get(kitType = "TemplatingKit", name = "One Touch 200 Template kit v2 DL")
            templateKitPart = orm.kitpart.objects.get(kit = templateKit, barcode = "4480285")
            templateKitPart.delete()
            templateKit.delete()

            print "after removing One Touch 200 Template kit v2 DL "   
        except:
            print "*** Error retrieving One Touch 200 Template kit v2 DL. Rollback skipped. "
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 16, 19, 31, 43971)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 16, 19, 31, 43808)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 15, 16, 19, 30, 529985)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rundb.results': {
            ...
            'projects': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'results'", 'blank': 'True', 'to': "orm['rundb.Project']"}),
