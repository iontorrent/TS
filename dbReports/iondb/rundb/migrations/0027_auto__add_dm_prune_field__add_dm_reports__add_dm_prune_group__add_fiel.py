...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rundb_dm_prune_field', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rule', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
        ))
        db.send_create_signal('rundb', ['dm_prune_field'])

        # Adding model 'dm_reports'
        db.create_table('rundb_dm_reports', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pruneStrings', self.gf('django.db.models.fields.TextField')(default='{}', blank=True)),
            ('pruneStringText', self.gf('django.db.models.fields.CharField')(default='', max_length=512)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('pruneLevel', self.gf('django.db.models.fields.CharField')(default='01', max_length=128)),
            ('numChoices', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('autoPrune', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reportDays', self.gf('django.db.models.fields.IntegerField')(default=30)),
        ))
        db.send_create_signal('rundb', ['dm_reports'])

        # Adding model 'dm_prune_group'
        db.create_table('rundb_dm_prune_group', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rules', self.gf('django.db.models.fields.TextField')(default='{}', blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('id_number', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('editable', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('ruleNums', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='1', max_length=128)),
        ))
        db.send_create_signal('rundb', ['dm_prune_group'])

        # Adding field 'Results.reportStatus'
        db.add_column('rundb_results', 'reportStatus', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'FileServer.percentfull'
        db.add_column('rundb_fileserver', 'percentfull', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'dm_prune_field'
        db.delete_table('rundb_dm_prune_field')

        # Deleting model 'dm_reports'
        db.delete_table('rundb_dm_reports')

        # Deleting model 'dm_prune_group'
        db.delete_table('rundb_dm_prune_group')

        # Deleting field 'Results.reportStatus'
        db.delete_column('rundb_results', 'reportStatus')

        # Deleting field 'FileServer.percentfull'
        db.delete_column('rundb_fileserver', 'percentfull')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 12, 7, 20, 964095)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 12, 7, 20, 963981)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 10, 12, 7, 20, 570529)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
