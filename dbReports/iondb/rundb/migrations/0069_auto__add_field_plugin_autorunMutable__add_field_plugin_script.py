...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rundb_plugin', 'autorunMutable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Plugin.script'
        db.add_column('rundb_plugin', 'script',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('rundb_plugin', 'autorunMutable')

        # Deleting field 'Plugin.script'
        db.delete_column('rundb_plugin', 'script')
