...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #samplePrep Kit:         Ion TargetSeq custom enrichment kits
        samplePrepKit, isCreated = orm.kitinfo.objects.get_or_create(kitType = "SamplePrepKit", name = "Ion TargetSeq custom enrichment kits", 
            description = "Ion TargetSeq custom enrichment kits", flowCount=0, nucleotideType="")
        
        print "*** AFTER get_or_create Ion TargetSeq custom enrichment kits isCreated=%s " % (str(isCreated)) 
    ...
    def backwards(self, orm):      
        #samplePrep Kit:         Ion TargetSeq custom enrichment kits
        try:
            samplePrepKit = orm.kitinfo.objects.get(kitType = "SamplePrepKit", name = "Ion TargetSeq custom enrichment kits")

            samplePrepKit.delete()
            print "after removing samplePrep kit Ion TargetSeq custom enrichment kits "        
        except:
            print "cannot rollback samplePrep kit: Ion TargetSeq custom enrichment kits "  
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 17, 31, 21, 638810)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 17, 31, 21, 638710)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 24, 17, 31, 21, 176213)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
