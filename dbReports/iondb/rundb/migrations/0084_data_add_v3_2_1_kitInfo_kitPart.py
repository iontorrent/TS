...
#change log:
#1) 20121012: added new kits for v3.2.1 release
#2) 20121018: fixed Ion TargetSeq Proton Exome
...
class Migration(DataMigration):
    ...
    def forwards(self, orm):        
        ...
        for sysTemplate in orm.plannedexperiment.objects.filter(isSystem = True, isReusable = True, planDisplayedName = "Ion TargetSeq Proton Exome"):
            sysTemplate.sequencekitname = defaultSeqKitName
            sysTemplate.templatingKitName = defaultTemplateKitName
            sysTemplate.flows = 260
            sysTemplate.save()
            print "*** AFTER Ion TargetSeq Proton Exome template changes have been saved. "
