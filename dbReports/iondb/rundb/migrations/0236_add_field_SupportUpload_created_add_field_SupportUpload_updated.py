...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SupportUpload.created'
        db.add_column(u'rundb_supportupload', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=timezone.now(), blank=True),
                      keep_default=False)

        # Adding field 'SupportUpload.updated'
        db.add_column(u'rundb_supportupload', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=timezone.now(), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SupportUpload.created'
        db.delete_column(u'rundb_supportupload', 'created')

        # Deleting field 'SupportUpload.updated'
        db.delete_column(u'rundb_supportupload', 'updated')
