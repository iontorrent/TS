...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DMFileStat.user_comment'
        db.add_column(u'rundb_dmfilestat', 'user_comment',
                      self.gf('django.db.models.fields.TextField')(default='{}', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DMFileStat.user_comment'
        db.delete_column(u'rundb_dmfilestat', 'user_comment')
