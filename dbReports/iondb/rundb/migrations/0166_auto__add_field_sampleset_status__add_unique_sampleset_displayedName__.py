...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSet.status'
        db.add_column(u'rundb_sampleset', 'status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'SampleSet', fields ['displayedName']
        db.create_unique(u'rundb_sampleset', ['displayedName'])

        # Adding field 'PlannedExperiment.sampleSet'
        db.add_column(u'rundb_plannedexperiment', 'sampleSet',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='plans', null=True, to=orm['rundb.SampleSet']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'SampleSet', fields ['displayedName']
        db.delete_unique(u'rundb_sampleset', ['displayedName'])

        # Deleting field 'SampleSet.status'
        db.delete_column(u'rundb_sampleset', 'status')
