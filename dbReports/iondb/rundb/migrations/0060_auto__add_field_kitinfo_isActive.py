...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KitInfo.isActive'
        db.add_column('rundb_kitinfo', 'isActive', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'KitInfo.isActive'
        db.delete_column('rundb_kitinfo', 'isActive')
