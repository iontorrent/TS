...
#20130606 change log:
# 1) delete all runType entries to switch to using initial data load 
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        for runType in orm.runtype.objects.all():
            print "*** 0160_ *** GOING to delete runType=%s with id=%s " %(runType.runType, str(runType.id))
            runType.delete()
