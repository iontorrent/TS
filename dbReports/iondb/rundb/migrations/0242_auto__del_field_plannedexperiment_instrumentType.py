...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlannedExperiment.instrumentType'
        db.delete_column(u'rundb_plannedexperiment', 'instrumentType')


    def backwards(self, orm):
        # Adding field 'PlannedExperiment.instrumentType'
        db.add_column(u'rundb_plannedexperiment', 'instrumentType',
