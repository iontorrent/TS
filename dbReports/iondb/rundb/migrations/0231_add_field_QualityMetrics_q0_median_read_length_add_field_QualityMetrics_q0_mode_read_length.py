...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QualityMetrics.q0_median_read_length'
        db.add_column(u'rundb_qualitymetrics', 'q0_median_read_length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QualityMetrics.q0_mode_read_length'
        db.add_column(u'rundb_qualitymetrics', 'q0_mode_read_length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QualityMetrics.q17_median_read_length'
        db.add_column(u'rundb_qualitymetrics', 'q17_median_read_length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QualityMetrics.q17_mode_read_length'
        db.add_column(u'rundb_qualitymetrics', 'q17_mode_read_length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QualityMetrics.q20_median_read_length'
        db.add_column(u'rundb_qualitymetrics', 'q20_median_read_length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QualityMetrics.q20_mode_read_length'
        db.add_column(u'rundb_qualitymetrics', 'q20_mode_read_length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QualityMetrics.q0_median_read_length'
        db.delete_column(u'rundb_qualitymetrics', 'q0_median_read_length')

        # Deleting field 'QualityMetrics.q0_mode_read_length'
        db.delete_column(u'rundb_qualitymetrics', 'q0_mode_read_length')

        # Deleting field 'QualityMetrics.q17_median_read_length'
        db.delete_column(u'rundb_qualitymetrics', 'q17_median_read_length')

        # Deleting field 'QualityMetrics.q17_mode_read_length'
        db.delete_column(u'rundb_qualitymetrics', 'q17_mode_read_length')

        # Deleting field 'QualityMetrics.q20_median_read_length'
        db.delete_column(u'rundb_qualitymetrics', 'q20_median_read_length')

        # Deleting field 'QualityMetrics.q20_mode_read_length'
        db.delete_column(u'rundb_qualitymetrics', 'q20_mode_read_length')
