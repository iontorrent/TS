...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RemoteAccount'
        db.create_table(u'rundb_remoteaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_label', self.gf('django.db.models.fields.CharField')(default='Unnamed Account', max_length=64)),
            ('remote_resource', self.gf('django.db.models.fields.CharField')(max_length=2048)),
            ('user_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True)),
            ('refresh_token', self.gf('django.db.models.fields.CharField')(max_length=2048, null=True, blank=True)),
            ('token_expires', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'rundb', ['RemoteAccount'])

        # Adding model 'SupportUpload'
        db.create_table(u'rundb_supportupload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.RemoteAccount'])),
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.Results'], null=True, blank=True)),
            ('local_status', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('local_message', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True)),
            ('celery_task_id', self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True)),
            ('file', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rundb.FileMonitor'], unique=True, null=True, blank=True)),
            ('contact_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75)),
            ('description', self.gf('django.db.models.fields.TextField')(default='')),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ticket_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('ticket_status', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('ticket_message', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True)),
        ))
        db.send_create_signal(u'rundb', ['SupportUpload'])


    def backwards(self, orm):
        # Deleting model 'RemoteAccount'
        db.delete_table(u'rundb_remoteaccount')

        # Deleting model 'SupportUpload'
        db.delete_table(u'rundb_supportupload')
    ...
    models = {
        ...
        u'rundb.supportupload': {
            ...
            'file': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['rundb.FileMonitor']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
