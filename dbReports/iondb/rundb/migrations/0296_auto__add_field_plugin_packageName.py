...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin.packageName'
        db.add_column(u'rundb_plugin', 'packageName',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, db_column='packagename', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin.packageName'
        db.delete_column(u'rundb_plugin', 'packagename')
