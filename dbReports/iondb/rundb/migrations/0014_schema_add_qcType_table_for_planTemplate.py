...
#20120627 change log:
# added QC types with default threshold
#
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #add table QCType
        db.create_table('rundb_qctype', (
            ('id', models.AutoField(primary_key=True)),
            ('qcName', models.CharField(max_length=512, unique=True)),
        ...
        db.send_create_signal('rundb', ['qctype'])
      

    def backwards(self, orm):
                
        #delete table QCType 
        db.delete_table('rundb_qctype')
