...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('rundb', ['Project'])

        # Adding field 'Results.reference'
        db.add_column('rundb_results', 'reference', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Results.resultsType'
        db.add_column('rundb_results', 'resultsType', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'Results.parentIDs'
        db.add_column('rundb_results', 'parentIDs', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding M2M table for field projects on 'Results'
        db.create_table('rundb_results_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('results', models.ForeignKey(orm['rundb.results'], null=False)),
            ('project', models.ForeignKey(orm['rundb.project'], null=False))
        ))
        db.create_unique('rundb_results_projects', ['results_id', 'project_id'])


    def backwards(self, orm):
        
        # Deleting model 'Project'
        db.delete_table('rundb_project')

        # Deleting field 'Results.reference'
        db.delete_column('rundb_results', 'reference')

        # Deleting field 'Results.resultsType'
        db.delete_column('rundb_results', 'resultsType')

        # Deleting field 'Results.parentIDs'
        db.delete_column('rundb_results', 'parentIDs')

        # Removing M2M table for field projects on 'Results'
        db.delete_table('rundb_results_projects')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 11, 10, 44, 45, 503341)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 11, 10, 44, 45, 503218)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 11, 10, 44, 45, 180391)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
