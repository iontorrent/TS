...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rundb_plannedexperiment', 'sampleDisplayedName', self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 12, 8, 27, 55, 409747)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 12, 8, 27, 55, 409582)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 12, 8, 27, 54, 950893)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
