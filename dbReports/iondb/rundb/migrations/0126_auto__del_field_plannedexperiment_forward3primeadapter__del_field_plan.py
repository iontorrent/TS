...
#20130121 change log:
# Removed obsolete/redundant fields in PlannedExperiment as part of the plan data decentralization (PDD) effort
# Enhanced roll-back logic to restore values in the un-deleted columns


class Migration(SchemaMigration):

    def forwards(self, orm):
        # Deleting field 'PlannedExperiment.forward3primeadapter'
        db.delete_column('rundb_plannedexperiment', 'forward3primeadapter')

        # Deleting field 'PlannedExperiment.autoAnalyze'
        db.delete_column('rundb_plannedexperiment', 'autoAnalyze')

        # Deleting field 'PlannedExperiment.sampleDisplayedName'
        db.delete_column('rundb_plannedexperiment', 'sampleDisplayedName')

        # Deleting field 'PlannedExperiment.notes'
        db.delete_column('rundb_plannedexperiment', 'notes')

        # Deleting field 'PlannedExperiment.sequencekitname'
        db.delete_column('rundb_plannedexperiment', 'sequencekitname')

        # Deleting field 'PlannedExperiment.chipType'
        db.delete_column('rundb_plannedexperiment', 'chipType')

        # Deleting field 'PlannedExperiment.library'
        db.delete_column('rundb_plannedexperiment', 'library')

        # Deleting field 'PlannedExperiment.sample'
        db.delete_column('rundb_plannedexperiment', 'sample')

        # Deleting field 'PlannedExperiment.reverselibrarykey'
        db.delete_column('rundb_plannedexperiment', 'reverselibrarykey')

        # Deleting field 'PlannedExperiment.barcodedSamples'
        db.delete_column('rundb_plannedexperiment', 'barcodedSamples')

        # Deleting field 'PlannedExperiment.barcodeId'
        db.delete_column('rundb_plannedexperiment', 'barcodeId')

        # Deleting field 'PlannedExperiment.regionfile'
        db.delete_column('rundb_plannedexperiment', 'regionfile')

        # Deleting field 'PlannedExperiment.selectedPlugins'
        db.delete_column('rundb_plannedexperiment', 'selectedPlugins')

        # Deleting field 'PlannedExperiment.bedfile'
        db.delete_column('rundb_plannedexperiment', 'bedfile')

        # Deleting field 'PlannedExperiment.libraryKey'
        db.delete_column('rundb_plannedexperiment', 'libraryKey')

        # Deleting field 'PlannedExperiment.flows'
        db.delete_column('rundb_plannedexperiment', 'flows')

        # Deleting field 'PlannedExperiment.variantfrequency'
        db.delete_column('rundb_plannedexperiment', 'variantfrequency')

        # Deleting field 'PlannedExperiment.librarykitname'
        db.delete_column('rundb_plannedexperiment', 'librarykitname')

        # Deleting field 'PlannedExperiment.reverse3primeadapter'
        db.delete_column('rundb_plannedexperiment', 'reverse3primeadapter')


                                                    
    def backwards(self, orm):
        # Adding field 'PlannedExperiment.forward3primeadapter'
        db.add_column('rundb_plannedexperiment', 'forward3primeadapter',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.autoAnalyze'
        db.add_column('rundb_plannedexperiment', 'autoAnalyze',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PlannedExperiment.sampleDisplayedName'
        db.add_column('rundb_plannedexperiment', 'sampleDisplayedName',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.notes'
        db.add_column('rundb_plannedexperiment', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.sequencekitname'
        db.add_column('rundb_plannedexperiment', 'sequencekitname',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.chipType'
        db.add_column('rundb_plannedexperiment', 'chipType',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.library'
        db.add_column('rundb_plannedexperiment', 'library',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.sample'
        db.add_column('rundb_plannedexperiment', 'sample',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.reverselibrarykey'
        db.add_column('rundb_plannedexperiment', 'reverselibrarykey',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.barcodedSamples'
        db.add_column('rundb_plannedexperiment', 'barcodedSamples',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.barcodeId'
        db.add_column('rundb_plannedexperiment', 'barcodeId',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.regionfile'
        db.add_column('rundb_plannedexperiment', 'regionfile',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.selectedPlugins'
        db.add_column('rundb_plannedexperiment', 'selectedPlugins',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.bedfile'
        db.add_column('rundb_plannedexperiment', 'bedfile',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.libraryKey'
        db.add_column('rundb_plannedexperiment', 'libraryKey',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.flows'
        db.add_column('rundb_plannedexperiment', 'flows',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.variantfrequency'
        db.add_column('rundb_plannedexperiment', 'variantfrequency',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.librarykitname'
        db.add_column('rundb_plannedexperiment', 'librarykitname',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PlannedExperiment.reverse3primeadapter'
        db.add_column('rundb_plannedexperiment', 'reverse3primeadapter',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


        #restore data for the resurrected fields
        plans = orm.plannedexperiment.objects.all()
        for plan in plans:
            exp = plan.experiment
            if exp:
                ##print "*** going to restore values from experiment oid=%s for plan.id=%s; name=%s;" %(str(exp.pk), str(plan.pk), plan.planName) 
                
                plan.autoAnalyze = exp.autoAnalyze
                plan.chipType = exp.chipType
                plan.flows = exp.flows
                plan.notes = exp.notes
                plan.exquencekitname = exp.sequencekitname
                ...
                if exp.eas_set:
                    eas_set = exp.eas_set.values().order_by('-date')
                    eas = eas_set[0]                    
                    ##print "*** going to restore values from EAS oid=%s for plan.id=%s; name=%s;" %(str(eas.get("id", "")), str(plan.pk), plan.planName)

                    plan.barcodedSamples = str(eas.get("barcodedSamples", ""))
                    barcodeKitName = str(eas.get("barcodeKitName", ""))
                    plan.barcodeId = barcodeKitName
                    plan.regionfile = str(eas.get("hotSptRegionBedFile", ""))
                    plan.libraryKey = str(eas.get("libraryKey", ""))
                    plan.librarykitname = str(eas.get("libraryKitName", ""))
                    plan.library = str(eas.get("reference", ""))
                    plan.selectedPlugins = str(eas.get("selectedPlugins", {}))
                    plan.bedfile = str(eas.get("targetRegionBedFile", ""))
                    plan.forward3primeadapter = str(eas.get("threePrimeAdapter", ""))
       
                    #if variantCaller is selected, restore variantFrequency values from EAS                          
                    selectedPluginsStr = str(eas.get("selectedPlugins", {}))
                    if selectedPluginsStr:
                        selectedPlugins = json.loads(selectedPluginsStr)
                        pluginInfo = selectedPlugins.get("variantCaller", {})
                        if pluginInfo:
                            userInput = pluginInfo.get("userInput", {})
                            if userInput:
                                plan.variantfrequency = userInput.get("variationtype", "")
                                ##print "--- 0126_ going to set variantFrequency to %s for plan.pk=%s " %(plan.variantfrequency, str(plan.pk))
                                    
                    plan.save()
                    
                    if barcodeKitName and barcodeKitName.lower() != "none":
                        isBarcoded = True
                else:
                    print "!!! Warning: EAS is found missing for plan.id=%s; name=%s; " %(str(plan.pk), plan.planName)
                           
                if not plan.isReusable and not isBarcoded:
                    samples = exp.samples.values()

                    if samples:
                        sample = samples[0]
                        sampleName = str(sample.get("name", ""))
                        sampleDisplayedName = str(sample.get("displayedName", ""))
                        
                        if sampleName:
                            ##print "*** going to restore sample info sampleDisplayedName=%s for plan.id=%s; name=%s;" %(sampleDisplayedName, str(plan.pk), plan.planName)
                    
                            plan.sample = sampleName
                            plan.sampleDisplayedName = sampleDisplayedName
                    
                            plan.save()                            
                        else:
                            print "!!! Warning: should sample name be blank for plan.id=%s; name=%s; " %(str(plan.pk), plan.planName)
                ##else:
                    ##print "*** No sample info restoration needed for plan template or barcoded plan - plan.id=%s; name=%s;" %(str(plan.pk), plan.planName)                 

            else:
                print "!!! Warning: NO experiment found to restore data for the resurrected fields for plan name=%s " %(plan.planName) 
                
        ##does EAS' selectedPlugins have variantFrequency regardless if Variant Caller is selected? 
