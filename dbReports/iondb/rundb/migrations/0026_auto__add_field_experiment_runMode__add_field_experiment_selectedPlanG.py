...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.runMode'
        db.add_column('rundb_experiment', 'runMode', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'Experiment.selectedPlanGUID'
        db.add_column('rundb_experiment', 'selectedPlanGUID', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)

        # Adding field 'Experiment.selectedPlanShortID'
        db.add_column('rundb_experiment', 'selectedPlanShortID', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.runMode'
        db.delete_column('rundb_experiment', 'runMode')

        # Deleting field 'Experiment.selectedPlanGUID'
        db.delete_column('rundb_experiment', 'selectedPlanGUID')

        # Deleting field 'Experiment.selectedPlanShortID'
        db.delete_column('rundb_experiment', 'selectedPlanShortID')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 14, 41, 0, 858830)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 14, 41, 0, 858717)'}),
        ...
        'rundb.plugin': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 7, 14, 41, 0, 484932)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
