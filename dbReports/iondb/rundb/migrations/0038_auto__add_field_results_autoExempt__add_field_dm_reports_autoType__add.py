...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Results.autoExempt'
        db.add_column('rundb_results', 'autoExempt', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'dm_reports.autoType'
        db.add_column('rundb_dm_reports', 'autoType', self.gf('django.db.models.fields.CharField')(default='P', max_length=32), keep_default=False)

        # Adding field 'dm_reports.autoAge'
        db.add_column('rundb_dm_reports', 'autoAge', self.gf('django.db.models.fields.IntegerField')(default=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Results.autoExempt'
        db.delete_column('rundb_results', 'autoExempt')

        # Deleting field 'dm_reports.autoType'
        db.delete_column('rundb_dm_reports', 'autoType')

        # Deleting field 'dm_reports.autoAge'
        db.delete_column('rundb_dm_reports', 'autoAge')
