...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.custom_args'
        db.add_column(u'rundb_experimentanalysissettings', 'custom_args',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.custom_args'
        db.delete_column(u'rundb_experimentanalysissettings', 'custom_args')
