...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin.requires_configuration'
        db.add_column(u'rundb_plugin', 'requires_configuration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin.requires_configuration'
        db.delete_column(u'rundb_plugin', 'requires_configuration')
