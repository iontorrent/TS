...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.isDefaultForInstrumentType'
        db.add_column(u'rundb_applproduct', 'isDefaultForInstrumentType',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.isDefaultForInstrumentType'
        db.delete_column(u'rundb_applproduct', 'isDefaultForInstrumentType')
