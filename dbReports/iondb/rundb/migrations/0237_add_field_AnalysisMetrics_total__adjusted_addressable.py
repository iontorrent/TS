...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnalysisMetrics.total'
        db.add_column(u'rundb_analysismetrics', 'total',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AnalysisMetrics.adjusted_addressable'
        db.add_column(u'rundb_analysismetrics', 'adjusted_addressable',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'AnalysisMetrics.loading'
        db.add_column(u'rundb_analysismetrics', 'loading',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnalysisMetrics.total'
        db.delete_column(u'rundb_analysismetrics', 'total')

        # Deleting field 'AnalysisMetrics.adjusted_addressable'
        db.delete_column(u'rundb_analysismetrics', 'adjusted_addressable')

        # Deleting field 'AnalysisMetrics.loading'
        db.delete_column(u'rundb_analysismetrics', 'loading')
