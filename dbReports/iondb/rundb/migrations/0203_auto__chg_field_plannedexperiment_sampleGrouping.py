...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PlannedExperiment.sampleGrouping' to match new field type.
        db.rename_column(u'rundb_plannedexperiment', 'sampleGrouping', 'sampleGrouping_old')

        # Changing field 'PlannedExperiment.sampleGrouping'
        db.add_column(u'rundb_plannedexperiment', 'sampleGrouping', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.SampleGroupType_CV'], null=True))

        db.start_transaction()

        db.execute("""
            UPDATE "rundb_plannedexperiment" SET "sampleGrouping_id" =
                (SELECT "rundb_samplegrouptype_cv"."id" FROM "rundb_samplegrouptype_cv"
                    WHERE "rundb_samplegrouptype_cv"."id"::varchar = "rundb_plannedexperiment"."sampleGrouping_old"::varchar AND "rundb_plannedexperiment"."sampleGrouping_old" != ''
                )
        """)
        ...
        db.delete_column(u'rundb_plannedexperiment','sampleGrouping_old')
        
        # # Adding index on 'PlannedExperiment', fields ['sampleGrouping']
        # db.create_index(u'rundb_plannedexperiment', ['sampleGrouping_id'])


    def backwards(self, orm):
        # Removing index on 'PlannedExperiment', fields ['sampleGrouping']
        db.delete_index(u'rundb_plannedexperiment', ['sampleGrouping_id'])


        # Renaming column for 'PlannedExperiment.sampleGrouping' to match new field type.
        db.rename_column(u'rundb_plannedexperiment', 'sampleGrouping_id', 'sampleGrouping')
        # Changing field 'PlannedExperiment.sampleGrouping'
        db.alter_column(u'rundb_plannedexperiment', 'sampleGrouping', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
