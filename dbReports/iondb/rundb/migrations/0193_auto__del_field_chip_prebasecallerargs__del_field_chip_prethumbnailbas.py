...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chip.prebasecallerargs'
        db.delete_column(u'rundb_chip', 'prebasecallerargs')

        # Deleting field 'Chip.prethumbnailbasecallerargs'
        db.delete_column(u'rundb_chip', 'prethumbnailbasecallerargs')

        # Deleting field 'Chip.thumbnailbasecallerargs'
        db.delete_column(u'rundb_chip', 'thumbnailbasecallerargs')

        # Deleting field 'Chip.thumbnailanalysisargs'
        db.delete_column(u'rundb_chip', 'thumbnailanalysisargs')

        # Deleting field 'Chip.thumbnailbeadfindargs'
        db.delete_column(u'rundb_chip', 'thumbnailbeadfindargs')

        # Deleting field 'Chip.analysisargs'
        db.delete_column(u'rundb_chip', 'analysisargs')

        # Deleting field 'Chip.basecallerargs'
        db.delete_column(u'rundb_chip', 'basecallerargs')

        # Deleting field 'Chip.beadfindargs'
        db.delete_column(u'rundb_chip', 'beadfindargs')


    def backwards(self, orm):
        # Adding field 'Chip.prebasecallerargs'
        db.add_column(u'rundb_chip', 'prebasecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Chip.prethumbnailbasecallerargs'
        db.add_column(u'rundb_chip', 'prethumbnailbasecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Chip.thumbnailbasecallerargs'
        db.add_column(u'rundb_chip', 'thumbnailbasecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Chip.thumbnailanalysisargs'
        db.add_column(u'rundb_chip', 'thumbnailanalysisargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Chip.thumbnailbeadfindargs'
        db.add_column(u'rundb_chip', 'thumbnailbeadfindargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Chip.analysisargs'
        db.add_column(u'rundb_chip', 'analysisargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Chip.basecallerargs'
        db.add_column(u'rundb_chip', 'basecallerargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'Chip.beadfindargs'
        db.add_column(u'rundb_chip', 'beadfindargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)
