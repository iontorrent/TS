...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ApplProduct.defaultVariantFrequency'
        db.delete_column(u'rundb_applproduct', 'defaultVariantFrequency')

        # Adding field 'ApplProduct.isBarcodeKitSelectionRequired'
        db.add_column(u'rundb_applproduct', 'isBarcodeKitSelectionRequired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ApplProduct.barcodeKitSelectableType'
        db.add_column(u'rundb_applproduct', 'barcodeKitSelectableType',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'ApplProduct.isSamplePrepKitSupported'
        db.add_column(u'rundb_applproduct', 'isSamplePrepKitSupported',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ApplProduct.defaultVariantFrequency'
        db.add_column(u'rundb_applproduct', 'defaultVariantFrequency',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ApplProduct.isBarcodeKitSelectionRequired'
        db.delete_column(u'rundb_applproduct', 'isBarcodeKitSelectionRequired')

        # Deleting field 'ApplProduct.barcodeKitSelectableType'
        db.delete_column(u'rundb_applproduct', 'barcodeKitSelectableType')

        # Deleting field 'ApplProduct.isSamplePrepKitSupported'
        db.delete_column(u'rundb_applproduct', 'isSamplePrepKitSupported')
