...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.cancerType'
        db.add_column(u'rundb_samplesetitem', 'cancerType',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.cellularityPct'
        db.add_column(u'rundb_samplesetitem', 'cellularityPct',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.cancerType'
        db.delete_column(u'rundb_samplesetitem', 'cancerType')

        # Deleting field 'SampleSetItem.cellularityPct'
        db.delete_column(u'rundb_samplesetitem', 'cellularityPct')
