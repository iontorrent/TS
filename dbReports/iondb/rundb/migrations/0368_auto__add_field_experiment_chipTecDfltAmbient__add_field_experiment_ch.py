...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.chipTecDfltAmbient'
        db.add_column(u'rundb_experiment', 'chipTecDfltAmbient',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chipTecSlope'
        db.add_column(u'rundb_experiment', 'chipTecSlope',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.chipTecMinThreshold'
        db.add_column(u'rundb_experiment', 'chipTecMinThreshold',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.manTecDfltAmbient'
        db.add_column(u'rundb_experiment', 'manTecDfltAmbient',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.manTecSlope'
        db.add_column(u'rundb_experiment', 'manTecSlope',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Experiment.manTecMinThreshold'
        db.add_column(u'rundb_experiment', 'manTecMinThreshold',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.chipTecDfltAmbient'
        db.delete_column(u'rundb_experiment', 'chipTecDfltAmbient')

        # Deleting field 'Experiment.chipTecSlope'
        db.delete_column(u'rundb_experiment', 'chipTecSlope')

        # Deleting field 'Experiment.chipTecMinThreshold'
        db.delete_column(u'rundb_experiment', 'chipTecMinThreshold')

        # Deleting field 'Experiment.manTecDfltAmbient'
        db.delete_column(u'rundb_experiment', 'manTecDfltAmbient')

        # Deleting field 'Experiment.manTecSlope'
        db.delete_column(u'rundb_experiment', 'manTecSlope')

        # Deleting field 'Experiment.manTecMinThreshold'
        db.delete_column(u'rundb_experiment', 'manTecMinThreshold')
    ...
    models = {
        ...
        u'rundb.analysisargs': {
            ...
            'applCategory': ('django.db.models.fields.CharField', [], {'max_length': '127', 'null': 'True', 'blank': 'True'}),
        ...
        u'rundb.chefpcrplateconfig': {
            'Meta': {'object_name': 'ChefPcrPlateconfig'},
            'confg': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rundb.KitInfo']", 'null': 'True', 'blank': 'True'})
        },
        u'rundb.chip': {
        ...
        u'rundb.experiment': {
            ...
            'chipTecDfltAmbient': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'chipTecMinThreshold': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'chipTecSlope': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'manTecDfltAmbient': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'manTecMinThreshold': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'manTecSlope': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'rundb.globalconfig': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'majorPlatform': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '24', 'null': 'True', 'blank': 'True'}),
        ...
        u'rundb.plannedexperiment': {
            ...
            'libraryPool': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'libraryReadLength': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'metaData': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'blank': 'True'}),
        ...
        u'rundb.sampleset': {
            ...
            'additionalCycles': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'categories': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'blank': 'True'}),
            ...
            'libraryPrepInstrumentData': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'libraryPrepData_sampleSet'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['rundb.SamplePrepData']"}),
            ...
            'libraryPrepProtocol': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        u'rundb.samplesetitem': {
            ...
            'assayGroup': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            ...
            'mouseStrains': ('django.db.models.fields.CharField', [], {'max_length': '127', 'null': 'True', 'blank': 'True'}),
            'nucleotideType': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
            'panelPoolType': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            ...
            'population': ('django.db.models.fields.CharField', [], {'max_length': '127', 'null': 'True', 'blank': 'True'}),
            ...
            'sampleCollectionDate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'sampleReceiptDate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'sampleSet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'samples'", 'to': u"orm['rundb.SampleSet']"}),
            'sampleSource': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'tubePosition': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'rundb.userprofile': {
            ...
            'needs_activation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
