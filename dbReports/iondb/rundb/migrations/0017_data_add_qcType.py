...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # add qc type data
        orm.qctype.objects.get_or_create(qcName='Bead Loading (%)', minThreshold='0', maxThreshold='100', defaultThreshold='30');
        orm.qctype.objects.get_or_create(qcName='Key Signal (1-100)', minThreshold='1', maxThreshold='100', defaultThreshold='30');
        orm.qctype.objects.get_or_create(qcName='Usable Sequence (%)', minThreshold='0', maxThreshold='100', defaultThreshold='50');    
    ...
    def backwards(self, orm):
        ...
        # delete qc type data         
        for qcType in orm.qctype.objects.filter(qcName__in=['Bead Loading (%)', 'Key Signal (1-100)', 'Usable Sequence (%)']):
            qcType.delete()
    ...
    models = {
        ...
        'rundb.qctype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'blank': 'True'}),
            'qcName': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'False', 'unique': 'True'}),
