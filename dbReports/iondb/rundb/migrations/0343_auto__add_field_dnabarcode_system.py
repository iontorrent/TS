...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'dnaBarcode.system'
        db.add_column(u'rundb_dnabarcode', 'system', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'dnaBarcode.system'
        db.delete_column(u'rundb_dnabarcode', 'system')
