...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Chip.args'
        db.delete_column('rundb_chip', 'args')

        # Adding field 'Chip.analysisargs'
        db.add_column('rundb_chip', 'analysisargs', self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True), keep_default=False)

        # Adding field 'Chip.basecallerargs'
        db.add_column('rundb_chip', 'basecallerargs', self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True), keep_default=False)

        # Adding field 'Chip.beadfindargs'
        db.add_column('rundb_chip', 'beadfindargs', self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True), keep_default=False)

        # Adding field 'Chip.thumbnailanalysisargs'
        db.add_column('rundb_chip', 'thumbnailanalysisargs', self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True), keep_default=False)

        # Adding field 'Chip.thumbnailbasecallerargs'
        db.add_column('rundb_chip', 'thumbnailbasecallerargs', self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True), keep_default=False)

        # Adding field 'Chip.thumbnailbeadfindargs'
        db.add_column('rundb_chip', 'thumbnailbeadfindargs', self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Chip.args'
        db.add_column('rundb_chip', 'args', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Deleting field 'Chip.analysisargs'
        db.delete_column('rundb_chip', 'analysisargs')

        # Deleting field 'Chip.basecallerargs'
        db.delete_column('rundb_chip', 'basecallerargs')

        # Deleting field 'Chip.beadfindargs'
        db.delete_column('rundb_chip', 'beadfindargs')

        # Deleting field 'Chip.thumbnailanalysisargs'
        db.delete_column('rundb_chip', 'thumbnailanalysisargs')

        # Deleting field 'Chip.thumbnailbasecallerargs'
        db.delete_column('rundb_chip', 'thumbnailbasecallerargs')

        # Deleting field 'Chip.thumbnailbeadfindargs'
        db.delete_column('rundb_chip', 'thumbnailbeadfindargs')
