...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KitInfo.cartridgeBetweenUsageAbsoluteMaxDayLimit'
        db.add_column(u'rundb_kitinfo', 'cartridgeBetweenUsageAbsoluteMaxDayLimit',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KitInfo.cartridgeBetweenUsageAbsoluteMaxDayLimit'
        db.delete_column(u'rundb_kitinfo', 'cartridgeBetweenUsageAbsoluteMaxDayLimit')
