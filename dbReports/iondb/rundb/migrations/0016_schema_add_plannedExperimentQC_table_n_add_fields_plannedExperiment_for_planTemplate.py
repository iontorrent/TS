...
#20120627 change log:
# modified plannedExperiment to support 
#    1) template, 
#    2) PE plan/template grouping, 
#    3) run mode, 
#    4) application-product-driven plan/template creation,
#    5) system pre-defined template,
#    6) system default plan,
#    7) QC thresholds
#    8) favorites
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlannedExperimentQC'
        # many2many model for plannedexperiment to qctype
        db.create_table('rundb_plannedexperimentqc', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plannedExperiment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.PlannedExperiment'], null=False)),
            ('qcType', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.QCType'], null=False)),
            ('threshold', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=False)),
        ))
        # Adding unique constraint on 'PlannedExperimentQC', fields ['plannedexperiment', 'qctype']
        db.create_unique('rundb_plannedexperimentqc', ['plannedExperiment_id', 'qcType_id'])
        db.send_create_signal('rundb', ['PlannedExperimentQC'])

        #add attributes to PlannedExperiments
        db.add_column('rundb_plannedexperiment', 'planDisplayedName', self.gf('django.db.models.fields.CharField') (max_length=512, blank=True, null=True))
        db.add_column('rundb_plannedexperiment', 'runMode', self.gf('django.db.models.fields.CharField') (max_length=64, default='single', blank=True))
        db.add_column('rundb_plannedexperiment', 'isReusable', self.gf('django.db.models.fields.BooleanField') (default=False))
        db.add_column('rundb_plannedexperiment', 'isFavorite', self.gf('django.db.models.fields.BooleanField') (default=False))
        db.add_column('rundb_plannedexperiment', 'isSystem', self.gf('django.db.models.fields.BooleanField') (default=False))
        db.add_column('rundb_plannedexperiment', 'isSystemDefault', self.gf('django.db.models.fields.BooleanField') (default=False))
        db.add_column('rundb_plannedexperiment', 'isPlanGroup', self.gf('django.db.models.fields.BooleanField') (default=False))
        db.add_column('rundb_plannedexperiment', 'parentPlan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='childPlan_set', null=True, to=orm['rundb.PlannedExperiment']), keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'PlannedExperimentQC', fields ['plannedexperiment', 'qctype']
        db.delete_unique('rundb_plannedexperimentqc', ['plannedExperiment_id', 'qcType_id'])

        #delete table PlannedExperimentQC
        db.delete_table('rundb_plannedexperimentqc')

        #delete attributes from PlannedExperiments
        db.delete_column('rundb_plannedexperiment', 'planDisplayedName')
        db.delete_column('rundb_plannedexperiment', 'runMode')
        db.delete_column('rundb_plannedexperiment', 'isReusable')
        db.delete_column('rundb_plannedexperiment', 'isFavorite')
        db.delete_column('rundb_plannedexperiment', 'isSystem')
        db.delete_column('rundb_plannedexperiment', 'isSystemDefault')
        db.delete_column('rundb_plannedexperiment', 'isPlanGroup')
        db.delete_column('rundb_plannedexperiment', 'parentPlan_id')
    ...
    models = {
        ...
        'rundb.plannedexperiment': {
            ...
            'metaData': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'blank': 'True'}),
            'notes': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}), 
            'parentPlan': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rundb.PlannedExperiment']", 'related_name': "'childPlan_set'", 'null': 'True'}),
            ...
            'qcValues': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['rundb.QCType']", 'through': "'rundb.PlannedExperimentQC'", 'null': 'True'}),
