...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.platform'
        db.add_column(u'rundb_experiment', 'platform',
                      self.gf('django.db.models.fields.CharField')(default='PGM', max_length=128, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Experiment.platform'
        db.delete_column(u'rundb_experiment', 'platform')
