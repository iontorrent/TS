...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KitInfo.runMode'
        db.add_column('rundb_kitinfo', 'runMode', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'KitInfo.runMode'
        db.delete_column('rundb_kitinfo', 'runMode')
