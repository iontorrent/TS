...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlannedExperiment.sampleSet'
        db.delete_column(u'rundb_plannedexperiment', 'sampleSet_id')


    def backwards(self, orm):
        # Adding field 'PlannedExperiment.sampleSet'
        db.add_column(u'rundb_plannedexperiment', 'sampleSet',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='plans_set', null=True, to=orm['rundb.SampleSet'], blank=True),
                      keep_default=False)
