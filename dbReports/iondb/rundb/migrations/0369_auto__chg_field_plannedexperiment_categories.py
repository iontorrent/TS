...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlannedExperiment.categories'
        db.alter_column(u'rundb_plannedexperiment', 'categories', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'PlannedExperiment.categories'
        db.alter_column(u'rundb_plannedexperiment', 'categories', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    models = {
        ...
        u'rundb.plannedexperiment': {
            ...
            'categories': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
