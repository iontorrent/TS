...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlannedExperiment.libraryPool'
        db.add_column(u'rundb_plannedexperiment', 'libraryPool',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlannedExperiment.libraryPool'
        db.delete_column(u'rundb_plannedexperiment', 'libraryPool')
