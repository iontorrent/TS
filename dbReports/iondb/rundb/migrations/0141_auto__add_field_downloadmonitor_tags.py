...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DownloadMonitor.tags'
        db.add_column('rundb_downloadmonitor', 'tags',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DownloadMonitor.tags'
        db.delete_column('rundb_downloadmonitor', 'tags')
