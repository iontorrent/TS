...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.tfKey'
        db.add_column(u'rundb_experimentanalysissettings', 'tfKey',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.tfKey'
        db.delete_column(u'rundb_experimentanalysissettings', 'tfKey')
