...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experiment.plan'
        db.alter_column('rundb_experiment', 'plan_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['rundb.PlannedExperiment']))
        # Adding unique constraint on 'Experiment', fields ['plan']
        db.create_unique('rundb_experiment', ['plan_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Experiment', fields ['plan']
        db.delete_unique('rundb_experiment', ['plan_id'])


        # Changing field 'Experiment.plan'
        db.alter_column('rundb_experiment', 'plan_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rundb.PlannedExperiment']))
