...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rig.host_address'
        db.add_column(u'rundb_rig', 'host_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)

        # Adding field 'Rig.type'
        db.add_column(u'rundb_rig', 'type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rig.host_address'
        db.delete_column(u'rundb_rig', 'host_address')

        # Deleting field 'Rig.type'
        db.delete_column(u'rundb_rig', 'type')
