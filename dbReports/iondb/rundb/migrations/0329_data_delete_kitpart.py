...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # remove obsolete kitpart db entries
        for entry in orm.kitpart.objects.filter(barcode__in=["LPREP0003_A29026C_obsolete", "A30934C", "ICPREP0011_A27754C_obsolete", "A33210C"]):
            print "*** 0329 > Removing kitpart pk=%d; barcode=%s" % (entry.id, entry.barcode) 
            entry.delete()
