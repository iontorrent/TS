...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSet.categories'
        db.add_column(u'rundb_sampleset', 'categories',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Rename field SampleSet.cyclingProtocols to libraryPrepProtocol
        db.rename_column("rundb_sampleset", "cyclingProtocols", "libraryPrepProtocol")


        # Set null on delete 'SampleSet.libraryPrepInstrumentData'
        db.alter_column(u'rundb_sampleset', 'libraryPrepInstrumentData_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['rundb.SamplePrepData']))


    def backwards(self, orm):
        db.delete_column(u'rundb_sampleset', 'categories')
        db.rename_column("rundb_sampleset", "libraryPrepProtocol", "cyclingProtocols")
