...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QualityMetrics.q0_15bp_reads'
        db.delete_column('rundb_qualitymetrics', 'q0_15bp_reads')


    def backwards(self, orm):
        # Adding field 'QualityMetrics.q0_15bp_reads'
        db.add_column('rundb_qualitymetrics', 'q0_15bp_reads',
