...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DownloadMonitor'
        db.create_table('rundb_downloadmonitor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('remote_url', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('local_dir', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('size', self.gf('django.db.models.fields.IntegerField')(default=None, null=True)),
            ...
            ('celery_task_id', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('rundb', ['DownloadMonitor'])


    def backwards(self, orm):
        # Deleting model 'DownloadMonitor'
        db.delete_table('rundb_downloadmonitor')
    ...
    models = {
        ...
        'rundb.downloadmonitor': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_dir': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
