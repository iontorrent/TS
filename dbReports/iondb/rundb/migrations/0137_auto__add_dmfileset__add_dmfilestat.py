...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DMFileSet'
        db.create_table('rundb_dmfileset', (
            ...
            ('backup_directory', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('bandwidth_limit', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('include', self.gf('iondb.rundb.separatedValuesField.SeparatedValuesField')(null=True, blank=True)),
            ('exclude', self.gf('iondb.rundb.separatedValuesField.SeparatedValuesField')(null=True, blank=True)),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('auto_trigger_age', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('auto_trigger_usage', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('auto_action', self.gf('django.db.models.fields.CharField')(default='OFF', max_length=8)),
            ('del_empty_dir', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('rundb', ['DMFileSet'])

        # Adding model 'DMFileStat'
        db.create_table('rundb_dmfilestat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filesys_status', self.gf('django.db.models.fields.CharField')(default='L', max_length=4)),
            ('action_state', self.gf('django.db.models.fields.CharField')(default='U', max_length=8)),
            ('archivepath', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('diskspace', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('result', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.Results'], null=True, blank=True)),
            ('dmfileset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rundb.DMFileSet'], null=True, blank=True)),
        ))
        db.send_create_signal('rundb', ['DMFileStat'])


    def backwards(self, orm):
        # Deleting model 'DMFileSet'
        db.delete_table('rundb_dmfileset')

        # Deleting model 'DMFileStat'
        db.delete_table('rundb_dmfilestat')
    ...
    models = {
        ...
        'rundb.dmfilestat': {
            ...
            'action_state': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '8'}),
            ...
            'filesys_status': ('django.db.models.fields.CharField', [], {'default': "'L'", 'max_length': '4'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
