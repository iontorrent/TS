...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PluginResult.validation_errors'
        db.add_column(u'rundb_pluginresult', 'validation_errors',
                      self.gf('django.db.models.fields.TextField')(default='{}', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PluginResult.validation_errors'
        db.delete_column(u'rundb_pluginresult', 'validation_errors')
