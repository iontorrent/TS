...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SampleSetItem.biopsyDays'
        db.add_column(u'rundb_samplesetitem', 'biopsyDays',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.coupleId'
        db.add_column(u'rundb_samplesetitem', 'coupleId',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SampleSetItem.embryoId'
        db.add_column(u'rundb_samplesetitem', 'embryoId',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SampleSetItem.biopsyDays'
        db.delete_column(u'rundb_samplesetitem', 'biopsyDays')

        # Deleting field 'SampleSetItem.coupleId'
        db.delete_column(u'rundb_samplesetitem', 'coupleId')

        # Deleting field 'SampleSetItem.embryoId'
        db.delete_column(u'rundb_samplesetitem', 'embryoId')
