...
#20130809 change log:
# 1) delete all Ion 3' adapter data to switch to using initial data load 
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        for adapter in orm.threeprimeadapter.objects.filter(name__icontains="ion"):
            print "*** 0179_ *** GOING to delete adapter=%s with id=%s " %(adapter.name, str(adapter.id))
            adapter.delete()

        for adapter in orm.threeprimeadapter.objects.filter(name__icontains="museek"):
            print "*** 0179_ *** GOING to delete adapter=%s with id=%s " %(adapter.name, str(adapter.id))
            adapter.delete()
