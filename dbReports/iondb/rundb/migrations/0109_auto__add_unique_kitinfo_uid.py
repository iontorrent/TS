...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'KitInfo', fields ['uid']
        db.create_unique('rundb_kitinfo', ['uid'])


    def backwards(self, orm):
        # Removing unique constraint on 'KitInfo', fields ['uid']
        db.delete_unique('rundb_kitinfo', ['uid'])
