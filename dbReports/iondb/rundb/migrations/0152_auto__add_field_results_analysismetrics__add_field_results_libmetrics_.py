...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Results.analysismetrics'
        db.add_column('rundb_results', 'analysismetrics',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rundb.AnalysisMetrics'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'Results.libmetrics'
        db.add_column('rundb_results', 'libmetrics',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rundb.LibMetrics'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'Results.qualitymetrics'
        db.add_column('rundb_results', 'qualitymetrics',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rundb.QualityMetrics'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Results.analysismetrics'
        db.delete_column('rundb_results', 'analysismetrics_id')

        # Deleting field 'Results.libmetrics'
        db.delete_column('rundb_results', 'libmetrics_id')

        # Deleting field 'Results.qualitymetrics'
        db.delete_column('rundb_results', 'qualitymetrics_id')
