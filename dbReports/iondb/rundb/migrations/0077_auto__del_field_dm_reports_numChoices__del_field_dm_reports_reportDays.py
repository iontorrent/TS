...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'dm_reports.numChoices'
        db.delete_column('rundb_dm_reports', 'numChoices')

        # Deleting field 'dm_reports.reportDays'
        db.delete_column('rundb_dm_reports', 'reportDays')

        # Deleting field 'dm_reports.pruneStringText'
        db.delete_column('rundb_dm_reports', 'pruneStringText')

        # Deleting field 'dm_reports.pruneStrings'
        db.delete_column('rundb_dm_reports', 'pruneStrings')

        # Deleting field 'dm_prune_group.id_number'
        db.delete_column('rundb_dm_prune_group', 'id_number')

        # Deleting field 'dm_prune_group.rules'
        db.delete_column('rundb_dm_prune_group', 'rules')


    def backwards(self, orm):
        
        # Adding field 'dm_reports.numChoices'
        db.add_column('rundb_dm_reports', 'numChoices', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'dm_reports.reportDays'
        db.add_column('rundb_dm_reports', 'reportDays', self.gf('django.db.models.fields.IntegerField')(default=30), keep_default=False)

        # Adding field 'dm_reports.pruneStringText'
        db.add_column('rundb_dm_reports', 'pruneStringText', self.gf('django.db.models.fields.CharField')(default='', max_length=512), keep_default=False)

        # Adding field 'dm_reports.pruneStrings'
        db.add_column('rundb_dm_reports', 'pruneStrings', self.gf('django.db.models.fields.TextField')(default='{}', blank=True), keep_default=False)

        # Adding field 'dm_prune_group.id_number'
        db.add_column('rundb_dm_prune_group', 'id_number', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'dm_prune_group.rules'
        db.add_column('rundb_dm_prune_group', 'rules', self.gf('django.db.models.fields.TextField')(default='{}', blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 11, 21, 52, 43)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 11, 21, 52, 43)'}),
