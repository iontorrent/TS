...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Set all references which are not in error to the 'complete' status"
        ReferenceGenome = orm['rundb.ReferenceGenome']
        ReferenceGenome.objects.exclude(status="error").update(status="complete")
