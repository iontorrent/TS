...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ApplProduct.defaultSamplePrepKit'
        db.add_column('rundb_applproduct', 'defaultSamplePrepKit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='samplePrepKit_applProduct_set', null=True, to=orm['rundb.KitInfo']), keep_default=False)

        # Adding field 'PlannedExperiment.samplePrepKitName'
        db.add_column('rundb_plannedexperiment', 'samplePrepKitName', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ApplProduct.defaultSamplePrepKit'
        db.delete_column('rundb_applproduct', 'defaultSamplePrepKit_id')

        # Deleting field 'PlannedExperiment.samplePrepKitName'
        db.delete_column('rundb_plannedexperiment', 'samplePrepKitName')
