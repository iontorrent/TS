...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GlobalConfig.mark_duplicates'
        db.add_column('rundb_globalconfig', 'mark_duplicates',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'ExperimentAnalysisSettings.hotSpotRegionBedFile'
        db.alter_column('rundb_experimentanalysissettings', 'hotSpotRegionBedFile', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'ExperimentAnalysisSettings.targetRegionBedFile'
        db.alter_column('rundb_experimentanalysissettings', 'targetRegionBedFile', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):
        # Deleting field 'GlobalConfig.mark_duplicates'
        db.delete_column('rundb_globalconfig', 'mark_duplicates')


        # Changing field 'ExperimentAnalysisSettings.hotSpotRegionBedFile'
        db.alter_column('rundb_experimentanalysissettings', 'hotSpotRegionBedFile', self.gf('django.db.models.fields.CharField')(default='', max_length=1024))

        # Changing field 'ExperimentAnalysisSettings.targetRegionBedFile'
        db.alter_column('rundb_experimentanalysissettings', 'targetRegionBedFile', self.gf('django.db.models.fields.CharField')(default='', max_length=1024))
