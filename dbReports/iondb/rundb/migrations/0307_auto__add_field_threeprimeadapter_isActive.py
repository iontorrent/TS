...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThreePrimeadapter.isActive'
        db.add_column(u'rundb_threeprimeadapter', 'isActive',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThreePrimeadapter.isActive'
        db.delete_column(u'rundb_threeprimeadapter', 'isActive')
