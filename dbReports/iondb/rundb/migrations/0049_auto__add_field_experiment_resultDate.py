...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Experiment.resultDate'
        db.add_column('rundb_experiment', 'resultDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Experiment.resultDate'
        db.delete_column('rundb_experiment', 'resultDate')
