...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'common_CV.isVisible'
        db.add_column(u'rundb_common_cv', 'isVisible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'common_CV.isVisible'
        db.delete_column(u'rundb_common_cv', 'isVisible')
