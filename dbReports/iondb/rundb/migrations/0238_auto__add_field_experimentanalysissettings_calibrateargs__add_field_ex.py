...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExperimentAnalysisSettings.calibrateargs'
        db.add_column(u'rundb_experimentanalysissettings', 'calibrateargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'ExperimentAnalysisSettings.thumbnailcalibrateargs'
        db.add_column(u'rundb_experimentanalysissettings', 'thumbnailcalibrateargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'AnalysisArgs.calibrateargs'
        db.add_column(u'rundb_analysisargs', 'calibrateargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)

        # Adding field 'AnalysisArgs.thumbnailcalibrateargs'
        db.add_column(u'rundb_analysisargs', 'thumbnailcalibrateargs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExperimentAnalysisSettings.calibrateargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'calibrateargs')

        # Deleting field 'ExperimentAnalysisSettings.thumbnailcalibrateargs'
        db.delete_column(u'rundb_experimentanalysissettings', 'thumbnailcalibrateargs')

        # Deleting field 'AnalysisArgs.calibrateargs'
        db.delete_column(u'rundb_analysisargs', 'calibrateargs')

        # Deleting field 'AnalysisArgs.thumbnailcalibrateargs'
        db.delete_column(u'rundb_analysisargs', 'thumbnailcalibrateargs')
