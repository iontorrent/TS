...
from iondb.utils import makePDF, files
from ion.utils import makeCSA
from iondb.rundb.tasks import removeDirContents, setResultDiskspace
...
def archiveReportShort(pkR, comment, _logger):
    try:
        ...
        if bk.location != (None or 'None' or '' or ' ' or '/'):
            ...
            #update diskusage in this result's database object
