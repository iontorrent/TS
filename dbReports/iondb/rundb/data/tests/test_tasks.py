...
# from iondb.rundb.data import result_archive as ion_archiveResult
...
#         # returns method results directly
#         result = iondb.rundb.data.tasks.prune_report(username, _id, comment)
...
#         # returns method results directly
#         result = iondb.rundb.data.tasks.archive_report(username, _id, comment)
...
#         result = iondb.rundb.data.tasks.archive_report.delay(username, _id, comment)
...
#         iondb.rundb.data.tasks.sync_filesystem_and_db_report_state.delay()
