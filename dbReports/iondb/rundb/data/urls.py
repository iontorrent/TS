...
urlpatterns = patterns(
    ...
    url(r'^project/(?P<project_pk>\d+)/results/(?P<result_pks>[\d,]+)/getSelectedCSV.csv$', 'views.get_project_CSV', name="get_project_CSV"),
#    url(r'^results/([\d,]+)/combine/sendto/project/(\d+)/(\w+)/$', 'views.combine_results_sendto_project', name="combine_results_sendto_project"),
    ...
    url(r'^datamanagement/dm_actions/(?P<results_pks>[\d,]+)/(?P<action>\w+)/$', 'views.dm_action_selected', name="dm_action_selected"),
    ...
    url(r'^datamanagement/dmactions_jobs/cancel/(?P<pk>\d+)/', 'views.cancel_pending_dmaction', name='cancel_pending_dmaction'),

    url(r'^datamanagement/browse_backup_dirs/(?P<path>.*)', 'views.browse_backup_dirs', name='browse_backup_dirs'),
