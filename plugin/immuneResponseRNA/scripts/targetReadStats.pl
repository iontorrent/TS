...
The file format is a table file with fields as generated by the coverageAnalysis scripts.
By default coverage is assumed to be by reads per individual target, sorted on the 'coverage depth' field (9).
The -a or -r options should be used if the input is for amplicon targets (as produced by targetReadCoverage.pl).
...
my $OPTIONS = "Options:
  ...
  -C <pcnt> Percentage of target length covered by at least one read for targe to be considered 'fully' covered. Default: 98.
...
sub outputStats
{
  ...
  if( $basedepths ) {
    ...
    printf "%ss with at least 1 reads:     %d\n",$tagU,$cumd[1];
    printf "%ss with at least 2 reads:     %d\n",$tagU,$cumd[2];
    printf "%ss with at least 3 reads:     %d\n",$tagU,$cumd[3];
    printf "%ss with at least 5 reads:     %d\n",$tagU,$cumd[5];
    ...
    printf "%ss with at least 1 reads:     %.2f%%\n",$tagU,$cumd[1]*$scl;
    printf "%ss with at least 2 reads:     %.2f%%\n",$tagU,$cumd[1]*$scl;
    printf "%ss with at least 3 reads:     %.2f%%\n",$tagU,$cumd[1]*$scl;
    printf "%ss with at least 5 reads:     %.2f%%\n",$tagU,$cumd[1]*$scl;
