...
print_html_variants_indels()
{
echo \
"            <div id=\"VariantCalls\" class=\"report_block\">
                <h2>Variant Calls (Insertions/Deletions) with frequency > 5%</h2>
                <div calss=\"demo_jui\">
					<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"noheading\" id=\"indeltable\" style=\"word-wrap:break-word\">
						<thead>
							<tr>
								<th class=\"col_med\">
								</th>
...
run python ${DIRNAME}/parse_variants_indels.py  ${TSP_FILEPATH_PLUGIN_DIR}/indel_variants.vcf.gz ${TSP_FILEPATH_PLUGIN_DIR}/indel_variants.xls;
echo -n \
"						</tbody>
                    </table>
					<div class=\"spacer\"></div>
                    <br>
                    <input value=\"Export displayed table as CSV\" type=\"button\" onclick=\"\$('#gatktable').table2CSV({header:['Sequence Name', 'Position', 'Gene Name', 'Reference', 'Variant', 'VarFreq','P-value','Total Coverage','Reference Coverage', 'Variant Coverage']})\">
