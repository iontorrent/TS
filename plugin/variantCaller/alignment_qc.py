...
class TMAP( object ):
    """
        ex:tmap mapall -Y -n 4 -f /results/referenceLibrary/tmap-f2/hg19/hg19.fasta -r /results2/analysis/output/Home/Auto_HOF-568-r124806-1100rpm_280m-jo_7819_11575/R_2011_08_31_17_10_25_user_HOF-568-r124806-1100rpm_280m-jo_Auto_HOF-568-r124806-1100rpm_280m-jo_7819.fastq.truncated.fastq -v map1 map2 map3 2>> alignmentQC_out.txt
        
    """
    def __init__(self):
        self.program = "tmap mapall"
        self.defaultParams = "-n 4 -v map1 map2 map3"
        self.sam = False
        self.pipe = False
