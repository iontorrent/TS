...
barcode_links ()
{
    ...
    echo "    <h2>Barcode Coverage and Sample Identification Report</h2>" >> "$HTML"
    echo "    <div>" >> "$HTML"
    echo "     <br/>" >> "$HTML"
    ...
    echo "      <tr>" >> "$HTML"
    echo "      <th style=\"width:200px !important\"><span class=\"help\" title=\"The barcode ID for each set of reads.\">Sample Identification Reports</span></th>" >> "$HTML"
    local BCN
    local CWIDTH=198
