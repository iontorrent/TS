...
var columns = [{
  ...
  id: "targetid", name: "Target ID", field: "targetid", width: 74, minWidth: 40, maxWidth: 200, sortable: true,
  toolTip: "Name of the target region containing the HotSpot variation site."
},{
  id: "hotspotid", name: "HotSpot ID", field: "hotspotid", width: 76, minWidth: 40, maxWidth: 200, sortable: true,
  toolTip: "Name of the HotSpot variant (site)."
},{
  id: "call", name: "Call", field: "call", width: 30, minWidth: 26, maxWidth: 40,
  toolTip: "Call based on reads at variant locus."
},{
...
$("#sampleIDalleleCoverageTable").css('width','808');
    ...
    $.each(lines, function(n,row) {
      ...
      if( n > 0 ) {
        data[numRecords] = {
          ...
          call : fields[4],
          reference : fields[5],
          coverage : Number(fields[6]),
          cov_a : Number(fields[7]),
          cov_c : Number(fields[8]),
          cov_g : Number(fields[9]),
          cov_t : Number(fields[10]),
          cov_f : Number(fields[11]),
          cov_r : Number(fields[12]),
          cov_d : Number(fields[13])
        };
