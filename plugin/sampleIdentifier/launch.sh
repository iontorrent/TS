...
BC_COL_TITLE[2]="Reads On-Target"
BC_COL_TITLE[3]="Read Depth"
BC_COL_TITLE[4]="20x Coverage"
BC_COL_TITLE[5]="100x Coverage"
...
BC_COL_HELP[1]="Number of reads that were mapped to the full reference for this barcode set."
BC_COL_HELP[2]="Percentage of mapped reads that were aligned over gender and sample identification regions."
BC_COL_HELP[3]="Mean average target base read depth over all sample identification loci."
BC_COL_HELP[4]="Percentage of all sample identification loci that were covered to at least 20x read depth."
BC_COL_HELP[5]="Percentage of all sample identification loci that were covered to at least 100x read depth."
...
rm -f "$PLUGIN_CHROM_X_TARGETS" "$PLUGIN_CHROM_Y_TARGETS" "$PLUGIN_OUT_HAPLOCODE"
rm -f ${TSP_FILEPATH_PLUGIN_DIR}/*.bed
