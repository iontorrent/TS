...
def getUserInput(inputJson):
    ...
    if version == "44":
        ...
        return getSampleTabulationRules_1_6(inputJson, workflowFullDetail)
...
def lastrun(bucket):
	...
	current_version = bucket['request_post']['version']
...
if __name__ == "__main__":
    ...
    k = {'port': '443',    # this is the one that is used for most of the test cases below
         ...
         #'version': 'IR40',
         'version': 'IR42',
         #'token': 'uaqsKR/zz8a2O0Rsg3AS/ojQEAGJpemo2NsfzQoMgOpFye/HV85vRdWl+96VMwBJ'
