...
python -c"import sys; sys.path.insert(0, '$DIRNAME/code'); import preproc_fastq; preproc_fastq.fastq_preproc('${TSP_FILEPATH_UNMAPPED_BAM}', '${RESULTS_DIR}/filtered.fastq',15,20);"
