...
class ChipCal:
    ...
    def determine_lane( self , gain_threshold=500. , leg_column_threshold=50, active_lanes = [1,2,3,4] ):
        """ 
        ...
        if self.is_multilane:
            ...
            for i,lane in enumerate(average_column_gain.reshape(4,-1)):
                setattr( self , 'lane_{}'.format(i+1) , bool(lane.mean() > gain_threshold) and  (i + 1) in active_lanes )
