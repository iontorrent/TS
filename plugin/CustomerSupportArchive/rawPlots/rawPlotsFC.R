# FullChip version of rawPlots
# works on Fullchip data with multiple lanes
...
expName = 'Auto_sierra_VB16-16-1lane_MFGtest_JGtemplate2_89778'
analysisDir = '/results-ddn4-gs2/analysis/output/Home/Auto_sierra_VB16-16-1lane_MFGtest_JGtemplate2_89778_183617'
sigprocDir = '/results-ddn4-gs2/analysis/output/Home/Auto_sierra_VB16-16-1lane_MFGtest_JGtemplate2_89778_183617/sigproc_results'
basecallerDir = '/results-ddn4-gs2/analysis/output/Home/Auto_sierra_VB16-16-1lane_MFGtest_JGtemplate2_89778_183617/basecaller_results'
alignmentDir = '/results-ddn4-gs2/analysis/output/Home/Auto_sierra_VB16-16-1lane_MFGtest_JGtemplate2_89778_183617'
datDir = '/rawdata-ddn4/results/BBdefault/Auto_R_2019_02_22_17_37_53_sierra_VB16-16-1lane_MFGtest_JGtemplate2_15'
plotDir = '/results-ddn4-gs2/analysis/output/Home/Auto_sierra_VB16-16-1lane_MFGtest_JGtemplate2_89778_183617/plugin_out/rawPlots_out.3326229/plots_lane_1'
maskFile = '/results-ddn4-gs2/analysis/output/Home/Auto_sierra_VB16-16-1lane_MFGtest_JGtemplate2_89778_183617/sigproc_results/analysis.bfmask.bin'
chipType = 'GX5'
multiLane = 'True'
activeLanes = 1
flows = c(0,1,2,3,4,5,6,7)
source("/results/plugins/rawPlots/rawPlots.fns.R")
# 
...
delta_x = 1288
delta_y = 1332
# dynamically select regions from blocks of fullchip
regionBlockIDs < function(lane, delta_x, delta_y) {
  nRegion = 4 
  nBlockX = 12
  nBlockY = 8
  x = delta_x * ((lane - 1) * 3 + 1) # middle block in y dimension
  xVal = seq(1,8,length=nRegion) 
  regionBlockIDs = list(
