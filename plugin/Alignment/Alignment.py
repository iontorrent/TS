...
class Alignment(IonPlugin):
	...
	# This is a very important dict; if it does what I hope it will (store environment vars and pass them properly), it'll invalidate my last week of work. BUT, it'll also let me do it again much faster and better.
